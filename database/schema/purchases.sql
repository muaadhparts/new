CREATE TABLE `purchases` (
  ...
  `merchant_shipping_id` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `merchant_packing_id` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `merchant_ids` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  ...
  `customer_shipping_choice` json DEFAULT NULL COMMENT 'Customer selected shipping company data per merchant',
  `shipping_status` json DEFAULT NULL COMMENT 'Shipping status per merchant with tracking info',
