...
"""
    CREATE TABLE IF NOT EXISTS `account_parties` (
      ...
      `reference_type` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Source table: users, couriers, shippings, etc',
      `reference_id` bigint unsigned DEFAULT NULL COMMENT 'ID in source table',
      `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `code` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Unique code: platform, merchant_5, courier_12, shipping_tryoto',
...
"""
    CREATE TABLE IF NOT EXISTS `catalog_items` (
      ...
      `photo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'LargePNG/SVG/noimage.png',
      `thumbnail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'SmallPNG/SVG/noimage.png',
      ...
      `created_at` timestamp NULL DEFAULT NULL,
      `updated_at` timestamp NULL DEFAULT NULL,
      `cross_items` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      PRIMARY KEY (`id`),
...
"""
    ...
    ) ENGINE=InnoDB AUTO_INCREMENT=6230 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
""",

"""
    CREATE TABLE IF NOT EXISTS `comms_blueprints` (
      `id` int NOT NULL AUTO_INCREMENT,
...
"""
    CREATE TABLE IF NOT EXISTS `delivery_couriers` (
      ...
      `payment_method` enum('online','cod') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'cod',
      `fee_status` enum('pending','paid','collected') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'pending',
      `settlement_status` enum('pending','settled') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'pending',
...
"""
    CREATE TABLE IF NOT EXISTS `home_page_themes` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
      `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
"""
    CREATE TABLE IF NOT EXISTS `merchant_branches` (
      ...
      `tryoto_warehouse_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Warehouse Code from Tryoto dashboard',
...
"""
    CREATE TABLE IF NOT EXISTS `merchant_purchases` (
      ...
      `money_holder` enum('platform','merchant','courier','shipping_company','pending') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending' COMMENT 'Entity currently holding the payment',
      `delivery_method` enum('local_courier','shipping_company','pickup','digital','none') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'How the order is delivered',
      `delivery_provider` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Specific provider: courier_id or tryoto/aramex/etc',
      `collection_status` enum('not_applicable','pending','collected','failed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_applicable' COMMENT 'COD collection status',
      `collected_at` timestamp NULL DEFAULT NULL COMMENT 'When COD was collected',
      `collected_by` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Who collected COD (courier_id or shipping_company_name)',
      `payment_type` enum('merchant','platform') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'platform',
      `shipping_type` enum('merchant','platform','courier','pickup') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `money_received_by` enum('merchant','platform','courier') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'platform',
      ...
      `payment_method` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Payment method: cod or online',
      ...
      `updated_at` timestamp NULL DEFAULT NULL,
      `purchase_number` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      ...
      `settlement_status` enum('unsettled','pending','settled') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unsettled',
      `settled_at` timestamp NULL DEFAULT NULL,
...
"""
    CREATE TABLE IF NOT EXISTS `merchant_stock_updates` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
"""
    CREATE TABLE IF NOT EXISTS `merchant_tax_settings` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
      `user_id` int unsigned NOT NULL,
      `tax_rate` decimal(5,2) NOT NULL DEFAULT '0.00',
      `tax_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `tax_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'VAT',
      `is_active` tinyint(1) NOT NULL DEFAULT '1',
      `created_at` timestamp NULL DEFAULT NULL,
      `updated_at` timestamp NULL DEFAULT NULL,
      PRIMARY KEY (`id`),
...
"""
    CREATE TABLE IF NOT EXISTS `network_presences` (
      `id` int NOT NULL AUTO_INCREMENT,
      `user_id` int NOT NULL DEFAULT '0',
...
"""
    CREATE TABLE IF NOT EXISTS `nissan_credentials` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
"""
    CREATE TABLE IF NOT EXISTS `note_responses` (
      `id` int NOT NULL AUTO_INCREMENT,
      `user_id` int unsigned NOT NULL,
...
"""
    CREATE TABLE IF NOT EXISTS `pages` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
      `slug` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'URL slug: terms, privacy, refund',
      `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Page title',
      `title_ar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Arabic title',
      `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Page content (HTML)',
      `content_ar` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Arabic content',
      `is_active` tinyint(1) NOT NULL DEFAULT '1',
      `created_at` timestamp NULL DEFAULT NULL,
      `updated_at` timestamp NULL DEFAULT NULL,
      PRIMARY KEY (`id`),
...
"""
    CREATE TABLE IF NOT EXISTS `part_periods_r50gl` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
"""
    CREATE TABLE IF NOT EXISTS `part_spec_group_items_r50gl` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
"""
    CREATE TABLE IF NOT EXISTS `part_spec_groups_r50gl` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
      `part_id` bigint unsigned NOT NULL,
...
"""
    CREATE TABLE IF NOT EXISTS `parts_r50gl` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
    ...
    ) ENGINE=InnoDB AUTO_INCREMENT=12878 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
""",

"""
    CREATE TABLE IF NOT EXISTS `parts_y61gl` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
      `part_number` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `label_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `label_ar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
"""
    CREATE TABLE IF NOT EXISTS `platform_revenue_log` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
      `date` date NOT NULL,
      `source` enum('commission','tax','shipping_markup','courier_fee','other') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
"""
    CREATE TABLE IF NOT EXISTS `platform_settings` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
      `group` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Setting group: branding, mail, payment, etc',
      `key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Setting key within group',
      `value` json DEFAULT NULL COMMENT 'Setting value (JSON for flexibility)',
      `type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'string' COMMENT 'Value type: string, boolean, integer, json, file',
...
"""
    CREATE TABLE IF NOT EXISTS `purchase_timelines` (
      `id` int NOT NULL AUTO_INCREMENT,
      `purchase_id` int NOT NULL,
      `name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
"""
    CREATE TABLE IF NOT EXISTS `purchases` (
      ...
      `discount_code` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `discount_amount` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      `status` enum('pending','processing','completed','declined','on delivery') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
      `created_at` timestamp NULL DEFAULT NULL,
      `updated_at` timestamp NULL DEFAULT NULL,
      ...
      `merchant_shipping_id` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
      `merchant_packing_id` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
      `merchant_ids` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      ...
      `couriers` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
      PRIMARY KEY (`id`)
    ) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
""",

"""
    CREATE TABLE IF NOT EXISTS `quality_brands` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
"""
    CREATE TABLE IF NOT EXISTS `section_parts_r50gl` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
      `section_id` bigint unsigned NOT NULL,
      `part_id` bigint unsigned NOT NULL,
      `category_id` bigint unsigned NOT NULL,
...
"""
    CREATE TABLE IF NOT EXISTS `section_parts_y61gl` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
      `section_id` bigint unsigned NOT NULL,
      `part_id` bigint unsigned NOT NULL,
      `category_id` bigint unsigned NOT NULL,
...
"""
    CREATE TABLE IF NOT EXISTS `shipment_trackings` (
      ...
      `shipping_id` int unsigned DEFAULT NULL,
      `integration_type` enum('api','manual') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'manual',
      ...
      `external_shipment_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      ...
      `status_en` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      ...
      `source` enum('api','merchant','system','operator') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'system',
      `raw_payload` json DEFAULT NULL,
      `awb_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
"""
    CREATE TABLE IF NOT EXISTS `sku_alternatives` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
      `part_number` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
"""
    CREATE TABLE IF NOT EXISTS `support_threads` (
      ...
      `purchase_number` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
      `created_at` timestamp NULL DEFAULT NULL,
      `updated_at` timestamp NULL DEFAULT NULL,
      PRIMARY KEY (`id`),
...
"""
    CREATE TABLE IF NOT EXISTS `trust_badges` (
      ...
      `status` enum('Pending','Trusted','Rejected') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Pending',
      `text` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
"""
    CREATE TABLE IF NOT EXISTS `user_catalog_events` (
      `id` int NOT NULL AUTO_INCREMENT,
      `user_id` int NOT NULL,
      `purchase_number` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
      `is_read` tinyint(1) NOT NULL DEFAULT '0',
...
"""
    CREATE TABLE IF NOT EXISTS `users` (
      ...
      `merchant_logo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
"""
    CREATE TABLE IF NOT EXISTS `vin_catalog_log` (
      `id` bigint NOT NULL AUTO_INCREMENT,
...
"""
    CREATE TABLE IF NOT EXISTS `withdraws` (
      ...
      `type` enum('user','merchant','rider') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      PRIMARY KEY (`id`)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
""",
...
"""
    CREATE TABLE IF NOT EXISTS `settlement_batches` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
      `batch_ref` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Unique batch reference: SET-20260113-XXXXX',
      ...
      `payment_method` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'bank_transfer, cash, wallet, etc',
      `payment_reference` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Bank transfer ref, cheque number, etc',
...
"""
    CREATE TABLE IF NOT EXISTS `account_balances` (
      ...
      `balance_type` enum('receivable','payable') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      ...
      `monetary_unit_code` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'SAR',
...
"""
    CREATE TABLE IF NOT EXISTS `catalog_item_code_mappings` (
      `id` int unsigned NOT NULL AUTO_INCREMENT,
...
"""
    CREATE TABLE IF NOT EXISTS `merchant_settings` (
      ...
      `group` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Setting group',
      `key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Setting key within group',
...
"""
    CREATE TABLE IF NOT EXISTS `merchant_items` (
      ...
      `item_type` enum('normal','affiliate') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'normal',
...
"""
    CREATE TABLE IF NOT EXISTS `accounting_ledger` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
      `transaction_ref` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Unique transaction reference: TXN-20260113-XXXXX',
      ...
      `amount` decimal(12,2) NOT NULL,
      `monetary_unit_code` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'SAR',
      `transaction_type` enum('debt','collection','settlement','fee','refund','reversal','adjustment') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `entry_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Specific entry type: SALE_REVENUE, COMMISSION_EARNED, TAX_COLLECTED, etc.',
      `direction` enum('DEBIT','CREDIT') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'CREDIT',
      `description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
      ...
      `debt_status` enum('PENDING','SETTLED','CANCELLED','REVERSED') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDING',
...
"""
    CREATE TABLE IF NOT EXISTS `catalog_item_fitments` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
      `catalog_item_id` int unsigned DEFAULT NULL,
      `catalog_id` bigint unsigned NOT NULL,
      `brand_id` bigint unsigned NOT NULL,
    ...
    ) ENGINE=InnoDB AUTO_INCREMENT=1263176 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
""",

"""
    CREATE TABLE IF NOT EXISTS `vin_decoded_cache` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
      `vin` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
      `brand_id` bigint unsigned DEFAULT NULL,
      `brand_region_id` bigint unsigned DEFAULT NULL,
...
"""
    CREATE TABLE IF NOT EXISTS `newcategories` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
      `brand_id` bigint unsigned NOT NULL,
      ...
      KEY `idx_nc_catalog_brand_level` (`catalog_id`,`brand_id`,`level`) USING BTREE,
      KEY `idx_nc_full_code` (`full_code`) USING BTREE,
      KEY `idx_nc_spec_key` (`catalog_id`,`spec_key`,`level`) USING BTREE,
...
"""
    CREATE TABLE IF NOT EXISTS `vin_spec_attributes` (
      `id` bigint NOT NULL AUTO_INCREMENT,
...
"""
    CREATE TABLE IF NOT EXISTS `vin_spec_mapped` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
"""
    CREATE TABLE IF NOT EXISTS `vin_spec_to_spec_item` (
      `id` bigint NOT NULL AUTO_INCREMENT,
...
"""
    CREATE TABLE IF NOT EXISTS `category_spec_groups` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
      `category_id` bigint unsigned NOT NULL,
      `catalog_id` bigint unsigned NOT NULL,
...
"""
    CREATE TABLE IF NOT EXISTS `category_spec_group_items` (
      `id` bigint unsigned NOT NULL AUTO_INCREMENT,
      `group_id` bigint unsigned NOT NULL,
      `specification_item_id` int unsigned NOT NULL,
      PRIMARY KEY (`id`),
