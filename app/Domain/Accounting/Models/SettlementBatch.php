...
/**
 * SettlementBatch Model - Settlement payment batches
 *
 * Domain: Accounting
 * Table: settlement_batches
 *
 * Groups multiple settlement transactions into one batch.
 * Example: Platform pays merchant once weekly.
 */
class SettlementBatch extends Model
{
    ...
    protected $fillable = [
        'batch_ref', 'from_party_id', 'to_party_id', 'total_amount',
