...
class PackageController extends MerchantBaseController
{

 
    public function index(){
        $datas = Package::where('user_id',$this->user->id)->get();
        return view('merchant.package.index',compact('datas'));
    }
    ...
    {
        $sign = $this->curr;
        return view('merchant.package.create',compact('sign'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('merchant.package.edit',compact('data','sign'));
    }
