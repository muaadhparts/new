...
class NotificationController extends MerchantBaseController
{
    ...
    public function purchase_notf_count($id)
    {
        $data = UserCatalogEvent::where('user_id','=',$id)->where('is_read','=',0)->get()->count();
        return response()->json($data);
    }

    public function purchase_notf_clear($id)
    {
    ...
    public function purchase_notf_show($id)
    {
        ...
        return view('merchant.notification.purchase',compact('datas'));
    } 
}
