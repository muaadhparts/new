...
class PublicationController extends AdminBaseController
{
    ...
    public function datatables()
    {
        ...
        return Datatables::of($datas)
            ...
            ->addColumn('action', function (Publication $publication) {
                return '<div class="action-list"><a href="' . route('admin-publication-edit', $publication->id) . '"> <i class="fas fa-edit"></i>' . __('Edit') . '</a><a href="javascript:;" data-href="' . route('admin-publication-delete', $publication->id) . '" data-bs-toggle="modal" data-bs-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a></div>';
            })
    ...
    public function index()
    {
        ...
        return view('admin.publication.post.index');
    }
    ...
    public function create()
    {
        ...
        return view('admin.publication.post.create', compact('cats'));
    }

    public function settings()
    {
        return view('admin.publication.settings');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.publication.post.edit', compact('publication', 'cats'));
    }
