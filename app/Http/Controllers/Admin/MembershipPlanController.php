...
class MembershipPlanController extends AdminBaseController
{
    //*** JSON Request
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ...
                            ->addColumn('action', function(MembershipPlan $data) {
                                return '<div class="action-list"><a data-href="' . route('admin-membership-plan-edit',$data->id) . '" class="edit" data-bs-toggle="modal" data-bs-target="#modal1"> <i class="fas fa-edit"></i>'.__('Edit').'</a><a href="javascript:;" data-href="' . route('admin-membership-plan-delete',$data->id) . '" data-bs-toggle="modal" data-bs-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a></div>';
                            })
                            ->rawColumns(['action'])
    ...
    public function edit($id)
    {
        ...
        return view('admin.membership-plan.edit',compact('data','sign'));
    }
