...
class FrontendSettingController extends AdminBaseController
{
    protected $rules =
    [
    ...
    public function homeupdate(Request $request)
    {
        ...
        if ($request->featured_promo == ""){
            $input['featured_promo'] = 0;
        }
    ...
    public function deal(){
        ...
        return view('admin.frontend-setting.deal', compact('dealCatalogItems'));
    }
    ...
    public function contact()
    {
        ...
        return view('admin.frontend-setting.contact',compact('data'));
    }

    public function customize()
    {
        $data = FrontendSetting::find(1);
        return view('admin.frontend-setting.customize',compact('data'));
    }

    public function best_seller()
    {
        $data = FrontendSetting::find(1);
        return view('admin.frontend-setting.best_seller',compact('data'));
    }

    public function big_save()
    {
        $data = FrontendSetting::find(1);
        return view('admin.frontend-setting.big_save',compact('data'));
    }

    public function page_banner()
    {
        $data = FrontendSetting::find(1);
        return view('admin.frontend-setting.page_banner',compact('data'));
    }

    public function right_banner()
    {
        $data = FrontendSetting::find(1);
        return view('admin.frontend-setting.right_banner',compact('data'));
    }

    public function menu_links()
    {
        $data = FrontendSetting::find(1);
        return view('admin.frontend-setting.menu_links',compact('data'));
    }
    ...
    public function bestSellers()
    {
        ...
        return view('admin.frontend-setting.best_sellers_manage', compact('bestCatalogItems'));
    }
    ...
    // TOP RATED
    public function topRated() { return view('admin.frontend-setting.top_rated_manage', ['catalogItems' => $this->getCatalogItemsByFlag('top')]); }
    ...
    // BIG SAVE
    public function bigSave() { return view('admin.frontend-setting.big_save_manage', ['catalogItems' => $this->getCatalogItemsByFlag('big')]); }
    ...
    // TRENDING
    public function trending() { return view('admin.frontend-setting.trending_manage', ['catalogItems' => $this->getCatalogItemsByFlag('trending')]); }
    ...
    // FEATURED
    public function featured() { return view('admin.frontend-setting.featured_manage', ['catalogItems' => $this->getCatalogItemsByFlag('featured')]); }
