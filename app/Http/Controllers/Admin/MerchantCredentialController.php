...
class MerchantCredentialController extends AdminBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.merchant-credentials.index', compact(
            'credentials',
            'groupedCredentials',
            'merchants',
            'services'
    ...
    public function create()
    {
        ...
        return view('admin.merchant-credentials.create', compact(
            'merchants',
            'services',
            'keyTypes',
            'environments'
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.merchant-credentials.index')
    ...
    public function edit($id)
    {
        ...
        return view('admin.merchant-credentials.edit', compact('credential', 'environments'));
    }
