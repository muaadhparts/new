...
class HomePageThemeController extends AdminBaseController
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.homethemes.index', compact('themes'));
    }
    ...
    {
        return view('admin.homethemes.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.homethemes.edit', compact('theme'));
    }
