...
class BuyerNoteController extends AdminBaseController
{
	...
	public function datatables()
	{
		...
		return Datatables::of($datas)
			...
			->addColumn('action', function (BuyerNote $data) {
				return '<div class="action-list"><a data-href="' . route('admin-buyer-note-show', $data->id) . '" class="view details-width" data-bs-toggle="modal" data-bs-target="#modal1"> <i class="fas fa-eye"></i>' . __('Details') . '</a><a href="javascript:;" data-href="' . route('admin-buyer-note-delete', $data->id) . '" data-bs-toggle="modal" data-bs-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a></div>';
			})
	...
	{
		return view('admin.buyer-note.index');
	}
	...
	public function show($id)
	{
		...
		return view('admin.buyer-note.show', compact('data'));
	}
