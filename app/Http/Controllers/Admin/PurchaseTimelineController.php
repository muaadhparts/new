...
class PurchaseTimelineController extends AdminBaseController
{
   ...
   //*** GET Request
    public function index($id)
    {
        ...
        return view('admin.purchase.track',compact('purchase'));
    }
   ...
   //*** GET Request
    ...
    {
        $purchase = Purchase::findOrFail($id);
        return view('admin.purchase.track-load',compact('purchase'));
    }
