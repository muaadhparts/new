...
class SupportTicketController extends AdminBaseController
{
    ...
    public function datatables($type)
    {
        ...
        return Datatables::of($datas)
            ...
            ->addColumn('action', function (SupportThread $data) {
                return '<div class="action-list"><a href="' . route('admin-support-ticket-show', $data->id) . '"> <i class="fas fa-eye"></i> ' . __('Details') . '</a><a href="javascript:;" data-href="' . route('admin-support-ticket-delete', $data->id) . '" data-bs-toggle="modal" data-bs-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a></div>';
            })
            ->rawColumns(['action'])
    ...
    {
        return view('admin.support-ticket.dispute');
    }
    ...
    public function message($id)
    {
        ...
        return view('admin.support-ticket.create', compact('conv'));
    }
