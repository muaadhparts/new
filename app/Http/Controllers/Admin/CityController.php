            ...
            ->addColumn('status', function (City $data) {
                ...
                return '<div class="action-list">
                    <select class="process select droplinks ' . $class . '">
                        <option data-val="1" value="' . route('admin-city-status', [$data->id, 1]) . '" ' . $s . '>Activated</option>
                        <option data-val="0" value="' . route('admin-city-status', [$data->id, 0]) . '" ' . $ns . '>Deactivated</option>
                    </select>
                </div>';
            })
