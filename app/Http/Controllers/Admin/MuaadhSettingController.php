...
class MuaadhSettingController extends AdminBaseController
{
    protected $rules =
        [
    ...
    {
        return view('admin.muaadhsetting.paymentsinfo');
    }

    public function logo()
    {
        return view('admin.muaadhsetting.logo');
    }

    public function favicon()
    {
        return view('admin.muaadhsetting.favicon');
    }

    public function loader()
    {
        return view('admin.muaadhsetting.loader');
    }

    public function websitecontent()
    {
        return view('admin.muaadhsetting.websitecontent');
    }
    public function popup()
    {
        return view('admin.muaadhsetting.popup');
    }
    ...
    {
        return view('admin.muaadhsetting.footer');
    }

    public function affilate()
    {
        return view('admin.muaadhsetting.affilate');
    }

    public function error_banner()
    {
        return view('admin.muaadhsetting.error_banner');
    }
    ...
    {
        return view('admin.muaadhsetting.user_image');
    }
    ...
    {
        return view('admin.muaadhsetting.homepage');
    }
    ...
    {
        return view('admin.muaadhsetting.theme_colors');
    }
