...
class WalletLogController extends AdminBaseController
{
        //*** JSON Request
             ...
             return Datatables::of($datas)
                                ...
                                ->addColumn('action', function(WalletLog $data) {
                                    return '<div class="action-list">
                                                <a href="javascript:;" data-href="' . route('admin-wallet-log-show',$data->id) . '" class="view" data-bs-toggle="modal" data-bs-target="#modal1">
        ...
        public function index(){
            return view('admin.wallet-log.index');
        }
        ...
        public function transhow($id)
        {
            ...
            return view('admin.wallet-log.show',compact('data'));
        }
