...
class AbuseFlagController extends AdminBaseController
{
	...
	public function datatables()
	{
		...
		return Datatables::of($datas)
			...
			->addColumn('action', function (AbuseFlag $data) {
				return '<div class="action-list"><a data-href="' . route('admin-abuse-flag-show', $data->id) . '" class="view details-width" data-bs-toggle="modal" data-bs-target="#modal1"> <i class="fas fa-eye"></i>' . __('Details') . '</a><a href="javascript:;" data-href="' . route('admin-abuse-flag-delete', $data->id) . '" data-bs-toggle="modal" data-bs-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a></div>';
			})
		...
		public function index(){
			return view('admin.abuse-flag.index');
		}
	...
	public function show($id)
	{
		...
		return view('admin.abuse-flag.show', compact('data'));
	}
