...
class CredentialController extends VendorBaseController
{
    protected VendorCredentialService $credentialService;

    public function __construct(VendorCredentialService $credentialService)
    {
        parent::__construct();
    ...
    public function index()
    {
        ...
        return view('vendor.credentials.index', compact('user', 'credentials', 'availableServices'));
    }
    ...
    public function create()
    {
        ...
        return view('vendor.credentials.create', compact('user', 'availableServices'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vendor-credentials-index')
    ...
    public function edit($id)
    {
        ...
        return view('vendor.credentials.edit', compact('user', 'credential', 'availableServices'));
    }
