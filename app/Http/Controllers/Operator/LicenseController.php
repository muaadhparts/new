...
class LicenseController extends OperatorBaseController
{
    /**
    ...
    {
        return view('operator.license.index');
    }
    ...
    public function datatables()
    {
        ...
        return Datatables::of($datas)
            ...
            ->addColumn('action', function (License $data) {
                ...
                $buttons .= '<a data-href="' . route('operator-license-edit', $data->id) . '" class="edit" data-bs-toggle="modal" data-bs-target="#modal1"><i class="fas fa-edit"></i> ' . __('Edit') . '</a>';

                if ($data->status === 'active') {
                    $buttons .= '<a href="' . route('operator-license-deactivate', $data->id) . '" class="btn btn-sm btn-warning"><i class="fas fa-pause"></i></a>';
                } else {
                    $buttons .= '<a href="' . route('operator-license-activate-license', $data->id) . '" class="btn btn-sm btn-success"><i class="fas fa-play"></i></a>';
                }

                $buttons .= '<a href="javascript:;" data-href="' . route('operator-license-delete', $data->id) . '" data-bs-toggle="modal" data-bs-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a>';
                $buttons .= '</div>';
    ...
    {
        return view('operator.license.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('operator.license.edit', compact('data'));
    }
    ...
    public function activation()
    {
        ...
        return view('operator.license.activation', compact('activeLicense'));
    }
