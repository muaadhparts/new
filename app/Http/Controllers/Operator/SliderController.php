...
class SliderController extends OperatorBaseController
{
    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ...
                            ->addColumn('action', function(Slider $data) {
                                return '<div class="action-list"><a href="' . route('operator-sl-edit',$data->id) . '"> <i class="fas fa-edit"></i>'.__('Edit').'</a><a href="javascript:;" data-href="' . route('operator-sl-delete',$data->id) . '" data-bs-toggle="modal" data-bs-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a></div>';
                            })
    ...
    public function index(){
        return view('operator.slider.index');
    }

    public function create(){
        return view('operator.slider.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('operator.slider.edit',compact('data'));
    }
