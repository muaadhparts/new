...
class FontController extends OperatorBaseController
{
    public function datatables(){
        $datas = Font::orderBy('id','desc')->get();
        return Datatables::of($datas)
                            ->addColumn('action',function(Font $data){
                                $default = $data->is_default == 1 ? '<a><i class="fa fa-check"></i> Default</a>' : '<a class="status" data-href="'.route('operator.fonts.status',$data->id).'">Set Default</a>';
                                return '<div class="action-list"><a data-href="' . route('operator.fonts.edit',$data->id) . '" class="edit" data-bs-toggle="modal" data-bs-target="#modal1"> <i class="fas fa-edit"></i>'.__("Edit").'</a><a href="javascript:;" data-href="' . route('operator.fonts.delete',['id' => $data->id]) . '" data-bs-toggle="modal" data-bs-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a>'.$default.'</div>';
                            })
                            ->rawColumns(['action'])
                            ->toJson();
    }
    ...
    public function index(){
        return view('operator.fonts.index');
    }

    public function create(){
        return view('operator.fonts.create');
    }
    ...
    public function edit($id){
        ...
        return view('operator.fonts.edit',compact('data'));
    }
