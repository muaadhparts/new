...
class DiscountCodeController extends OperatorBaseController
{
    ...
    public function create()
    {
        ...
        return view('operator.discount-code.create', compact('categories', 'sub_categories', 'child_categories', 'merchants'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('operator.discount-code.edit', compact('data', 'categories', 'sub_categories', 'child_categories', 'merchants'));
    }
