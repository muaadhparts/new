...
class FeaturedPromoController extends Controller
{
    public function datatables()
    {
        ...
        return Datatables::of($datas)
            ...
            ->addColumn('action', function (FeaturedPromo $data) {
                return '<div class="action-list"><a href="' . route('operator-featured-promo-edit', $data->id) . '"> <i class="fas fa-edit"></i>' . __('Edit') . '</a><a href="javascript:;" data-href="' . route('operator-featured-promo-delete', $data->id) . '" data-bs-toggle="modal" data-bs-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a></div>';
            })
    ...
    public function index()
    {
        ...
        return redirect()->route('operator-fs-best-sellers');
    }
    public function create()
    {
        return view('operator.featured-promo.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('operator.featured-promo.edit', compact('data'));
    }
