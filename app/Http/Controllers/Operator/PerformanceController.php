...
class PerformanceController extends OperatorBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            return view('operator.performance.index', compact(
                'summary',
                'slowQueries',
                'slowRequests',
                'slowestEndpoints',
            ...
            return view('operator.performance.index', [
                'error' => $e->getMessage(),
                'days' => $days,
            ]);
        }
    ...
    public function slowQueries(Request $request)
    {
        ...
        return view('operator.performance.slow-queries', compact('slowQueries', 'days'));
    }
    ...
    public function slowRequests(Request $request)
    {
        ...
        return view('operator.performance.slow-requests', compact('slowRequests', 'days'));
    }
    ...
    public function repeatedQueries(Request $request)
    {
        ...
        return view('operator.performance.repeated-queries', compact('repeatedQueries', 'days'));
    }
