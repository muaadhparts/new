...
class FrontendSettingController extends OperatorBaseController
{
    ...
    public function deal(){
        ...
        return view('operator.frontend-setting.deal', compact('dealCatalogItems'));
    }
    ...
    {
        $data = FrontendSetting::find(1);
        return view('operator.frontend-setting.best_seller',compact('data'));
    }

    public function big_save()
    {
        $data = FrontendSetting::find(1);
        return view('operator.frontend-setting.big_save',compact('data'));
    }
    ...
    public function bestSellers()
    {
        ...
        return view('operator.frontend-setting.best_sellers_manage', compact('bestCatalogItems'));
    }
    ...
    // TOP RATED
    public function topRated() { return view('operator.frontend-setting.top_rated_manage', ['catalogItems' => $this->getCatalogItemsByFlag('top')]); }
    ...
    // BIG SAVE
    public function bigSave() { return view('operator.frontend-setting.big_save_manage', ['catalogItems' => $this->getCatalogItemsByFlag('big')]); }
    ...
    // TRENDING
    public function trending() { return view('operator.frontend-setting.trending_manage', ['catalogItems' => $this->getCatalogItemsByFlag('trending')]); }
    ...
    // FEATURED
    public function featured() { return view('operator.frontend-setting.featured_manage', ['catalogItems' => $this->getCatalogItemsByFlag('featured')]); }
