...
class HelpArticleController extends OperatorBaseController
{
    //*** JSON Request
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ...
                            ->addColumn('action', function(HelpArticle $data) {
                                return '<div class="action-list"><a href="' . route('operator-help-article-edit',$data->id) . '"> <i class="fas fa-edit"></i>'.__("Edit").'</a><a href="javascript:;" data-href="' . route('operator-help-article-delete',$data->id) . '" data-bs-toggle="modal" data-bs-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a></div>';
                            })
                            ->rawColumns(['action'])
    ...
    public function index(){
        return view('operator.help-article.index');
    }

    public function create(){
        return view('operator.help-article.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('operator.help-article.edit',compact('data'));
    }
