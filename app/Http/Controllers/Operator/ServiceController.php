...
class ServiceController extends OperatorBaseController
{
    //*** JSON Request
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ...
                            ->addColumn('action', function(Service $data) {
                                return '<div class="action-list"><a data-href="' . route('operator-service-edit',$data->id) . '" class="edit" data-bs-toggle="modal" data-bs-target="#modal1"> <i class="fas fa-edit"></i>'.__('Edit').'</a><a href="javascript:;" data-href="' . route('operator-service-delete',$data->id) . '" data-bs-toggle="modal" data-bs-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a></div>';
                            }) 
    ...
    public function index(){
        return view('operator.service.index');
    }

    public function create(){
        return view('operator.service.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('operator.service.edit',compact('data'));
    }
