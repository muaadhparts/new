...
class WalletPaymentController extends MembershipPlanBaseController
{
    public function store(Request $request){
        ...
        $user->is_merchant = 2;
            ...
            $plan->currency = $membershipPlan->currency;
            $plan->currency_code = $membershipPlan->currency_code;
