 ...
 * AdDisplay Model
 *
 * Manages promotional banners/advertisements on the MUAADH EPC homepage.
 * Supports promotional campaigns for auto parts categories or merchant highlights.
 *
 * @property int $id
 * @property string $link Ad click destination URL
 * @property string $photo Ad image filename
 * @property string $name Ad name
 * @property int $position Display position/order
 * @property bool $status Active/inactive status
 */
class AdDisplay extends Model
{
    /**
     ...
     * @var array<string>
     */
    protected $fillable = ['link', 'photo', 'name', 'position', 'status'];
    ...
    /**
     * Check if ad display has a valid link.
     *
     * @return bool
     */
    ...
    /**
     * Get active ad displays ordered by position.
     *
