...
class Generalsetting extends Model
{
    protected $fillable = [
        ...
        'multiple_shipping', 'vendor_ship_info', 'is_verification_email',
        'wholesell', 'is_capcha', 'error_banner_404', 'error_banner_500',
        'popup_title', 'popup_text', 'popup_background',
        'invoice_logo', 'user_image', 'vendor_color', 'is_secure',
        ...
        'seller_product_count', 'wishlist_count', 'vendor_page_count',
        'min_price', 'max_price', 'product_page', 'post_count', 'wishlist_page',
