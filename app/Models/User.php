...
class User extends Authenticatable implements JWTSubject
{
    ...
    protected $fillable = ['name', 'photo', 'zip', 'city_id', 'state_id', 'country', 'address', 'latitude', 'longitude', 'phone', 'fax', 'email', 'password', 'affilate_code', 'verification_link', 'shop_name', 'owner_name', 'shop_number', 'shop_address', 'reg_number', 'shop_message', 'is_vendor', 'shop_details', 'shop_image', 'shipping_cost', 'date', 'mail_sent', 'email_verified', 'email_token', 'reward', 'warehouse_city', 'warehouse_state', 'warehouse_address', 'warehouse_lat', 'warehouse_lng'];
