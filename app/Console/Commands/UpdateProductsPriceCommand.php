...
class UpdateProductsPriceCommand extends Command
{
    ...
    protected $description = 'Update merchant_products.price from stock_all.cost_price * margin (default +30%) for the given vendor.';
    ...
    public function handle(): int
    {
        ...
        $this->info("Updating merchant_products.price from stock_all.cost_price * {$margin} for user_id={$userId}...");
