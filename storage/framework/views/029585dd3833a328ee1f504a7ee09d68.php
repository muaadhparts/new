    ...
    <ul class="gs-dashboard-user-sidebar-wrapper">
        ...
        <li
            ...
            <ul class="sidebar-sub-menu collapse <?php echo e(request()->is('vendor/products/types') || request()->is('vendor/products') || request()->is('vendor/products/catalogs') || request()->is('vendor/products/physical/create') || request()->is('vendor/products/digital/create') || request()->is('vendor/products/license/create') || request()->is('vendor/products/listing/create') || request()->is('vendor/products/edit/*') || request()->is('vendor/products/catalog/*') || request()->is('vendor/stock/*') ? 'show' : ''); ?>"
                ...
                <li><a class="sidebar-sub-menu-item <?php echo e(request()->is('vendor/stock/*') ? 'active' : ''); ?>"
                        href="<?php echo e(route('vendor-stock-management')); ?>">
        ...
        <li class="">
            <a href="<?php echo e(route('user-messages')); ?>">
                ...
                <span class="label"><?php echo app('translator')->get('Messages'); ?></span>
            </a>
        </li>
...
<?php /**PATH C:\Users\hp\Herd\new\resources\views/includes/vendor/sidebar.blade.php ENDPATH**/ ?>