<footer class="gs-footer-section <?php echo e($gs->theme == 'theme3' ? 'home-3' : ''); ?>">
    <div class="newslatter <?php echo e($gs->theme != 'theme1' ? 'newslatter2' : ''); ?>">
        <div class="container">
            <div class="row newslatter-row">
                <div class="col-lg-7 col-md-6 col-12 newslatter-area">
                    <div class="newslatter-content">
                        <h2><?php echo app('translator')->get('SIGN UP TO NEWSLATTER'); ?></h2>
                    </div>
                </div>
                <div class="col-lg-5 col-md-6 col-12 newslatter-area">
                    <div class="newslatter-form">
                        <form action="<?php echo e(route('front.subscribe')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <input class="news-latter-input" type="email" placeholder="<?php echo app('translator')->get('Enter Your Email'); ?>" name="email">
                            <button class="newsletter-btn" type="submit"><?php echo app('translator')->get('Send'); ?></button>
                        </form>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row footer-row gy-3">
            <div class="col-lg-3 col-md-6 col-12 left-info">
                <img class="logo" src="<?php echo e(asset('assets/images/' . $gs->footer_logo)); ?>" alt="">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <h5 class="wow-replaced"><?php echo app('translator')->get('Product Category'); ?></h5>
                <ul class="footer-category-links">
                    <?php $__currentLoopData = $categories->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="wow-replaced" data-wow-delay=".1s"><a
                                href="<?php echo e(route('front.category', $cate->slug)); ?><?php echo e(!empty(request()->input('search')) ? '?search=' . request()->input('search') : ''); ?>"><?php echo e($cate->name); ?></a>
                        </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
            <div class="col-lg-3 col-md-6 col-12">
                <h5 class="wow-replaced"><?php echo app('translator')->get('Customer Care'); ?></h5>
                <ul class="footer-category-links">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <h5 class=" wow-replaced"><?php echo app('translator')->get('Recent Post'); ?></h5>
                <div class="gs-sm-recent-post-wrapper">
                    ...
                    <?php $__currentLoopData = $footer_blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $footer_blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('front.blogshow', $footer_blog->slug)); ?>"
                            ...
                            <img src="<?php echo e(asset('assets/images/blogs/' . $footer_blog->photo)); ?>" alt="recent post">
                            <div class="recent-post-content">
                                ...
                                <span class="post-date">
                                    ...
                                    <?php echo e(date('M d - Y', strtotime($footer_blog->created_at))); ?></span>
                            </div>
                        </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
