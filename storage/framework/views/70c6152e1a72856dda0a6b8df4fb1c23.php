                    ...
                    <div class="top-area">
                        <div class="row">
                            ...
                            <div class="col-sm-12 text-center">(
                                <small><?php echo e(__('You can upload multiple Images.')); ?></small> )</div>
                        </div>
                    </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data[0] == 0) {
                            ...
                            $('.selected-image .row').html(
                                '<h3><?php echo e(__('No Images Found.')); ?></h3>');
                        } else {
                            ...
                            for (var k in arr) {
                                $('.selected-image .row').append('<div class="col-sm-6">' +
                                    ...
                                    '</span>' +
                                    '<a href="' +
                                    '<?php echo e(asset('assets/images/galleries') . '/'); ?>' + arr[k][
                                        'photo'
                                    ] + '" target="_blank">' +
                                    '<img src="' +
                                    '<?php echo e(asset('assets/images/galleries') . '/'); ?>' + arr[k][
