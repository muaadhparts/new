<?php $__env->startSection('content'); ?>
    ...
    <div class="gs-checkout-wrapper">
        <div class="container">
            ...
            <!-- address-->
            <form class="address-wrapper" action="<?php echo e(isset($is_vendor_checkout) && $is_vendor_checkout ? route('front.checkout.vendor.step1.submit', $vendor_id) : route('front.checkout.step1.submit')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row gy-4">
                    <div class="col-lg-7 col-xl-8 wow fadeInUp" data-wow-delay=".2s">
                        <!-- personal information -->
                        <div class="mb-40">
                            <h4 class="form-title"><?php echo app('translator')->get('Personal Information'); ?></h4>
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="input-wrapper">
                                        <label class="label-cls" for="name"><?php echo app('translator')->get('Name'); ?></label>
                                        <input class="input-cls" id="name" name="personal_name"
                                            value="<?php echo e(Auth::check() ? Auth::user()->name : ''); ?>" type="text"
                                            placeholder="<?php echo app('translator')->get('Enter Your Name'); ?>" <?php echo e(Auth::check() ? 'readonly' : ''); ?>>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="input-wrapper">
                                        <label class="label-cls" for="email"><?php echo app('translator')->get('Email'); ?></label>
                                        <input class="input-cls" id="email" type="email" name="personal_email"
                                            placeholder="<?php echo app('translator')->get('Enter Your Emai'); ?>l"
                                ...
                                <?php if(!Auth::check()): ?>
                                    <div class="col-lg-12">
                                        <div class="gs-checkbox-wrapper" data-bs-toggle="collapse"
                                            ...
                                            <label for="showca"><?php echo app('translator')->get('Create an account ?'); ?></label>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-wrapper">
                                                    <label class="label-cls" for="crpass">
                                                        <?php echo app('translator')->get('Create Password'); ?>
                                                    </label>
                                                    <input class="input-cls" id="crpass" name="password" type="password"
                                                        placeholder="<?php echo app('translator')->get('Create Your Password'); ?>" minlength="6">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="input-wrapper">
                                                    <label class="label-cls" for="conpass">
                                                        <?php echo app('translator')->get('Confirm Password'); ?>
                                                    </label>
                                                    <input class="input-cls" id="conpass" name="password_confirmation" type="password"
                                                        placeholder="<?php echo app('translator')->get('Confirm Password'); ?>" minlength="6">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <!-- Billing Details -->
                        <div class="mb-40">
                            <h4 class="form-title"><?php echo app('translator')->get('Billing Details'); ?></h4>
                            <div class="row g-4">
                                <div class="col-lg-6 <?php echo e($digital == 1 ? 'd-none' : ''); ?>">
                                    <div class="input-wrapper">
                                        <label class="label-cls" for="Shipping"><?php echo app('translator')->get('Shipping'); ?></label>
                                    ...
                                    <div class="input-wrapper">
                                        ...
                                        <select class="input-cls" name="pickup_location">
                                            <?php $__currentLoopData = $pickups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pickup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($pickup->location); ?>">
                                                    <?php echo e($pickup->location); ?>
                                ...
                                <div class="col-lg-6">
                                    <div class="input-wrapper">
                                        <label class="label-cls" for="customer_name"><?php echo app('translator')->get('Name'); ?></label>
                                ...
                                <div class="col-lg-6">
                                    <div class="input-wrapper">
                                        <label class="label-cls" for="customer_email"><?php echo app('translator')->get('Email'); ?></label>
                                        <input class="input-cls" id="customer_email" type="text"
                                            name="customer_email" placeholder="<?php echo app('translator')->get('Your Email'); ?>"
                                            value="<?php echo e(Auth::check() ? Auth::user()->email : ''); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="input-wrapper">
                                        ...
                                        <input class="input-cls" id="phone" type="tel"
                                            placeholder="<?php echo app('translator')->get('Phone Number'); ?>" name="customer_phone"
                                ...
                                <div class="col-lg-6">
                                    <div class="input-wrapper">
                                        ...
                                        <input class="input-cls" id="address" type="text"
                                            placeholder="<?php echo app('translator')->get('Address'); ?>" name="customer_address"
                                ...
                                <div class="col-lg-6">
                                    <div class="input-wrapper">
                                        <label class="label-cls" for="zip">
                                            <?php echo app('translator')->get('Postal Code'); ?>
                                        </label>
                                        <input class="input-cls" id="zip" type="text"
                                            placeholder="<?php echo app('translator')->get('Postal Code'); ?>" name="customer_zip"
                                ...
                                <div class="col-lg-6 d-none">
                                    <div class="input-wrapper">
                                        <label class="label-cls"><?php echo app('translator')->get('Select Country'); ?></label>
                                ...
                                <div class="col-lg-6 d-none select_state">
                                    <div class="input-wrapper">
                                        <label class="label-cls"><?php echo app('translator')->get('Select State'); ?></label>
                                ...
                                <div class="col-lg-6 d-none">
                                    <div class="input-wrapper">
                                        <label class="label-cls"><?php echo app('translator')->get('Select City'); ?></label>
                                ...
                                <div class="col-lg-12">
                                    <div class="alert alert-info d-flex align-items-center" role="alert">
                                        ...
                                        <div>
                                            <strong><?php echo app('translator')->get('Please select your delivery location from the map below'); ?></strong>
                                        </div>
                                    </div>
                                    <div class="mt-3 mb-3">
                                        <button type="button" class="btn btn-outline-primary w-100" data-bs-toggle="modal" data-bs-target="#mapModal" style="padding: 12px;">
                                            <i class="fas fa-map-marker-alt"></i> <?php echo app('translator')->get('Select Location from Map'); ?>
                                        </button>
                                    </div>
                                </div>

                                <!-- chekbox -->
                                <div class="col-lg-12  <?php echo e($digital == 1 ? 'd-none' : ''); ?>" id="ship_deff">
                                    <div class="gs-checkbox-wrapper" data-bs-toggle="collapse"
                                        ...
                                        <label for="shpto"><?php echo app('translator')->get('Ship to a Different Address?'); ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="collapse" id="show_shipping_address">
                            <h4 class="form-title"><?php echo app('translator')->get('Shipping Address'); ?></h4>
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="input-wrapper">
                                        ...
                                        <input class="input-cls" id="shipping_name" type="text"
                                            placeholder="<?php echo app('translator')->get('Full Name'); ?>" name="shipping_name">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="input-wrapper">
                                        ...
                                        <input class="input-cls" id="shipping_phone" name="shipping_phone"
                                            type="tel" placeholder="<?php echo app('translator')->get('Phone Number'); ?>">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="input-wrapper">
                                        ...
                                        <input class="input-cls" id="shipping_address" name="shipping_address"
                                            type="text" placeholder="<?php echo app('translator')->get('Address'); ?>">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="input-wrapper">
                                        ...
                                        <input class="input-cls" id="shipping_zip" name="shipping_zip" type="text"
                                            placeholder="<?php echo app('translator')->get('Postal Code'); ?>">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="input-wrapper">
                                        <label class="label-cls" for="shipping_city"><?php echo app('translator')->get('City'); ?></label>
                                ...
                                <div class="col-lg-6">
                                    <div class="input-wrapper">
                                        <label class="label-cls" for="shipping_state"><?php echo app('translator')->get('State'); ?></label>
                                        <input class="input-cls" id="shipping_state" name="shipping_state"
                                            type="text" placeholder="<?php echo app('translator')->get('State'); ?>">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="input-wrapper">
                                ...
                                <div class="col-lg-12">
                                    <div class="input-wrapper">
                                        <label class="label-cls" for="Order-Note">
                                            <?php echo app('translator')->get('Order Note'); ?>
                                        </label>
                                        <input class="input-cls" id="Order-Note" name="order_notes" type="text"
                                            placeholder="<?php echo app('translator')->get('Order note (Optional)'); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="summary-box">
                            ...
                            <div class="summary-inner-box">
                                <div class="btn-wrappers">
                                    ...
                                    <a href="<?php echo e(route('front.cart')); ?>" class="template-btn dark-outline w-100">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24"
                                            viewBox="0 0 25 24" fill="none">
                ...
                <?php if(Session::has('coupon_total')): ?>
                    <input type="hidden" name="total" id="grandtotal"
                        value="<?php echo e(round($totalPrice * $curr->value, 2)); ?>">
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
                    <h5 class="modal-title"><?php echo app('translator')->get('Select location on map'); ?></h5>
                    ...
                    <div style="padding: 20px;">
                        <div id="map-container" style="position: relative; height: 500px; border-radius: 8px; overflow: hidden; border: 2px solid #e0e0e0;">
                            <div class="map-search" style="position: absolute; top: 10px; right: 10px; left: 10px; z-index: 10;">
                                <input type="text" id="map-search-input" placeholder="<?php echo app('translator')->get('Search for an address...'); ?>"
                        ...
                        <div class="buttons-container" style="display: flex; gap: 10px; margin-top: 15px;">
                            <button class="btn btn-secondary" id="reset-btn-modal" type="button">
                                <?php echo app('translator')->get('Reset Location'); ?>
                            </button>
                            <button class="btn btn-secondary" id="current-location-btn-modal" type="button">
                                <?php echo app('translator')->get('My Current Location'); ?>
                            </button>
                        </div>
                        ...
                        <div class="location-info" id="location-info-modal" style="display: none; background: #f8f9fa; padding: 20px; border-radius: 8px; margin-top: 20px;">
                            <h6 style="font-size: 16px; color: #333; margin-bottom: 15px; padding-bottom: 10px; border-bottom: 2px solid #667eea;"><?php echo app('translator')->get('Location Information'); ?></h6>

                            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 15px;">
                                <div style="background: white; padding: 15px; border-radius: 6px; border-right: 3px solid #667eea;">
                                    <label style="display: block; font-size: 12px; color: #666; margin-bottom: 5px; font-weight: 600;"><?php echo app('translator')->get('Country (Arabic)'); ?></label>
                                    <div id="country-ar-modal" style="font-size: 14px; color: #333;">-</div>
                                </div>
                                <div style="background: white; padding: 15px; border-radius: 6px; border-right: 3px solid #667eea;">
                                    <label style="display: block; font-size: 12px; color: #666; margin-bottom: 5px; font-weight: 600;"><?php echo app('translator')->get('Country (English)'); ?></label>
                                    <div id="country-en-modal" style="font-size: 14px; color: #333;">-</div>
                                </div>
                                <div style="background: white; padding: 15px; border-radius: 6px; border-right: 3px solid #667eea;">
                                    <label style="display: block; font-size: 12px; color: #666; margin-bottom: 5px; font-weight: 600;"><?php echo app('translator')->get('State (Arabic)'); ?></label>
                                    <div id="state-ar-modal" style="font-size: 14px; color: #333;">-</div>
                                </div>
                                <div style="background: white; padding: 15px; border-radius: 6px; border-right: 3px solid #667eea;">
                                    <label style="display: block; font-size: 12px; color: #666; margin-bottom: 5px; font-weight: 600;"><?php echo app('translator')->get('State (English)'); ?></label>
                                    <div id="state-en-modal" style="font-size: 14px; color: #333;">-</div>
                                </div>
                                <div style="background: white; padding: 15px; border-radius: 6px; border-right: 3px solid #667eea;">
                                    <label style="display: block; font-size: 12px; color: #666; margin-bottom: 5px; font-weight: 600;"><?php echo app('translator')->get('City (Arabic)'); ?></label>
                                    <div id="city-ar-modal" style="font-size: 14px; color: #333;">-</div>
                                </div>
                                <div style="background: white; padding: 15px; border-radius: 6px; border-right: 3px solid #667eea;">
                                    <label style="display: block; font-size: 12px; color: #666; margin-bottom: 5px; font-weight: 600;"><?php echo app('translator')->get('City (English)'); ?></label>
                            ...
                            <div style="display: flex; gap: 15px; margin-top: 15px;">
                                <div style="flex: 1; background: white; padding: 15px; border-radius: 6px; text-align: center;">
                                    <label style="display: block; font-size: 12px; color: #666; margin-bottom: 5px;"><?php echo app('translator')->get('Latitude'); ?></label>
                                    <div id="latitude-value-modal" style="font-size: 16px; font-weight: 600; color: #667eea;">-</div>
                                </div>
                                <div style="flex: 1; background: white; padding: 15px; border-radius: 6px; text-align: center;">
                                    <label style="display: block; font-size: 12px; color: #666; margin-bottom: 5px;"><?php echo app('translator')->get('Longitude'); ?></label>
                            ...
                            <div style="margin-top: 15px;">
                                <div style="background: white; padding: 15px; border-radius: 6px;">
                                    <label style="display: block; font-size: 12px; color: #666; margin-bottom: 5px; font-weight: 600;"><?php echo app('translator')->get('Full Address'); ?></label>
                            ...
                            <div id="tryoto-info-modal" style="display: none; margin-top: 15px; padding: 15px; border-radius: 8px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                                <div style="display: flex; align-items: center; margin-bottom: 10px;">
                                    ...
                                    <h6 style="color: white; margin: 0; font-size: 15px; font-weight: 600;"><?php echo app('translator')->get('Tryoto Shipping Information'); ?></h6>
                                </div>
                                    ...
                                    <div style="display: flex; align-items: start;">
                                        ...
                                        <div style="flex: 1;">
                                            <p style="margin: 0; font-size: 13px; color: #856404; font-weight: 600;">
                                                <?php echo app('translator')->get('Selected location is not supported for shipping'); ?>
                                            </p>
                                            <p style="margin: 5px 0 0 0; font-size: 12px; color: #856404;">
                                                <strong><?php echo app('translator')->get('Nearest supported city'); ?>:</strong>
                                                <span id="tryoto-alternative-city" style="font-weight: 700;">-</span>
                                                (<span id="tryoto-alternative-distance">-</span> <?php echo app('translator')->get('km'); ?>)
                                            </p>
                                            <p style="margin: 5px 0 0 0; font-size: 11px; color: #856404;">
                                                <?php echo app('translator')->get('Shipping will be to'); ?> <strong id="tryoto-alternative-city-ar">-</strong> <?php echo app('translator')->get('and we will contact you to coordinate delivery'); ?>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="tryoto-not-supported-box" style="display: none; background: rgba(255, 82, 82, 0.1); padding: 12px; border-radius: 6px; margin-top: 10px; border-right: 4px solid #dc3545;">
                                    <div style="display: flex; align-items: center;">
                                        ...
                                        <p style="margin: 0; font-size: 13px; color: #721c24; font-weight: 600;">
                                            <?php echo app('translator')->get('Sorry, this location is outside the available shipping area'); ?>
                                        </p>
                                    </div>
                                    <p style="margin: 5px 0 0 0; font-size: 11px; color: #721c24;">
                                        <?php echo app('translator')->get('Please select a location within Saudi Arabia'); ?>
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="use-location-btn-modal" disabled><?php echo app('translator')->get('Use This Location'); ?></button>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script type="text/javascript">
        ...
        */
        ...
        $(document).on('change', '#show_state', function() {
            ...
            $.get("<?php echo e(route('state.wise.city')); ?>", {
                state_id: state_id
            }, function(data) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data[1] && parseFloat(data[1]) > 0) {
                        ...
                        if (pos == 0) {
                            $('.tax-amount-value').html('<?php echo e($curr->sign); ?>' + taxAmount.toFixed(2));
                        } else {
                            $('.tax-amount-value').html(taxAmount.toFixed(2) + '<?php echo e($curr->sign); ?>');
                        }
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(config('services.google_maps.api_key')); ?>&libraries=places&language=en" async defer></script>
    <script>
