                    ...
                    <div class="muaadh-map-body">
                        <div id="map-container" class="muaadh-map-container">
                            <div class="muaadh-map-search">
                                <input type="text" id="map-search-input" class="muaadh-map-search-input" placeholder="<?php echo app('translator')->get('Search for an address...'); ?>">
                            </div>
                        ...
                        <div class="muaadh-location-info" id="location-info-modal">
                            <h6 class="muaadh-location-info-title"><?php echo app('translator')->get('Location Information'); ?></h6>

                            <div class="muaadh-location-grid">
                                <div class="muaadh-location-item">
                                    <label class="muaadh-location-item-label"><?php echo app('translator')->get('Country (Arabic)'); ?></label>
                                    <div id="country-ar-modal" class="muaadh-location-item-value">-</div>
                                </div>
                                <div class="muaadh-location-item">
                                    <label class="muaadh-location-item-label"><?php echo app('translator')->get('Country (English)'); ?></label>
                                    <div id="country-en-modal" class="muaadh-location-item-value">-</div>
                                </div>
                                <div class="muaadh-location-item">
                                    <label class="muaadh-location-item-label"><?php echo app('translator')->get('State (Arabic)'); ?></label>
                                    <div id="state-ar-modal" class="muaadh-location-item-value">-</div>
                                </div>
                                <div class="muaadh-location-item">
                                    <label class="muaadh-location-item-label"><?php echo app('translator')->get('State (English)'); ?></label>
                                    <div id="state-en-modal" class="muaadh-location-item-value">-</div>
                                </div>
                                <div class="muaadh-location-item">
                                    <label class="muaadh-location-item-label"><?php echo app('translator')->get('City (Arabic)'); ?></label>
                                    <div id="city-ar-modal" class="muaadh-location-item-value">-</div>
                                </div>
                                <div class="muaadh-location-item">
                                    <label class="muaadh-location-item-label"><?php echo app('translator')->get('City (English)'); ?></label>
                            ...
                            <div class="muaadh-coords-row">
                                <div class="muaadh-coords-item">
                                    <label class="muaadh-location-item-label"><?php echo app('translator')->get('Latitude'); ?></label>
                                    <div id="latitude-value-modal" class="muaadh-coords-value">-</div>
                                </div>
                                <div class="muaadh-coords-item">
                                    <label class="muaadh-location-item-label"><?php echo app('translator')->get('Longitude'); ?></label>
                            ...
                            <div class="mt-3">
                                <div class="muaadh-location-item">
                                    <label class="muaadh-location-item-label"><?php echo app('translator')->get('Full Address'); ?></label>
                            ...
                            <div id="tryoto-info-modal" class="muaadh-tryoto-info">
                                <div class="muaadh-tryoto-header">
                                    ...
                                    <h6><?php echo app('translator')->get('Tryoto Shipping Information'); ?></h6>
                                </div>
                                ...
                                <div id="tryoto-alternative-box" class="muaadh-tryoto-alternative">
                                    <div class="muaadh-tryoto-alternative-content">
                                        ...
                                        <div class="muaadh-tryoto-alternative-text">
                                            <p><?php echo app('translator')->get('Selected location is not supported for shipping'); ?></p>
                                            <p>
                                ...
                                <div id="tryoto-not-supported-box" class="muaadh-tryoto-not-supported">
                                    <div class="muaadh-tryoto-not-supported-content">
                                        ...
                                        <p><?php echo app('translator')->get('Sorry, this location is outside the available shipping area'); ?></p>
                                    </div>
