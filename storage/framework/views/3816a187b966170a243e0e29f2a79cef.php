    ...
    <section class="gs-breadcrumb-section bg-class"
        ...
        <div class="container">
            <div class="row justify-content-center content-wrapper">
                <div class="col-12">
                    <h2 class="breadcrumb-title"><?php echo app('translator')->get('Vednor Shop'); ?></h2>
                    <ul class="bread-menu">
                        <li><a href="<?php echo e(route('front.index')); ?>"><?php echo app('translator')->get('Home'); ?></a></li>
                        <li><a href="javascript:;"><?php echo app('translator')->get('Vednor Shop :'); ?> </a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row flex-column-reverse flex-lg-row">
                <div class="col-12 col-lg-4 col-xl-3 mt-40 mt-lg-0">
                    <div class="gs-product-sidebar-wrapper">
                        <div class="single-product-widget contact-vendor-wrapper">
                            <h5 class="widget-title"><?php echo app('translator')->get('Contact Vendor'); ?></h5>
                            <div class="img-wrapper">
                                <img src="<?php echo e(asset('assets/images/users/' . $vendor->photo)); ?>" alt="vendor img">
                            </div>
                            <ul>
                                <li><span><b><?php echo app('translator')->get('Store Name:'); ?> </b><?php echo e($vendor->shop_name); ?></span></li>
                                <li><span><b><?php echo app('translator')->get('Owner Name:'); ?> </b><?php echo e($vendor->owner_name); ?></span></li>
                                <li><span><b><?php echo app('translator')->get('Phone:'); ?> </b> <?php echo e($vendor->shop_number); ?></span></li>
                                <li><span><b><?php echo app('translator')->get('Email:'); ?> </b><?php echo e($vendor->email); ?></span></li>
                                <li><span><b><?php echo app('translator')->get('Address:'); ?> </b><?php echo e($vendor->shop_address); ?></span></li>
                            </ul>
                            <?php if(!auth()->id() == $vendor->id): ?>
                            <?php if(auth()->check()): ?>
                                ...
                                <div class="vendor-input-wrapper">
                                    ...
                                    <div class="input-wrapper">
                                        <input class="input-cls" id="email" name="email" type="email"
                                            placeholder="<?php echo app('translator')->get('Email'); ?>" readonly value="<?php echo e($vendor->email); ?>" />
                                    </div>
                                    <div class="input-wrapper">
                                    ...
                                    <div class="input-wrapper">
                                        <textarea placeholder="<?php echo app('translator')->get('Type Your Message...'); ?>" name="message" class="input-cls txtarea-cls" rows="3"></textarea>
                                    </div>
                                    <div class="input-wrapper">
                                        <button class="template-btn w-100" type="submit"><?php echo app('translator')->get('Send Message'); ?></button>
                                    </div>
                                </div>
                            </form>
                            <?php else: ?>
                            <div class="input-wrapper">
                                <a href="<?php echo e(route("user.login")); ?>" class="template-btn w-100" type="button"><?php echo app('translator')->get('Login for Send Message'); ?></a>
                            </div>
                            <?php endif; ?>  
                            <?php endif; ?>
                ...
                <div class="col-12 col-lg-8 col-xl-9 gs-main-blog-wrapper">
                    ...
                    <div class=" product-nav-wrapper">
                        <h5><?php echo app('translator')->get('Total Products Found:'); ?> <?php echo e($vprods->count()); ?></h5>
                    ...
                    <?php else: ?>
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade <?php echo e($view == 'list-view' ? 'show active' : ''); ?>"
                                ...
                                <div class="row gy-4 mt-20 ">
                                    <?php $__currentLoopData = $vprods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php echo e($vprods->links('includes.frontend.pagination')); ?>
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        function filter() {
            let filterlink =
                '<?php echo e(route('front.vendor', str_replace(' ', '-', $vendor->shop_name))); ?>';
