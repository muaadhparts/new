    ...
    <div class="gs-vendor-outlet">
        ...
        <div class="gs-vendor-breadcrumb has-mb">
            ...
            <div class="gs-deposit-title d-flex align-items-center gap-4">
                <a href="<?php echo e(route("vendor-order-index")); ?>" class="back-btn">
                    <i class="fa-solid fa-arrow-left-long"></i>
                </a>
                <h4 class="text-capitalize"><?php echo app('translator')->get('Order Invoice'); ?></h4>
            </div>
            ...
            <ul class="breadcrumb-menu">
                ...
                <li>
                    <a href="#" class="text-capitalize"> <?php echo app('translator')->get('Order'); ?> </a>
                </li>
                <li>
                    <a href="#" class="text-capitalize"><?php echo app('translator')->get('Invoice'); ?>  </a>
                </li>
            </ul>
        </div>
        <!-- breadcrumb end -->
        ...
        <div class="gs-vendor-order-invoice">
            ...
            <div class="user-purchase-title-wrapper">
                <div>
                    <h4 class="order-number"><?php echo app('translator')->get('Genius Shop'); ?></h4>
                </div>

                <a href="<?php echo e(route('vendor-order-print',$order->order_number)); ?>" class="template-btn dark-btn" type="button">
                    <?php echo app('translator')->get('Print Order'); ?>
            ...
            <div class="purchase-address-wrapper">
                ...
                <div class="address-item w-100">
                    <h5><?php echo app('translator')->get('Order Details'); ?></h5>
                    <ul>
                        <li>
                            <span class="fw-semibold"><?php echo app('translator')->get('Invoice Number :'); ?></span>
                            <span class="fw-normal"><?php echo e($order->order_number); ?></span>
                        </li>
                        <li>
                            <span class="fw-semibold"><?php echo app('translator')->get('Order Date :'); ?></span>
                            <span class="fw-normal"><?php echo e(date('d-M-Y H:i:s a', strtotime($order->created_at))); ?></span>
                        </li>

                        <?php if(isset($shipping)): ?>
                            <li>
                                <span class="fw-semibold"><?php echo app('translator')->get('Shipping Method :'); ?></span>
                                <span class="fw-normal">
                                    <?php echo e($shipping->title); ?> |
                                    <?php echo e(\PriceHelper::showOrderCurrencyPrice($shipping->price * $order->currency_value, $order->currency_sign)); ?>
                        ...
                        <?php if(isset($packaging)): ?>
                            <li>
                                <span class="fw-semibold"><?php echo app('translator')->get('Packaging Method :'); ?></span>
                                <span class="fw-normal">
                                    <?php echo e($packaging->title); ?>
                        ...
                        <li>
                            <span class="fw-semibold"><?php echo app('translator')->get('Payment Method :'); ?></span>
                            <span class="fw-normal"><?php echo e($order->method); ?></span>
                        </li>

                        <li>
                            <span class="fw-semibold"><?php echo app('translator')->get('Transaction ID :'); ?></span>
                            <span class="fw-normal"><?php echo e($order->txnid ?? '--'); ?></span>
                        </li>
                        <li>
                            <span class="fw-semibold"><?php echo app('translator')->get('Payment Status :'); ?></span>
                ...
                <div class="address-item">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <?php echo e($order->shipping_name == null ? $order->customer_name : $order->shipping_name); ?>

                        </li>

                        <?php if($order->shipping_address != null || $order->customer_address != null ): ?>
                        ...
                        <li>
                            ...
                            <?php echo e($order->shipping_address == null ? $order->customer_address : $order->shipping_address); ?>
                        ...
                        <li>
                            ...
                            <?php echo e($order->shipping_phone == null ? $order->customer_phone : $order->shipping_phone); ?>
                        ...
                        <li>
                            ...
                            <?php echo e($order->shipping_email == null ? $order->customer_email : $order->shipping_email); ?>
                                            ...
                                            <td>
                                                ...
                                                <?php if($product['item']['user_id'] != 0): ?>
                                                    ...
                                                    <span class="content product-title d-inline-block">
                                                        <a target="_blank" href="<?php echo e($vendorInvoiceProductUrl); ?>">
                                                ...
                                                <div class="rider">
                                                    ...
                                                    <?php if($product['size']): ?>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <span
                                                                class="value"><?php echo e(str_replace('-', '', $product['size'])); ?></span>
                                                        </div>
                                                    <?php endif; ?>
                                                    ...
                                                    <?php if($product['color']): ?>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <span
                                                                style="width: 20px; height: 20px; display: inline-block; vertical-align: middle; border-radius: 50%; background: #<?php echo e($product['color']); ?>;"
                                                                class="value"></span>
                                                        </div>
                                                    <?php endif; ?>
                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <span
                                                            class="value"><?php echo e(\PriceHelper::showOrderCurrencyPrice($product['item_price'] * $order->currency_value, $order->currency_sign)); ?></span>
                                                    </div>
                                                    ...
                                                    <?php if(!empty($product['keys'])): ?>
                                                        <?php $__currentLoopData = array_combine(explode(',', $product['keys']), explode(',', $product['values'])); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <span
                                                                    class="key"><?php echo e(ucwords(str_replace('_', ' ', $key))); ?>
            ...
            <ul class="calculation-list">
                <li class="calculation-list-item">
                    <span class="amount-type"><?php echo app('translator')->get('Subtotal'); ?></span> <span
                        class="amount"><?php echo e(\PriceHelper::showOrderCurrencyPrice($subtotal, $order->currency_sign)); ?></span>
                </li>
                ...
                <?php if(Auth::user()->id == $order->vendor_shipping_id): ?>
                    <?php if($order->shipping_cost != 0): ?>
                        <li class="calculation-list-item">
                            <span class="amount-type"><?php echo app('translator')->get('Shipping Cost'); ?></span> <span
                                class="amount"><?php echo e(\PriceHelper::showOrderCurrencyPrice($order->shipping_cost, $order->currency_sign)); ?></span>
                        </li>
                ...
                <?php if(Auth::user()->id == $order->vendor_packing_id): ?>
                    <?php if($order->packing_cost != 0): ?>
                        <li class="calculation-list-item">
                            <span class="amount-type"><?php echo app('translator')->get('Packaging Cost'); ?></span> <span
                                class="amount"><?php echo e(\PriceHelper::showOrderCurrencyPrice($order->packing_cost, $order->currency_sign)); ?></span>
                        </li>
                        <?php
                ...
                <?php if($order->tax != 0): ?>
                    ...
                    <li class="calculation-list-item">
                        <span class="amount-type"><?php echo app('translator')->get('TAX'); ?>(<?php echo e($order->currency_sign); ?>)</span> <span
                            class="amount"><?php echo e(\PriceHelper::showOrderCurrencyPrice($tax, $order->currency_sign)); ?></span>
                    </li>
                <?php endif; ?>
                ...
                <li class="calculation-list-item">
                    <span class="amount-type"><?php echo app('translator')->get('Total'); ?></span> <span
                        class="amount"><?php echo e(\PriceHelper::showOrderCurrencyPrice($subtotal + $data, $order->currency_sign)); ?></span>
                </li>
            </ul>
        </div>
