                ...
                <div class="info-left">
                    <ul class="wows align-items-center">
                        <li><a href="tel:+1(234)567-8901">
                                <?php echo app('translator')->get('Contact & Support'); ?>: <?php echo e($ps->phone); ?></a>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul class="d-flex wows align-items-center">
                        ...
                        <?php if(Auth::guard('web')->check() && Auth::guard('web')->user()->is_vendor == 2): ?>
                            <li class="d-none d-lg-block"><a class="border px-3 py-1"
                                    href="<?php echo e(route('vendor.dashboard')); ?>"><?php echo e(__('Vendor Panel')); ?></a>
                            </li>
                        <?php else: ?>
                            <li class="d-none d-lg-block">
                                <a href="<?php echo e(route('vendor.login')); ?>" class="info-bar-btn">
                        ...
                        <?php if(!Auth::guard('rider')->check()): ?>
                            <li class="d-none d-lg-block"><a href="<?php echo e(route('rider.login')); ?>" class="info-bar-btn">
                                    <?php echo app('translator')->get('Rider Login'); ?>
                                </a>
                            </li>
                        <?php endif; ?>
                        ...
                        <li class="d-flex gap-2 align-items-center">
                            ...
                            <div class="dropdown">
                                <button class="dropdown-toggle" type="button" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    <?php echo e(Session::has('language')
                                ...
                                <ul class="dropdown-menu">
                                    <?php $__currentLoopData = $languges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <a class="dropdown-item dropdown__item <?php echo e(Session::has('language')
                                                ...
                                                : ($languges->where('is_default', '=', 1)->first()->id == $language->id
                                                    ? 'active'
                                                    : '')); ?>"
                                                href="<?php echo e(route('front.language', $language->id)); ?>"><?php echo e($language->language); ?></a>
                                        </li>
                                    ...
                                    <ul class="dropdown-menu">
                                        <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li>
                                                ...
                                                <a class="dropdown-item dropdown__item <?php echo e(Session::has('currency')
                                                    ...
                                                    : ($currencies->where('is_default', '=', 1)->first()->id == $currency->id
                                                        ? 'active'
                                                        : '')); ?>"
                                                    href="<?php echo e(route('front.currency', $currency->id)); ?>"><?php echo e($currency->name); ?></a>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <li class="d-none  d-md-flex gap-2 align-items-center">
                            ...
                            <?php elseif(Auth::guard('rider')->check()): ?>
                                <a href="<?php echo e(route('rider-dashboard')); ?>"><?php echo app('translator')->get('Dashboard'); ?></a>
                            <?php else: ?>
                                <a href="<?php echo e(route('user.login')); ?>"><?php echo app('translator')->get('My Account'); ?></a>
                            <?php endif; ?>
        ...
        <div class="container custom-containerr">
            <div class="create-navbar d-flex">
                ...
                <div class="nav-left">
                    ...
                    <a class="header-logo-wrapper" href="<?php echo e(route('front.index')); ?>">
                        <img class="logo" src="<?php echo e(asset('assets/images/' . $gs->logo)); ?>" alt="logo">
                    </a>
                </div>
                <div class="nav-center">
                    <ul class="d-flex align-items-center nav-menus">
                        <li class=""><a href="<?php echo e(route('front.index')); ?>"
                                class="nav-link <?php echo e(request()->path() == '/' ? 'active' : ''); ?>"><?php echo app('translator')->get('Home'); ?></a>
                        </li>
                        <li class="has-megamenu <?php echo e(request()->path() == 'category' ? 'active' : ''); ?>">
                                ...
                                <?php $__currentLoopData = $pages->where('header', '=', 1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <a class="dropdown-item dropdown__item"
                                            href="<?php echo e(route('front.vendor', $data->slug)); ?>"><?php echo e($data->title); ?></a>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if($ps->blog == 1): ?>
                            <li class="<?php echo e(request()->path() == 'blog' ? 'active' : ''); ?>"><a
                                    href="<?php echo e(route('front.blog')); ?>" class="nav-link"><?php echo app('translator')->get('Blog'); ?></a>
                        <?php endif; ?>
                        </li>
                        <li class="<?php echo e(request()->path() == 'faq' ? 'active' : ''); ?>"><a
                                href="<?php echo e(route('front.faq')); ?>" class="nav-link"><?php echo app('translator')->get('Faq'); ?></a>
                        </li>
                        <li class="<?php echo e(request()->path() == 'contact' ? 'active' : ''); ?>"><a
                                href="<?php echo e(route('front.contact')); ?>" class="nav-link"><?php echo app('translator')->get('Contact Us'); ?></a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="nav-right">
                    ...
                    <div class="icon-circle">
                        ...
                        <?php if(Auth::guard('web')->check()): ?>
                            <a href="<?php echo e(auth()->check() ? route('user-wishlists') : route('user.login')); ?>">
                                <span class="cart-count" id="wishlist-count">
                                    <?php echo e(Auth::guard('web')->user()->wishlistCount()); ?>
