    ...
    <section class="gs-breadcrumb-section bg-class"
        ...
        <div class="container">
            <div class="row justify-content-center content-wrapper">
                <div class="col-12">
                    <h2 class="breadcrumb-title"><?php echo app('translator')->get('Product Details'); ?></h2>
                    <ul class="bread-menu">
                        <li><a href="<?php echo e(route('front.index')); ?>"><?php echo app('translator')->get('Home'); ?></a></li>
                        <li><a href="#"><?php echo e($productt->localized_name); ?></a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row gy-4">
                <div class="col-12">
                    ...
                    <ul class="product-breadcrumb">
                        <li><a href="<?php echo e(route('front.index')); ?>"><?php echo app('translator')->get('home'); ?></a></li>
                        <li><a
                                href="<?php echo e(route('front.category', $productt->category->slug)); ?>"><?php echo e($productt->category->localized_name); ?></a>
                        </li>
                        <?php if($productt->subcategory_id): ?>
          
                            <li><a
                                    href="<?php echo e(route('front.category', [$productt->category->slug, $productt->subcategory->slug])); ?>"><?php echo e($productt->subcategory->localized_name); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if($productt->childcategory_id): ?>
             
                            <li><a
                                    href="<?php echo e(route('front.category', [$productt->category->slug, $productt->subcategory->slug, $productt->childcategory->slug])); ?>"><?php echo e($productt->childcategory->localized_name); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </div>
                ...
                <div class="col-lg-6 wow-replaced" data-wow-delay=".1s">
                    <div class="gs-product-details-gallery-wrapper">
                        <div class="product-main-slider">
                            <img src="<?php echo e(filter_var($productt->photo, FILTER_VALIDATE_URL) ? $productt->photo : ($productt->photo ? \Illuminate\Support\Facades\Storage::url($productt->photo) : asset('assets/images/noimage.png'))); ?>"
                                alt="Thumb Image"
                                data-zoom-image="<?php echo e(filter_var($productt->photo, FILTER_VALIDATE_URL) ? $productt->photo : ($productt->photo ? \Illuminate\Support\Facades\Storage::url($productt->photo) : asset('assets/images/noimage.png'))); ?>"
                            ...
                            <?php $__currentLoopData = $productt->galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <img src="<?php echo e(asset('assets/images/galleries/' . $gal->photo)); ?>"
                                    data-image="<?php echo e(asset('assets/images/galleries/' . $gal->photo)); ?>" class="main-img"
                                    alt="gallery-img">
                        ...
                        <div class="product-nav-slider">
                            ...
                            <?php $__currentLoopData = $productt->galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <img src="<?php echo e(asset('assets/images/galleries/' . $gal->photo)); ?>"
                                    data-image="<?php echo e(asset('assets/images/galleries/' . $gal->photo)); ?>" class="nav-img"
                                    alt="gallery-img">
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 wow-replaced" data-wow-delay=".2s">
                    <form>
                        ...
                        <div class="product-info-wrapper  <?php echo e($productt->type != 'Physical' ? 'mb-3' : ''); ?>">
                            <h3><?php echo e($productt->localized_name); ?></h3>
                            <div class="price-wrapper">
                                <h5 id="sizeprice"><?php echo e($productt->showPrice()); ?></h5>
                                <h5><del><?php echo e($productt->showPreviousPrice()); ?></del></h5>

                                <?php if($productt->offPercentage() && round($productt->offPercentage()) > 0): ?>
                                    <span class="product-badge">-<?php echo e(round($productt->offPercentage())); ?>%</span>
                                <?php endif; ?>
                            ...
                            <div class="rating-wrapper">
                                ...
                                <span class="rating"><?php echo e(number_format($productt->ratings_avg_rating, 1)); ?>

                                    (<?php echo e(App\Models\Rating::ratingCount($productt->id)); ?> <?php echo app('translator')->get('Reviews'); ?>)</span>
                            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.product-info','data' => ['product' => $productt,'mp' => $merchantProduct ?? null,'displayMode' => 'badges','showSku' => true,'showBrand' => true,'showQualityBrand' => true,'showVendor' => true,'showStock' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['product' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($productt),'mp' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($merchantProduct ?? null),'display-mode' => 'badges','show-sku' => true,'show-brand' => true,'show-quality-brand' => true,'show-vendor' => true,'show-stock' => true]); ?>
...
<?php endif; ?>
                                ...
                                <ul>
                                    <li>
                                        <?php if($productt->type == 'Physical'): ?>
                                            <span><b><?php echo app('translator')->get('Availability :'); ?> </b></span>
                                            <?php if($productt->emptyStock()): ?>
                                                <div class="stock-availability out-stock"><?php echo e(__('Out Of Stock')); ?></div>
                                            <?php else: ?>
                                                <?php echo e($gs->show_stock == 0 ? '' : $productt->stock); ?> <?php echo e(__('In Stock')); ?>
                                    ...
                                    <?php if($productt->ship != null): ?>
                                        <li>
                                            <span><b><?php echo app('translator')->get('Estimated Shipping Time :'); ?> </b></span>
                                            <span><?php echo e($productt->ship); ?></span>
                                        </li>
                                    <?php endif; ?>
                                    <?php if($productt->sku != null): ?>
                                        <li>
                                            <span><b><?php echo app('translator')->get('Product SKU :'); ?> </b></span>
                                            <span><?php echo e($productt->sku); ?> </span>
                                        </li>
                                    <?php endif; ?>

                                    <?php if($productt->type == 'License'): ?>
                                        <?php if($productt->platform != null): ?>
                                            <span><b><?php echo app('translator')->get('Platform:'); ?> </b></span>
                                            <span><?php echo e($productt->platform); ?> </span>
                                        <?php endif; ?>
                                        <?php if($productt->region != null): ?>
                                            <span><b><?php echo app('translator')->get('Region:'); ?> </b></span>
                                            <span><?php echo e($productt->region); ?> </span>
                                        <?php endif; ?>
                                        <?php if($productt->licence_type != null): ?>
                                            <span><b><?php echo app('translator')->get('License Type:'); ?> </b></span>
                                            <span><?php echo e($productt->licence_type); ?> </span>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                </ul>
                            </div>
                                    ...
                                    <?php if(array_key_exists('details_status', $attrVal) && $attrVal['details_status'] == 1): ?>
                                        <div class="col-lg-6">
                                            <div class="attribute-wrapper">
                                                <span class="attribute-title"><?php echo e(str_replace('_', ' ', $attrKey)); ?>
                                                    ...
                                                    <?php $__currentLoopData = $attrVal['values']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optionKey => $optionVal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li class="gs-radio-wrapper">
                                                            <input type="radio"
                                                                ...
                                                                data-price = "<?php echo e($attrVal['prices'][$optionKey] * $curr->value); ?>"
                                                                value="<?php echo e($optionVal); ?>" name="<?php echo e($attrKey); ?>"
                                                                <?php echo e($loop->first ? 'checked' : ''); ?> class="cart_attr">
                                                            ...
                                                            <label for="<?php echo e($attrKey); ?><?php echo e($optionKey); ?>">
                                                                <?php echo e($optionVal); ?>

                                                                <?php if(!empty($attrVal['prices'][$optionKey])): ?>
                                                                    +
                                                                    <?php echo e($curr->sign); ?>

                                                                    <?php echo e($attrVal['prices'][$optionKey] * $curr->value); ?>
                        ...
                        <?php if($productt->stock_check == 1): ?>
                            <?php if(!empty($productt->size)): ?>
                                ...
                                <div class="variation-wrapper variation-sizes">
                                    <span class="varition-title"><?php echo app('translator')->get('Size :'); ?></span>
                                    <ul>
                                        <?php $__currentLoopData = array_unique($productt->size); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="<?php echo e($loop->first ? 'active' : ''); ?> cart_size"
                                                data-price="<?php echo e($productt->size_price[$key] * $curr->value); ?>">
                                                <input <?php echo e($loop->first ? 'checked' : ''); ?> type="radio"
                                                    id="size_<?php echo e($key); ?>" data-value="<?php echo e($key); ?>"
                                                    data-key="<?php echo e(str_replace(' ', '', $data1)); ?>"
                                                    data-price="<?php echo e($productt->size_price[$key] * $curr->value); ?>"
                                                    data-qty="<?php echo e($productt->size_qty[$key]); ?>" value="<?php echo e($key); ?>"
                                                    name="size">
                                                <label for="size_<?php echo e($key); ?>"><?php echo e($data1); ?></label>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                </div>
                            ...
                            <?php if(!empty($productt->color_all)): ?>
                                ...
                                <div class="variation-wrapper variation-colors">
                                    <span class="varition-title"><?php echo app('translator')->get('Color :'); ?></span>
                                    <ul>
                                        <?php $__currentLoopData = $productt->color_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ckey => $color1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="<?php echo e($loop->first ? 'active' : ''); ?> cart_color">
                                                <input <?php echo e($loop->first ? 'checked' : ''); ?> type="radio" data-price="0"
                                                    data-color="<?php echo e($color1); ?>" id="color_<?php echo e($ckey); ?>"
                                                    name="colors" value="<?php echo e($ckey); ?>">
                                                <label for="color_<?php echo e($ckey); ?>"
                                                    data-color-code="<?php echo e($color1); ?>"
                                                    data-outline-color-code="<?php echo e($color1); ?>"></label>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if($productt->type == 'Physical'): ?>
                            ...
                            <?php if(is_array($productt->size)): ?>
                                <input type="hidden" id="stock" value="<?php echo e($productt->size_qty[0]); ?>">
                            <?php else: ?>
                                <?php if(!$productt->emptyStock()): ?>
                                    <?php if($productt->stock_check == 1): ?>
                                        <input type="hidden" id="stock" value="<?php echo e($productt->size_price[0]); ?>">
                                    <?php else: ?>
                            ...
                            <div class="add-qty-wrapper">
                                <span class="varition-title"><?php echo app('translator')->get('Quantity :'); ?></span>
                                <div class="product-input-wrapper">
                                    <button class="action-btn qtminus" type="button">-</button>

                                    <input class="qty-input qttotal" type="text" readonly id="order-qty"
                                        value="<?php echo e($productt->minimum_qty == null ? '1' : (int) $productt->minimum_qty); ?>">
                        ...
                        <input type="hidden" id="product_price"
                            value="<?php echo e(round($productt->vendorPrice() * $curr->value, 2)); ?>">
                        <input type="hidden" id="product_id" value="<?php echo e($productt->id); ?>">
                        <input type="hidden" id="merchant_product_id" value="<?php echo e(isset($merchantProduct) ? $merchantProduct->id : (isset($merchant) ? $merchant->id : '')); ?>">
                        <input type="hidden" id="vendor_user_id" value="<?php echo e(isset($merchantProduct) ? $merchantProduct->user_id : (isset($merchant) ? $merchant->user_id : '')); ?>">
                        ...
                        <div class="row row-cols-2">
                            ...
                            <div class="col">
                                <button type="button" class="template-btn w-100"
                                    id="addtobycard"><?php echo app('translator')->get('buy now'); ?></button>
                            </div>
                        </div>
                        ...
                        <div class="wish-compare-report-wrapper">
                            <?php if(Auth::check()): ?>
                                <a href="javascript:;" data-href="<?php echo e(route('user-wishlist-add', $productt->id)); ?>"
                                    class="link wishlist">
                                    ...
                                    <span class="title"><?php echo app('translator')->get('Add to Wishlist'); ?></span>
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(route('user.login')); ?>" class="link">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M11.9932 5.13581C9.9938 2.7984 6.65975 2.16964 4.15469 4.31001C1.64964 6.45038 1.29697 10.029 3.2642 12.5604C4.89982 14.6651 9.84977 19.1041 11.4721 20.5408C11.6536 20.7016 11.7444 20.7819 11.8502 20.8135C11.9426 20.8411 12.0437 20.8411 12.1361 20.8135C12.2419 20.7819 12.3327 20.7016 12.5142 20.5408C14.1365 19.1041 19.0865 14.6651 20.7221 12.5604C22.6893 10.029 22.3797 6.42787 19.8316 4.31001C17.2835 2.19216 13.9925 2.7984 11.9932 5.13581Z"
                            ...
                            <?php if($productt->type != 'Listing'): ?>
                                <a data-href="<?php echo e(route('product.compare.add', $productt->id)); ?>" href="javascript:;"
                                    ...
                                    <span class="title"><?php echo app('translator')->get('Add to Compare'); ?></span>
                                </a>
                            <?php endif; ?>

                            <?php if($gs->is_report == 1): ?>
                                <?php if(Auth::guard('web')->check()): ?>
                                    <a href="#" class="link report-item" href="javascript:;"
                                        ...
                                        <span class="title"><?php echo app('translator')->get('Report This Item'); ?></span>
                                    </a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('user.login')); ?>" class="link">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        <div class="share-links social-linkss social-sharing a2a_kit a2a_kit_size_32">
                            <h4><?php echo app('translator')->get('Share:'); ?></h4>
                        ...
                        <div class="store-seller-wrapper">
                            <span> <b><?php echo app('translator')->get('Sold By :'); ?></b>

                                <?php if(isset($merchant) && $merchant->user): ?>
                                    <?php echo e($merchant->user->shop_name); ?>

                                    <?php if($merchant->user->checkStatus()): ?>
                                        <a class="verify-link" href="javascript:;" data-original-title="">
                                            <?php echo e(__('Verified')); ?> <i class="fas fa-check-circle"></i>
                                        </a>
                                    <?php endif; ?>
                                <?php else: ?>
                            ...
                            <span> <b><?php echo app('translator')->get('Total Items :'); ?></b>
                                <?php if(isset($merchant) && $merchant->user): ?>
                                    <?php echo e(App\Models\MerchantProduct::where('user_id', '=', $merchant->user_id)->where('status', 1)->count()); ?>

                                <?php else: ?>
                                    <?php echo e(App\Models\Product::whereDoesntHave('merchantProducts')->count()); ?>
                            ...
                            <div class="action-btns-wrapper">
                                ...
                                <?php if(isset($merchant) && $merchant->user): ?>
                                    <a class="template-btn dark-outline"
                                        href="<?php echo e(route('front.vendor', str_replace(' ', '-', $merchant->user->shop_name))); ?>"><?php echo app('translator')->get('visit store'); ?></a>
                                <?php endif; ?>
                                    ...
                                    <?php if(Auth::check()): ?>
                                        ...
                                        <?php else: ?>
                                            <a class="template-btn dark-outline" href="javascript:;"
                                                ...
                                                data-bs-target="#sendMessage"><?php echo app('translator')->get('contact seller'); ?></a>
                                        <?php endif; ?>
                                    <?php else: ?>
                                        <a class="template-btn dark-outline" href="<?php echo e(route('user.login')); ?>">
                                            <i class="icofont-ui-chat"></i>
                                            <?php echo e(__('Contact Seller')); ?>
                                ...
                                <?php if(isset($merchant) && $merchant->user): ?>
                                    <?php if(Auth::check()): ?>
                                        <?php if(Auth::user()->favorites()->where('vendor_id', '=', $merchant->user_id)->get()->count() > 0): ?>
                                            <a class="template-btn dark-outline" href="javascript:;" >
                                        ...
                                        <?php else: ?>
                                            <a class="template-btn dark-outline favorite-prod" href="javascript:;"
                                                data-href="<?php echo e(route('user-favorite', [Auth::user()->id, $merchant->user_id])); ?>">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="buy-return-policy-tab" data-bs-toggle="tab"
                        ...
                        <?php echo app('translator')->get('Buy / Return Policy'); ?>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <?php if($productt->whole_sell_qty != null && $productt->whole_sell_qty != ''): ?>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="whole-sell-tab" data-bs-toggle="tab"
                            ...
                            <?php echo app('translator')->get('Whole sell'); ?>
                        </button>
                    </li>
                <?php endif; ?>
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="reviews-tab-pane" role="tabpanel" aria-labelledby="reviews-tab"
                    ...
                    <div class="row review-tab-content-wrapper">
                        <div class="col-xxl-8">
                            <div id="comments">
                                <h5 class="woocommerce-Reviews-titleDDD my-3"> <?php echo app('translator')->get('Ratings & Reviews'); ?></h5>
                                <ul class="all-comments">
                                    <?php $__empty_1 = true; $__currentLoopData = $productt->ratings(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <li>
                                            <div class="single-comment">
                                                <div class="left-area">
                                                    <img src="<?php echo e($review->user->photo ? asset('assets/images/users/' . $review->user->photo) : asset('assets/images/' . $gs->user_image)); ?>"
                                                        alt="">
                                                    ...
                                                    <div class="reating-area">
                                                        <div class="stars"><span
                                                                id="star-rating"><?php echo e($review->rating); ?></span> <i
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <li>
                                            <div class="single-comment">
                                                <div class="left-area">
                                                    <p class="name text-lg">
                                                        <?php echo app('translator')->get('No Review Found'); ?>
                                                    </p>
                                                </div>
                                            </div>
                                        </li>
                            ...
                            <?php if(Auth::check()): ?>
                                <div id="review_form_wrapper">
                                    ...
                                    <div class="review-area">
                                        ...
                                        <h5 class="title"><?php echo app('translator')->get('Reviews'); ?></h5>
                                        <div class="star-area">
                                            <ul class="star-list">
                                    ...
                                    <div class="write-comment-area">
                                        ...
                                        <form action="<?php echo e(route('front.review.submit')); ?>"
                                            data-href="<?php echo e(route('front.reviews', $productt->id)); ?>"
                                            data-side-href="<?php echo e(route('front.side.reviews', $productt->id)); ?>"
                                            method="POST">
                                            <?php echo csrf_field(); ?>
                                ...
                                <div class="pro-summary ">
                                    <div class="price-summary">
                                        <div class="price-summary-content">
                                            <p class="title text-center text-lg"><?php echo app('translator')->get('Wholesell'); ?></p>
                                            <ul class="price-summary-list">
                                                <li class="regular-price">
                                                    <p class="fw-medium"><?php echo app('translator')->get('Quantity'); ?></p>
                                                    <p class="fw-medium">
                                                ...
                                                <?php $__currentLoopData = $productt->whole_sell_qty; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li class="selling-price">
                                                        <label><?php echo e($productt->whole_sell_qty[$key]); ?>+</label> <span><span
                                                                class="woocommerce-Price-amount amount"><?php echo e($productt->whole_sell_discount[$key]); ?>%
    ...
    <div class="gs-product-cards-slider-area wow-replaced" data-wow-delay=".1s">
        <div class="container">
            <h2 class="title text-center"><?php echo app('translator')->get('Related Products'); ?></h2>
            <div class="product-cards-slider">
                <?php $__currentLoopData = App\Models\Product::where('type', $productt->type)->where('product_type', $productt->product_type)->withCount('ratings')->withAvg('ratings', 'rating')->take(12)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo $__env->make('includes.frontend.home_product', ['class' => 'not'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    </div>
    ...
    <?php if(isset($vendorListings) && $vendorListings->count() > 0): ?>
        <div class="gs-product-cards-slider-section more-products-by-seller  wow-replaced" data-wow-delay=".1s">
            <div class="gs-product-cards-slider-area more-products-by-seller">
                <div class="container">
                    <h2 class="title text-center"><?php echo app('translator')->get('More Products By Seller'); ?></h2>
                    <div class="product-cards-slider">
                        <?php $__currentLoopData = $vendorListings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $merchantProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('includes.frontend.home_product', ['class' => 'not', 'product' => $merchantProduct->product, 'mp' => $merchantProduct], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            </div>
    ...
    <?php if(auth()->check()): ?>
        <div class="modal gs-modal fade" id="report-modal" tabindex="-1" aria-hidden="true">
            <form action="<?php echo e(route('product.report')); ?>" method="POST"
                ...
                <div class="modal-content assign-rider-modal-content form-group">
                    <div class="modal-header w-100">
                        <h4 class="title"><?php echo e(__('REPORT PRODUCT')); ?></h4>
                    ...
                    <div class="input-label-wrapper w-100">
                        <label><?php echo e(__('Please give the following details')); ?></label>
                        <input type="text" name="title" class="form-control mb-3"
                            placeholder="<?php echo e(__('Enter Report Title')); ?>" required="">

                        <textarea name="note" class="form-control border  p-3" placeholder="<?php echo e(__('Enter Report Note')); ?>"
                            required=""></textarea>
                    ...
                    <!-- Assign Rider Button  -->
                    <button class="template-btn" data-bs-dismiss="modal" type="submit"><?php echo e(__('SUBMIT')); ?></button>
                    <!-- modal body end  -->
                </div>
            </form>
        </div>
    ...
    <div class="modal gs-modal fade" id="vendorform" tabindex="-1" aria-modal="true" role="dialog">
        <form action="<?php echo e(route('user-send-message')); ?>" id="emailreply" method="POST"
            class="modal-dialog assign-rider-modal-dialog modal-dialog-centered emailreply">
            <?php echo e(csrf_field()); ?>

            <div class="modal-content assign-rider-modal-content form-group">
                <div class="modal-header w-100">
                    <h4 class="title"><?php echo app('translator')->get('Send Message'); ?></h4>
                    <button type="button" data-bs-dismiss="modal">
                        <i class="fa-regular fa-circle-xmark gs-modal-close-btn"></i>
                    </button>
                ...
                <div class="input-label-wrapper w-100">
                    ...
                    <input type="text" class="form-control  border px-3 mb-4" id="eml" name="email"
                        name="subject" readonly placeholder="<?php echo app('translator')->get('Select Rider'); ?>"
                        value="<?php echo e(auth()->user() ? auth()->user()->email : ''); ?>">
                    <input type="text" class="form-control  border px-3 mb-4" name="subject"
                        placeholder="<?php echo app('translator')->get('Subject'); ?>" required="">

                    <textarea class="form-control  border px-3 mb-4" name="message" placeholder="<?php echo e(__('Your Message')); ?>"
                        required=""></textarea>
                    ...
                    <input type="hidden" name="vendor_id" value="<?php echo e(isset($merchant) ? $merchant->user_id : ''); ?>">

                </div>
                <!-- Select Pickup Point -->

                <!-- Assign Rider Button  -->
                <button class="template-btn" data-bs-dismiss="modal" type="submit"><?php echo app('translator')->get('Send Message'); ?></button>
                <!-- modal body end  -->
            </div>
        </form>
    </div>
            ...
            <div class="modal-content assign-rider-modal-content form-group">
                ...
                <div class="input-label-wrapper w-100">
                    ...
                    <div class="dropdown-container">
                        ...
                        <textarea class="form-control form__control border px-3 mb-4" name="message" placeholder="<?php echo e(__('Your Message')); ?>"
                            required=""></textarea>
                    </div>
                </div>
