...
<div class="gs-vendor-outlet">
    ...
    <div class="gs-vendor-breadcrumb has-mb">
        <h4 class="text-capitalize"><?php echo app('translator')->get('All Orders'); ?></h4>
        <ul class="breadcrumb-menu">
            ...
            <li>
                <a href="#" class="text-capitalize">
                    <?php echo app('translator')->get('All Order'); ?>
                </a>
            </li>
        </ul>
    </div>
    ...
    <div class="vendor-table-wrapper all-orders-table-wrapper">
        <div class="user-table table-responsive position-relative">
            <table class="gs-data-table w-100">
                <thead>
                    <tr>
                        <th><span class="header-title"><?php echo app('translator')->get('Order Number'); ?></span></th>
                        <th><span class="header-title"><?php echo app('translator')->get('Total Qty'); ?></span></th>
                        <th><span class="header-title"><?php echo app('translator')->get('Total Cost'); ?></span></th>
                        <th><span class="header-title"><?php echo app('translator')->get('Payment Method'); ?></span></th>
                        <th><span class="header-title"><?php echo app('translator')->get('Status'); ?></span></th>
                        <th class="text-center">
                            <span class="header-title"><?php echo app('translator')->get('Actions'); ?></span>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <!-- Order Number -->
                        <td><span class="content"><?php echo e($order->order_number); ?></span></td>
                        <!-- Total Qty -->
                        <td class="text-start">
                            <span class="content">
                                <?php echo e($order->vendororders()->where('user_id', '=', $user->id)->sum('qty')); ?>

                            </span>
                        </td>
                        <!-- Total Cost -->
                        <td><span class="content"><?php echo e(PriceHelper::showOrderCurrencyPrice($price, $order->currency_sign)); ?></span>
                        </td>
                        <!-- Payment Method -->
                        <td>
                            <span class="content">
                        ...
                        <td>
                            ...
                            <span class="content">
                                ...
                                <span class="bg-pending status-btn"><?php echo e($order->status); ?></span>
                                <?php elseif($order->status == 'processing'): ?>
                                <span class="bg-processing status-btn"><?php echo e($order->status); ?></span>
                                <?php elseif($order->status == 'completed'): ?>
                                <span class="bg-complete status-btn"><?php echo e($order->status); ?></span>
                                <?php elseif($order->status == 'declined'): ?>
                                <span class="bg-declined status-btn"><?php echo e($order->status); ?></span>
                                <?php endif; ?>
                            </span>
                        </td>
                        <!-- Actions -->
                        <td>
                            <div class="table-icon-btns-wrapper">
                                <a href="<?php echo e(route('vendor-order-show', $order->order_number)); ?>" class="view-btn">
