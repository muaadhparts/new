...
<div class="muaadh-search-wrapper" id="partSearchWrapper<?php echo e($uniqueId ?? 'default'); ?>">
    <div class="muaadh-search-container">
        <div class="muaadh-search-input-group">
            ...
            <input
                ...
                autocomplete="off"
            >
            <button class="muaadh-search-btn part-search-btn" type="button" id="partSearchBtn<?php echo e($uniqueId ?? 'default'); ?>">
        ...
        <div class="muaadh-suggestions-dropdown d-none" id="partSuggestions<?php echo e($uniqueId ?? 'default'); ?>">
