...
<div class="mobile-menu">
    ...
    <li class="<?php echo e(Request::url() == route('user-dashboard') ? 'active' : ''); ?>">
    ...
    <li class="<?php echo e(Request::url() == route('user-orders') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('user-orders')); ?>">
            ...
            <span><?php echo app('translator')->get('Purchased Items'); ?></span>
        </a>
    </li>
    
    <li
        class="<?php echo e(Request::url() == route('user-deposit-index') || request()->path() == 'user/deposit/create' ? 'active' : ''); ?>">
    ...
    <li class="<?php echo e(Request::url() == route('user-transactions-index') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('user-transactions-index')); ?>">
            ...
            <span><?php echo app('translator')->get('Transactions'); ?></span>
        </a>
    </li>
    
    <li
        class="<?php echo e(Request::url() == route('user-reward-index') || request()->path() == 'user/reward/convert' ? 'active' : ''); ?>">
        <a href="<?php echo e(route('user-reward-index')); ?>">
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <span><?php echo app('translator')->get('Rewards'); ?></span>
        </a>
    </li>
    
    <li class="<?php echo e(Request::url() == route('user-affilate-program') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('user-affilate-program')); ?>">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <span><?php echo app('translator')->get('Affiliate Program'); ?></span>
        </a>
    </li>
    
    <li
        class="<?php echo e(Request::url() == route('user-wwt-index') || request()->path() == 'user/affilate/withdraw/create' ? 'active' : ''); ?>">
        <a href="<?php echo e(route('user-wwt-index')); ?>">
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
    ...
    <li class="<?php echo e(Request::url() == route('user-order-track') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('user-order-track')); ?>">
            ...
            <span><?php echo app('translator')->get('Order Tracking'); ?></span>
        </a>
    </li>
    
    <li class="<?php echo e(Request::url() == route('user-favorites') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('user-favorites')); ?>">
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <span><?php echo app('translator')->get('Favorite Sellers'); ?></span>
        </a>
    </li>
    
    <li class="<?php echo e(Request::url() == route('user-messages') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('user-messages')); ?>">
            ...
            <span><?php echo app('translator')->get('Messages'); ?></span>
        </a>
    </li>
    
    <li class="<?php echo e(Request::url() == route('user-message-index') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('user-message-index')); ?>">
            <svg width="22" height="18" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <span><?php echo app('translator')->get('Tickets'); ?></span>
        </a>
    </li>
    
    <li class="<?php echo e(Request::url() == route('user-dmessage-index') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('user-dmessage-index')); ?>">
            ...
            <span><?php echo app('translator')->get('Disputes'); ?></span>
        </a>
    </li>
    
    <li class="<?php echo e(Request::url() == route('user-profile') ? 'active' : ''); ?>">
    ...
    <li class="<?php echo e(Request::url() == route('user-reset') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('user-reset')); ?>">
            ...
            <span><?php echo app('translator')->get('Reset Password'); ?></span>
        </a>
    </li>
    
    <li class="<?php echo e(Request::url() == route('user-package') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('user-package')); ?>">
            <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M14 8V6C14 3.23858 11.7614 1 9 1C6.23858 1 4 3.23858 4 6V8M9 12.5V14.5M5.8 19H12.2C13.8802 19 14.7202 19 15.362 18.673C15.9265 18.3854 16.3854 17.9265 16.673 17.362C17 16.7202 17 15.8802 17 14.2V12.8C17 11.1198 17 10.2798 16.673 9.63803C16.3854 9.07354 15.9265 8.6146 15.362 8.32698C14.7202 8 13.8802 8 12.2 8H5.8C4.11984 8 3.27976 8 2.63803 8.32698C2.07354 8.6146 1.6146 9.07354 1.32698 9.63803C1 10.2798 1 11.1198 1 12.8V14.2C1 15.8802 1 16.7202 1.32698 17.362C1.6146 17.9265 2.07354 18.3854 2.63803 18.673C3.27976 19 4.11984 19 5.8 19Z"
                    stroke="#1F0300" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            ...
            <span><?php echo app('translator')->get('Pricing Plans'); ?></span>
        </a>
    </li>
...
</div><?php /**PATH C:\Users\hp\Herd\new\resources\views/includes/user/mobile-header.blade.php ENDPATH**/ ?>