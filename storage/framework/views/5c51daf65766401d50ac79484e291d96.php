                                                    ...
                                                    <?php if(!empty($product['color']) || !empty($product['size'])): ?>
                                                        <div class="d-flex align-items-center gap-2 mt-2">
                                                            <?php if(!empty($product['color'])): ?>
                                                                ...
                                                                <span class="cart-color d-inline-block rounded-2" style="border:10px solid #<?php echo e($product['color']==''?'white':$product['color']); ?>;"></span>
                                                            <?php endif; ?>
