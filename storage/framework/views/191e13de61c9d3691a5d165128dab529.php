        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <div class="hero-content text-center mb-5">
                    <h1 class="hero-title"><?php echo app('translator')->get('Search By Part Number Or Name'); ?></h1>
                </div>
...
<section class="brands-showcase-section">
    <div class="container">
        ...
        <div class="section-header text-center mb-5">
            <span class="section-badge"><?php echo app('translator')->get('Genuine Parts Catalogues'); ?></span>
            <h2 class="section-title"><?php echo app('translator')->get('Explore genuine OEM parts catalogues for all vehicle models. Fast search. precise results, and certified quality guaranteed.'); ?></h2>
            <p class="section-description mt-3"><?php echo app('translator')->get('Select your vehicle brand to find the perfect parts'); ?></p>
        </div>
        ...
        <div class="brands-grid">
            <?php $__currentLoopData = DB::table('brands')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="brand-card-wrapper">
                    <a href="<?php echo e(route('catlogs.index', $brand->name)); ?>" class="brand-card">
                        <div class="brand-image-container">
                            <img src="<?php echo e(asset('assets/images/brand/' . $brand->photo)); ?>"
...
<section class="categories-modern-section">
    <div class="container">
        <!-- Section Header -->
        <div class="section-header text-center mb-5">
            <span class="section-badge"><?php echo app('translator')->get('Browse Categories'); ?></span>
            <h2 class="section-title"><?php echo app('translator')->get('Shop by Category'); ?></h2>
            <p class="section-description"><?php echo app('translator')->get('Find exactly what you need from our extensive catalog'); ?></p>
        </div>
        ...
        <div class="categories-grid">
            <?php $__currentLoopData = $featured_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="category-card-wrapper">
                    <a href="<?php echo e(route('front.category', $fcategory->slug)); ?>" class="category-card">
                        <div class="category-image-wrapper">
                            <img class="category-image"
                                 src="<?php echo e(asset('assets/images/categories/' . $fcategory->image)); ?>"
                                 alt="<?php echo e($fcategory->name); ?>"
                                 loading="lazy">
                            <div class="category-badge">
                                <span class="product-count"><?php echo e($fcategory->products_count); ?></span>
                            </div>
                        </div>
                        <div class="category-content">
                            <h6 class="category-title"><?php echo e($fcategory->name); ?></h6>
                            <p class="category-subtitle"><?php echo e($fcategory->products_count); ?> <?php echo app('translator')->get('Products'); ?></p>
            ...
            <?php $__currentLoopData = DB::table('services')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="service-card">
                    ...
                    <div class="service-content">
                        <h6 class="service-title"><?php echo e($service->title); ?></h6>
                        <p class="service-description"><?php echo e($service->details); ?></p>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        ...
        <div class="modal-content modern-modal-home">
            <div class="modal-header modern-modal-header-home">
                <h5 class="modal-title" id="vinSearchModalHomeLabel">
                    <i class="fas fa-car me-2"></i>
                    <span class="d-none d-sm-inline"><?php echo app('translator')->get('Search by VIN'); ?></span>
                    <span class="d-sm-none">VIN</span>
                </h5>
                <button type="button" class="btn-close modern-close-home" data-bs-dismiss="modal" aria-label="<?php echo app('translator')->get('Close'); ?>"></button>
            </div>
