<div class="positon-relative">
    ...
    <div class="gs-vendor-header gap-2 gap-md-3">
        ...
        <div class="d-flex align-items-center gap-4">
            <a href="<?php echo e(route("front.index")); ?>"><img class="vendor-res-header-logo d-xl-none" src="<?php echo e(asset("assets/images/".$gs->logo)); ?>" alt="logo"></a>
            ...
            <div class="user-dropdown-wrapper dropdown">
                <div role="button" class="user-dropdown dropdown-toggle" id="dropdownMenuButton1"
                    ...
                    <span class="avatar overflow-hidden">
                        ...
                        <?php if(Auth::user()->is_provider == 1): ?>
                            <img class="w-100 h-100"
                                src="<?php echo e(Auth::user()->photo ? asset(Auth::user()->photo) : asset('assets/images/noimage.png')); ?>"
                                alt="">
                        <?php else: ?>
                            <img class="w-100 h-100"
                                src="<?php echo e(Auth::user()->photo ? asset('assets/images/users/' . Auth::user()->photo) : asset('assets/images/noimage.png')); ?>"
                                alt="">
                        <?php endif; ?>
                    ...
                    <div class="d-none d-md-flex flex-column gap-1">
                        ...
                        <span class="user-designation"><?php echo app('translator')->get('Vendor'); ?></span>
                    </div>
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li>
                        <a class="dropdown-item"
                            href="<?php echo e(route('front.vendor', str_replace(' ', '-', $user->shop_name))); ?>">
                            ...
                            <span><?php echo app('translator')->get('Visit Store'); ?></span>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="<?php echo e(route('user-dashboard')); ?>">
                            ...
                            <span><?php echo app('translator')->get('User Panel'); ?></span>
                        </a>
                    </li>
                    <li>
    ...
    <div class="gs-vendor-header-noti">
        <div class="d-flex align-items-center justify-content-between gap-4">
            <span class="title"><?php echo app('translator')->get('Your Notification'); ?></span>
            <a class="clear-btn" href="<?php echo e(route('vendor-order-notf-clear',Auth::user()->id)); ?>">Clear All</a>
        </div>
        <ul>
            <?php
                $notifications = App\Models\UserNotification::whereUserId(auth()->id())->orderby('id','desc')->get();
            ?>
            <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <li>
                <span class="sm-info-1"><?php echo app('translator')->get('Order has been placed'); ?></span>
                <a href="<?php echo e(route('vendor-order-show', $data->order_number)); ?>"
                    class="sm-info-2 link"><?php echo app('translator')->get('Order ID:'); ?>
                    <?php echo e($data->order_number); ?> <?php echo app('translator')->get('has been placed'); ?></a>
                <span class="sm-info-2"><?php echo e(Carbon\Carbon::parse($data->created_at)->diffForHumans()); ?></span>
...
<?php /**PATH C:\Users\hp\Herd\new\resources\views/includes/vendor/header.blade.php ENDPATH**/ ?>