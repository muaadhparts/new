...
<div class="col-sm-6 col-md-6 col-lg-12 ">
    <div class="single-product-list-view">
        <div class="img-wrapper">
            <?php if($off > 0): ?>
                <span class="product-badge">-<?php echo e($off); ?>%</span>
            <?php endif; ?>


            <?php if(Auth::check()): ?>
                <a href="javascript" class="wishlist" data-href="<?php echo e(isset($merchant) ? route('merchant.wishlist.add', $merchant->id) : route('user-wishlist-add', $product->id)); ?>">
                    <div class="add-to-wishlist-btn <?php echo e(isset($merchant) ? (merchantWishlistCheck($merchant->id) ? 'active' : '') : (wishlistCheck($product->id) ? 'active' : '')); ?>">
        ...
        <div class="content-wrapper">
            <h4 class="product-title">
                <a href="<?php echo e($detailsUrl); ?>"> <?php echo e($actualProduct->showName()); ?></a>
            </h4>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.product-info','data' => ['product' => $actualProduct,'mp' => $merchant,'displayMode' => 'list','showSku' => true,'showBrand' => true,'showQualityBrand' => true,'showVendor' => true,'showStock' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['product' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($actualProduct),'mp' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($merchant),'display-mode' => 'list','show-sku' => true,'show-brand' => true,'show-quality-brand' => true,'show-vendor' => true,'show-stock' => true]); ?>
...
<?php endif; ?>
            ...
            <div class="price-wrapper">
                <?php if($merchant): ?>
                    <h4><?php echo e(method_exists($merchant,'showPrice') ? $merchant->showPrice() : \App\Models\Product::convertPrice($merchant->price)); ?></h4>
                    <?php if($merchant->previous_price > 0): ?>
                        <h4><del><?php echo e(\App\Models\Product::convertPrice($merchant->previous_price)); ?></del></h4>
                    <?php endif; ?>
                <?php else: ?>
                    <h4><?php echo e($actualProduct->showPrice()); ?></h4>
                    <h4><del><?php echo e($actualProduct->showPreviousPrice()); ?></del></h4>
                <?php endif; ?>
            </div>
            ...
            <?php if($actualProduct->type == 'Physical' && $hasVendor && ($inStock || ($merchant && $merchant->preordered))): ?>
                <?php
                ...
                <div class="muaadh-qty-wrapper">
                    <span class="muaadh-qty-label"><?php echo app('translator')->get('Qty'); ?>:</span>
                    <div class="muaadh-qty-control">
                        <button type="button" class="muaadh-qty-btn hp-qtminus" data-target="<?php echo e($uniqueId); ?>" data-min="<?php echo e($minQty); ?>">-</button>
                        <input type="text" class="muaadh-qty-input hp-qty-input" id="qty_<?php echo e($uniqueId); ?>" value="<?php echo e($minQty); ?>" readonly
                               data-min="<?php echo e($minQty); ?>" data-stock="<?php echo e($stock); ?>" data-preordered="<?php echo e($preordered); ?>">
                        <button type="button" class="muaadh-qty-btn hp-qtplus" data-target="<?php echo e($uniqueId); ?>" data-stock="<?php echo e($stock); ?>" data-preordered="<?php echo e($preordered); ?>">+</button>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <div class="add-to-cart">
                <?php if($actualProduct->type != 'Listing'): ?>
                    <a href="javascript:;" class="compare_product" data-href="<?php echo e(isset($merchant) ? route('merchant.compare.add', $merchant->id) : route('product.compare.add', $actualProduct->id)); ?>">
                        <div class="compare">
                ...
                <?php if($actualProduct->product_type == 'affiliate'): ?>
                    <a href="javascript:;" data-href="<?php echo e($actualProduct->affiliate_link); ?>" class="add_to_cart_button">
                        <div class="add-cart">
                            <?php echo app('translator')->get('Add To Cart'); ?>
                        </div>
                    </a>
                <?php else: ?>
                    <?php if(!$hasVendor || (!$inStock && !($merchant && $merchant->preordered))): ?>
                        <div class="add-cart">
                    ...
                    <?php else: ?>
                        <?php if($actualProduct->type != 'Listing'): ?>
                            ...
                            <a <?php echo e($actualProduct->cross_products ? 'data-bs-target=#exampleModal' : ''); ?> href="javascript:;"
                                ...
                                data-merchant-product="<?php echo e($merchant->id ?? ''); ?>"
                                data-qty-prefix="<?php echo e($qtyInputId); ?>"
                                data-product="<?php echo e($actualProduct->id); ?>"
...
<?php /**PATH C:\Users\hp\Herd\new\resources\views/includes/frontend/list_view_product.blade.php ENDPATH**/ ?>