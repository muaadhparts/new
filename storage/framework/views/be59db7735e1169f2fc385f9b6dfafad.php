...
<div class="mobile-menu">
    <div class="mobile-menu-top">
        ...
        <ul class="gs-dashboard-user-sidebar-wrapper">
            <li class="<?php echo e(request()->is('vendor/dashboard') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('vendor.dashboard')); ?>">
                    ...
                    <span class="label"><?php echo app('translator')->get('Dashboard'); ?></span>
                </a>
            </li>
        
        
            <li>
                <a href="<?php echo e(route('front.vendor', str_replace(' ', '-', $user->shop_name))); ?>" target="_blank">
                    ...
                    <span class="label"><?php echo app('translator')->get('Visit Store'); ?></span>
                </a>
            </li>
            <li class="<?php echo e(request()->is('vendor/delivery') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('vendor.delivery.index')); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path
                    ...
                    <span class="label"><?php echo app('translator')->get('Delivery'); ?></span>
                </a>
            </li>
            <li class="<?php echo e(request()->is('vendor/orders') || request()->is('vendor/order/*/show') ? 'active' : ''); ?>">
            ...
            <li
                ...
                <a href="#vendor-collapse-product"
                    ...
                    <span class="label"><?php echo app('translator')->get('Products'); ?></span>
                    <i class="ms-auto fa-solid fa-angle-down angle-down"></i>
                </a>
                <ul class="sidebar-sub-menu collapse <?php echo e(request()->is('vendor/products/types') || request()->is('vendor/products') || request()->is('vendor/products/catalogs') || request()->is('vendor/products/physical/create') || request()->is('vendor/products/digital/create') || request()->is('vendor/products/license/create') || request()->is('vendor/products/listing/create') || request()->is('vendor/products/edit/*') || request()->is('vendor/products/catalog/*') ? 'show' : ''); ?>"
                    id="vendor-collapse-product">
        
        
                    <li><a class="sidebar-sub-menu-item <?php echo e(request()->is('vendor/products/types') || request()->is('vendor/products/physical/create') || request()->is('vendor/products/digital/create') || request()->is('vendor/products/license/create') || request()->is('vendor/listing/create') ? 'active' : ''); ?>"
                            href="<?php echo e(route('vendor-prod-types')); ?>"><?php echo app('translator')->get('Add New Product'); ?></a>
                    </li>
                    <li><a class="sidebar-sub-menu-item <?php echo e(request()->is('vendor/products') || request()->is('vendor/products/edit/*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('vendor-prod-index')); ?>"><?php echo app('translator')->get('All Product'); ?></a></li>
                    <li><a class="sidebar-sub-menu-item <?php echo e(request()->is('vendor/products/catalogs') || request()->is('vendor/products/catalog/*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('vendor-prod-catalogs')); ?>"><?php echo app('translator')->get('Product Catalogs'); ?></a></li>
                </ul>
            </li>
            ...
            <li class="<?php echo e(request()->is('vendor/products/import') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('vendor-prod-import')); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path
                    ...
                    <span class="label"><?php echo app('translator')->get('Bulk Item Upload'); ?></span>
                </a>
            </li>
        
            <li class="<?php echo e(request()->is('vendor/withdraw') || request()->is('vendor/withdraw/create') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('vendor-wt-index')); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path
                    ...
                    <span class="label"><?php echo app('translator')->get('Withdraw'); ?></span>
                </a>
            </li>
        
        
            <li
                class="has-sub-menu <?php echo e(request()->is('vendor/shipping') || request()->is('vendor/shipping/*') || request()->is('vendor/package') || request()->is('vendor/package/*') || request()->is('vendor/pickup-point') || request()->is('vendor/pickup-point/*') || request()->is('vendor/social-link') || request()->is('vendor/social-link/*') ? 'active' : ''); ?>">
                <a href="#vendor-collapsed-settings"
                    class="<?php echo e(request()->is('vendor/shipping') || request()->is('vendor/shipping/*') || request()->is('vendor/package') || request()->is('vendor/package/*') || request()->is('vendor/pickup-point') || request()->is('vendor/pickup-point/*') || request()->is('vendor/social-link') || request()->is('vendor/social-link/*') ? '' : 'collapsed'); ?>"
                    ...
                    <span class="label"><?php echo app('translator')->get('Settings'); ?></span>
                    <i class="ms-auto fa-solid fa-angle-down angle-down"></i>
                </a>
                <ul class="sidebar-sub-menu collapse <?php echo e(request()->is('vendor/shipping') || request()->is('vendor/shipping/*') || request()->is('vendor/package') || request()->is('vendor/package/*') || request()->is('vendor/pickup-point') || request()->is('vendor/pickup-point/*') || request()->is('vendor/social-link') || request()->is('vendor/social-link/*') ? 'show' : ''); ?>"
                    id="vendor-collapsed-settings">
                    <?php if($gs->vendor_ship_info == 1): ?>
                    <li class=""><a
                            class="sidebar-sub-menu-item <?php echo e(request()->is('vendor/shipping') || request()->is('vendor/shipping/*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('vendor-shipping-index')); ?>"><?php echo app('translator')->get('Shipping Methods'); ?></a></li>
                    <li class=""><a
                            class="sidebar-sub-menu-item <?php echo e(request()->is('vendor/package') || request()->is('vendor/package/*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('vendor-package-index')); ?>"><?php echo app('translator')->get('Packagings Products'); ?></a></li>
                    <li class=""><a
                            class="sidebar-sub-menu-item <?php echo e(request()->is('vendor/pickup-point') || request()->is('vendor/pickup-point/*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('vendor-pickup-point-index')); ?>"><?php echo app('translator')->get('Pickup Point'); ?></a></li>
                    <?php endif; ?>
                    <li class=""><a
                            class="sidebar-sub-menu-item <?php echo e(request()->is('vendor/social-link') || request()->is('vendor/social-link/*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('vendor-sociallink-index')); ?>"><?php echo app('translator')->get('Social Links'); ?></a>
                    </li>
            ...
            <li class="">
                <a href="<?php echo e(route('vendor.income')); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path
                    ...
                    <span class="label"><?php echo app('translator')->get('Total Earnings'); ?></span>
                </a>
            </li>
            <li class="<?php echo e(request()->is('vendor/profile') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('vendor-profile')); ?>">
                    ...
                    <span class="label"><?php echo app('translator')->get('Edit Profile'); ?></span>
                </a>
            </li>
            ...
            <li>
                <a href="<?php echo e(route('user.login')); ?>">
                    ...
                    <span class="label"><?php echo app('translator')->get('Logout'); ?></span>
                </a>
            </li>
        </ul>
                    ...
                    <div class="input-group input__group">
                        ...
                        <div class="input-group-append">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item dropdown__item" href="#"><?php echo app('translator')->get('Electronic'); ?></a>
                                </li>
                                <li>
                                    <a class="dropdown-item dropdown__item" href="#"><?php echo app('translator')->get('Fashion & Beauty'); ?></a>
                                </li>
                                <li>
                                    <a class="dropdown-item dropdown__item" href="#"><?php echo app('translator')->get('Camera & Photo'); ?></a>
                                </li>
                                <li>
                                    <a class="dropdown-item dropdown__item" href="#"><?php echo app('translator')->get('Smart Phone'); ?></a>
                                </li>
                                <li>
                                    <a class="dropdown-item dropdown__item" href="#"><?php echo app('translator')->get('Sports & Outdoor'); ?></a>
                                </li>
                                <li>
                                    <a class="dropdown-item dropdown__item" href="#"><?php echo app('translator')->get('Books & Office'); ?></a>
                                </li>
                            </ul>
                        </div>
...
</div><?php /**PATH C:\Users\hp\Herd\new\resources\views/includes/vendor/vendor-mobile-header.blade.php ENDPATH**/ ?>