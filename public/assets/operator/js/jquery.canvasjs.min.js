/*
 ...
 Copyright 2017 fenopix
  ...
  --------------------- License Information --------------------
 CanvasJS is a commercial catalogItem which requires purchase of license. Without a commercial license you can use it for evaluation purposes for upto 30 days. Please refer to the following link for further details.
...
ma(q,v,{padding:"5px 12px",cursor:"pointer","float":"left",width:"40px",height:"25px",outline:"0px",verticalAlign:"baseline",lineHeight:"0"}),v.setAttribute("name",q._cultureInfo[s+"Text"]),v.innerHTML="<img style='height:95%;' src='"+bb[s].image+"' alt='"+q._cultureInfo[s+"Text"]+"' />")}function Ka(){for(var q=null,v=0;v<arguments.length;v++)q=arguments[v],q.style&&(q.style.display="inline")}function ta(){for(var q=null,v=0;v<arguments.length;v++)(q=arguments[v])&&q.style&&(q.style.display="none")}
...
"toolbar"}function Ga(q,v){Ga.base.constructor.call(this,"Name","name",v,null,q);this.chart=q;this.canvas=q.canvas;this.ctx=this.chart.ctx;this.optionsName="name";if(w(this.options.margin)&&q.options.subnames)for(var s=q.options.subnames,x=0;x<s.length;x++)if((w(s[x].horizontalAlign)&&"center"===this.horizontalAlign||s[x].horizontalAlign===this.horizontalAlign)&&(w(s[x].verticalAlign)&&"top"===this.verticalAlign||s[x].verticalAlign===this.verticalAlign)&&!s[x].dockInsidePlotArea===!this.dockInsidePlotArea){this.margin=
0;break}"undefined"===typeof this.options.fontSize&&(this.fontSize=this.chart.getAutoFontSize(this.fontSize));this.height=this.width=null;this.bounds={x1:null,y1:null,x2:null,y2:null}}function La(q,v,s){La.base.constructor.call(this,"Subname","subnames",v,s,q);this.chart=q;this.canvas=q.canvas;this.ctx=this.chart.ctx;this.optionsName="subnames";this.isOptionsInArray=!0;"undefined"===typeof this.options.fontSize&&(this.fontSize=this.chart.getAutoFontSize(this.fontSize));this.height=this.width=null;
...
borderThickness:2,cornerRadius:5,fontSize:14,fontColor:"black",fontFamily:"Calibri, Arial, Georgia, serif;",fontWeight:"normal",fontStyle:"italic",publicProperties:{options:"readWrite",chart:"readOnly"}},Axis:{minimum:null,maximum:null,viewportMinimum:null,viewportMaximum:null,interval:null,intervalType:null,reversed:!1,logarithmic:!1,logarithmBase:10,name:null,nameFontColor:"black",nameFontSize:20,nameFontFamily:"arial",nameFontWeight:"normal",nameFontStyle:"normal",nameWrap:!0,nameMaxWidth:null,
nameBackgroundColor:x?"transparent":null,nameBorderColor:x?"transparent":null,nameBorderThickness:0,nameCornerRadius:0,labelAngle:0,labelFontFamily:"arial",labelFontColor:"black",labelFontSize:12,labelFontWeight:"normal",labelFontStyle:"normal",labelAutoFit:!0,labelWrap:!0,labelMaxWidth:null,labelFormatter:null,labelBackgroundColor:x?"transparent":null,labelBorderColor:x?"transparent":null,labelBorderThickness:0,labelCornerRadius:0,labelPlacement:"outside",prefix:"",suffix:"",includeZero:!0,tickLength:5,
...
colorSet2:"#6D78AD #51CDA0 #DF7970 #4C9CA0 #AE7D99 #C9D45C #5592AD #DF874D #52BCA8 #8E7AA3 #E3CB64 #C77B85 #C39762 #8DD17E #B57952 #FCC26C".split(" "),colorSet3:"#8CA1BC #36845C #017E82 #8CB9D0 #708C98 #94838D #F08891 #0366A7 #008276 #EE7757 #E5BA3A #F2990B #03557B #782970".split(" ")},J,ba,V,Z,fa;ba="#333333";V="#000000";J="#666666";fa=Z="#000000";var da=20,z=14,Qa={colorSet:"colorSet1",backgroundColor:"#FFFFFF",name:{fontFamily:ua,fontSize:32,fontColor:ba,fontWeight:"normal",verticalAlign:"top",
margin:5},subnames:[{fontFamily:ua,fontSize:z,fontColor:ba,fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:y,indexLabelFontSize:z,indexLabelFontColor:ba,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{nameFontFamily:y,nameFontSize:da,nameFontColor:ba,nameFontWeight:"normal",labelFontFamily:y,labelFontSize:z,labelFontColor:V,labelFontWeight:"normal",lineThickness:1,lineColor:J,tickThickness:1,tickColor:J,gridThickness:0,gridColor:J,stripLines:[{labelFontFamily:y,
labelFontSize:z,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:z,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:fa,color:Z,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisX2:[{nameFontFamily:y,nameFontSize:da,nameFontColor:ba,nameFontWeight:"normal",labelFontFamily:y,labelFontSize:z,
...
V=ba="#F5F5F5";J="#FFFFFF";Z="#40BAF1";fa="#F5F5F5";var da=20,z=14,Xa={colorSet:"colorSet2",name:{fontFamily:y,fontSize:33,fontColor:"#3A3A3A",fontWeight:"bold",verticalAlign:"top",margin:5},subnames:[{fontFamily:y,fontSize:z,fontColor:"#3A3A3A",fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:y,indexLabelFontSize:z,indexLabelFontColor:"#666666",indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{nameFontFamily:y,nameFontSize:da,nameFontColor:"#666666",
nameFontWeight:"normal",labelFontFamily:y,labelFontSize:z,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:1,lineColor:"#BBBBBB",tickThickness:1,tickColor:"#BBBBBB",gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:y,labelFontSize:z,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:z,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",
thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisX2:[{nameFontFamily:y,nameFontSize:da,nameFontColor:"#666666",nameFontWeight:"normal",labelFontFamily:y,labelFontSize:z,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:1,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:y,labelFontSize:z,labelFontColor:"#FFA500",labelFontWeight:"normal",
labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:z,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{nameFontFamily:y,nameFontSize:da,nameFontColor:"#666666",nameFontWeight:"normal",labelFontFamily:y,labelFontSize:z,labelFontColor:"#666666",labelFontWeight:"normal",
...
lineDashType:"solid"}}],axisY2:[{nameFontFamily:y,nameFontSize:da,nameFontColor:"#666666",nameFontWeight:"normal",labelFontFamily:y,labelFontSize:z,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:0,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:y,labelFontSize:z,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:z,
...
this.toolbar.borderColor,this._zoomButton.style.borderRight=this.toolbar.borderThickness+"px solid "+this.toolbar.borderColor,this._resetButton.style.borderRight=(this.exportEnabled?this.toolbar.borderThickness:0)+"px solid "+this.toolbar.borderColor):(ta(this._zoomButton,this._resetButton),this._toolBar.style.border=this.toolbar.borderThickness+"px solid transparent",this.options.zoomEnabled&&(this.zoomEnabled=!0,this.panEnabled=!1));this._processData();this.options.name&&(this.name=new Ga(this,
this.options.name),this.name.dockInsidePlotArea?f.push(this.name):this.name.render());if(this.options.subnames)for(this.subnames=[],a=0;a<this.options.subnames.length;a++)b=new La(this,this.options.subnames[a],a),this.subnames.push(b),b.dockInsidePlotArea?f.push(b):b.render();this.legend=new V(this,this.options.legend);for(a=0;a<this.data.length;a++)(this.data[a].showInLegend||"pie"===this.data[a].type||"doughnut"===this.data[a].type||"funnel"===this.data[a].type||"pyramid"===this.data[a].type)&&
...
10,3)&&(g=!0)):g=!0;g&&(0<f&&0<=a&&0<=b)&&(K(f,a,b),b=a=-1,f=0)}}0<f&&K(f,a,b)})()}}function l(){n.plotArea.layoutManager.reset();n.name&&(n.name.dockInsidePlotArea||"center"===n.name.horizontalAlign&&"center"===n.name.verticalAlign)&&n.name.render();if(n.subnames)for(var a=0;a<n.subnames.length;a++){var b=n.subnames[a];(b.dockInsidePlotArea||"center"===b.horizontalAlign&&"center"===b.verticalAlign)&&b.render()}n.legend&&(n.legend.dockInsidePlotArea||"center"===n.legend.horizontalAlign&&"center"===
...
a.roundRect||Aa(a);s.name&&(s.name.dockInsidePlotArea||"center"===s.name.horizontalAlign&&"center"===s.name.verticalAlign)&&(s.name.ctx=a,s.name.render());if(s.subnames)for(var b=0;b<s.subnames.length;b++){var c=s.subnames[b];if(c.dockInsidePlotArea||"center"===c.horizontalAlign&&"center"===c.verticalAlign)s.subnames.ctx=a,c.render()}s.legend&&(s.legend.dockInsidePlotArea||"center"===s.legend.horizontalAlign&&"center"===s.legend.verticalAlign)&&(s.legend.ctx=a,s.legend.render());na.fNg&&
...
c=b.measureText(),d=0===this.labelAngle?c.width:c.width*Math.cos(Math.PI/180*Math.abs(this.labelAngle))+(c.height-b.fontSize/2)*Math.sin(Math.PI/180*Math.abs(this.labelAngle)),a<d&&(a=d),this._stripLineLabels[f].effectiveWidth=d)}f=this.name?this._nameTextBlock.measureText().height+2:0;return b="inside"===this.labelPlacement?b=f+5:f+a+this.tickLength+5};B.prototype.createLabelsAndCalculateHeight=function(){var a=0;this._labels=[];this._stripLineLabels=[];var f,b=0;this.createLabels();if("bottom"===
...
q),t[q].startValue>=m[e].viewPortMinimum&&(m[e].scaleBreaks.lastBreakIndex=q));for(var s=q=0,u=0,v=0,y=0,z=0,D=0,A,B,F=l=0,J,L,O,t=J=L=O=!1,e=0;e<m.length;e++)m[e]&&m[e].name&&(m[e]._nameTextBlock=new ja(m[e].ctx,{text:m[e].name,horizontalAlign:"center",fontSize:m[e].nameFontSize,fontFamily:m[e].nameFontFamily,fontWeight:m[e].nameFontWeight,fontColor:m[e].nameFontColor,fontStyle:m[e].nameFontStyle,borderColor:m[e].nameBorderColor,borderThickness:m[e].nameBorderThickness,backgroundColor:m[e].nameBackgroundColor,
cornerRadius:m[e].nameCornerRadius,textBaseline:"top"}));for(e=0;e<m.length;e++)if(m[e].name)switch(m[e]._position){case "left":m[e]._nameTextBlock.maxWidth=m[e].nameMaxWidth||g.height;m[e]._nameTextBlock.maxHeight=m[e].nameWrap?0.8*g.width:1.5*m[e].nameFontSize;m[e]._nameTextBlock.angle=-90;break;case "right":m[e]._nameTextBlock.maxWidth=m[e].nameMaxWidth||g.height;m[e]._nameTextBlock.maxHeight=m[e].nameWrap?0.8*g.width:1.5*m[e].nameFontSize;m[e]._nameTextBlock.angle=90;break;default:m[e]._nameTextBlock.maxWidth=
m[e].nameMaxWidth||g.width,m[e]._nameTextBlock.maxHeight=m[e].nameWrap?0.8*g.height:1.5*m[e].nameFontSize,m[e]._nameTextBlock.angle=0}if("normal"===d){for(var v=[],y=[],z=[],D=[],P=[],N=[],I=[],R=[];4>q;){var Q=0,U=0,V=0,W=0,T=d=0,K=0,Z=0,X=0,M=0,aa=0,ba=0;if(b&&0<b.length)for(z=[],e=aa=0;e<b.length;e++)z.push(Math.ceil(b[e]?b[e].createLabelsAndCalculateWidth():0)),aa+=z[e],K+=b[e]?b[e].margin:0;else z.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateWidth():0));I.push(z);if(c&&0<c.length)for(D=
[],e=ba=0;e<c.length;e++)D.push(Math.ceil(c[e]?c[e].createLabelsAndCalculateWidth():0)),ba+=D[e],Z+=c[e]?c[e].margin:0;else D.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateWidth():0));R.push(D);k=Math.round(g.x1+aa+K);n=Math.round(g.x2-ba-Z>r.width-10?r.width-10:g.x2-ba-Z);if(a&&0<a.length)for(v=[],e=X=0;e<a.length;e++)a[e]&&(a[e].lineCoordinates={}),a[e].lineCoordinates.width=Math.abs(n-k),a[e].name&&(a[e]._nameTextBlock.maxWidth=0<a[e].nameMaxWidth&&a[e].nameMaxWidth<a[e].lineCoordinates.width?
a[e].nameMaxWidth:a[e].lineCoordinates.width),v.push(Math.ceil(a[e]?a[e].createLabelsAndCalculateHeight():0)),X+=v[e],d+=a[e]?a[e].margin:0;else v.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateHeight():0));P.push(v);if(f&&0<f.length)for(y=[],e=M=0;e<f.length;e++)f[e]&&(f[e].lineCoordinates={}),f[e].lineCoordinates.width=Math.abs(n-k),f[e].name&&(f[e]._nameTextBlock.maxWidth=0<f[e].nameMaxWidth&&f[e].nameMaxWidth<f[e].lineCoordinates.width?f[e].nameMaxWidth:f[e].lineCoordinates.width),y.push(Math.ceil(f[e]?
...
else J=!0;if(b&&0<b.length)for(e=0;e<b.length;e++)L=I[q-1][e]===I[q][e]?!0:!1;else L=!0;if(c&&0<c.length)for(e=0;e<c.length;e++)O=R[q-1][e]===R[q][e]?!0:!1;else O=!0}if(t&&J&&L&&O)break;q++}p.save();p.beginPath();a[0]&&p.rect(5,a[0].bounds.y1,a[0].chart.width-10,a[0].bounds.height);f[0]&&p.rect(5,f[f.length-1].bounds.y1,f[0].chart.width-10,f[0].bounds.height);p.clip();if(a&&0<a.length)for(e=0;e<a.length;e++)a[e].calculateStripLinesThicknessInValues(),a[e].calculateBreaksInPixels(),a[e].renderLabelsTicksAndName();
if(f&&0<f.length)for(e=0;e<f.length;e++)f[e].calculateStripLinesThicknessInValues(),f[e].calculateBreaksInPixels(),f[e].renderLabelsTicksAndName();p.restore();if(b&&0<b.length)for(e=0;e<b.length;e++)b[e].calculateStripLinesThicknessInValues(),b[e].calculateBreaksInPixels(),b[e].renderLabelsTicksAndName();if(c&&0<c.length)for(e=0;e<c.length;e++)c[e].calculateStripLinesThicknessInValues(),c[e].calculateBreaksInPixels(),c[e].renderLabelsTicksAndName()}else{A=[];F=[];s=[];B=[];u=[];P=[];N=[];for(I=
...
{},k=Math.round(g.x1+X+d),n=Math.round(g.x2-M-T>r.width-10?r.width-10:g.x2-M-T),b[e].labelAutoFit&&!w(v)&&(0<!a.length&&(k=0>b[e].labelAngle?Math.max(k,v):0===b[e].labelAngle?Math.max(k,v/2):k),0<!f.length&&(n=0<b[e].labelAngle?n-y/2:0===b[e].labelAngle?n-y/2:n)),b[e].lineCoordinates.x1=k,b[e].lineCoordinates.x2=n,b[e].lineCoordinates.width=Math.abs(n-k),b[e].name&&(b[e]._nameTextBlock.maxWidth=0<b[e].nameMaxWidth&&b[e].nameMaxWidth<b[e].lineCoordinates.width?b[e].nameMaxWidth:b[e].lineCoordinates.width);
if(c&&0<c.length)for(e=0;e<c.length;e++)c[e].lineCoordinates={},k=Math.round(g.x1+X+d),n=Math.round(g.x2-M-T>c[e].chart.width-10?c[e].chart.width-10:g.x2-M-T),c[e]&&c[e].labelAutoFit&&!w(z)&&(0<!a.length&&(k=0<c[e].labelAngle?Math.max(k,z):0===c[e].labelAngle?Math.max(k,z/2):k),0<!f.length&&(n-=D/2)),c[e].lineCoordinates.x1=k,c[e].lineCoordinates.x2=n,c[e].lineCoordinates.width=Math.abs(n-k),c[e].name&&(c[e]._nameTextBlock.maxWidth=0<c[e].nameMaxWidth&&c[e].nameMaxWidth<c[e].lineCoordinates.width?
...
A[e];if(b&&0<b.length)for(e=b.length-1;0<=e;e--)l=Math.round(g.y2),h=Math.round(g.y2>b[e].chart.height-10?b[e].chart.height-10:g.y2),b[e].lineCoordinates.y1=l-(A[e]+b[e].margin+Q),b[e].lineCoordinates.y2=l-(A[e]+b[e].margin+Q),b[e].bounds={x1:k,y1:l-(A[e]+Q+b[e].margin),x2:n,y2:h-(Q+b[e].margin),width:n-k,height:A[e]},b[e].name&&(b[e]._nameTextBlock.maxWidth=0<b[e].nameMaxWidth&&b[e].nameMaxWidth<b[e].lineCoordinates.width?b[e].nameMaxWidth:b[e].lineCoordinates.width),Q+=A[e]+b[e].margin;if(c&&
...
0<b.length)for(K=0;K<b.length;K++)b[K]&&b[K].labelAutoFit&&(n=0>b[K].labelAngle?Math.max(n,v):0===b[K].labelAngle?Math.max(n,v/2):n,k=0>b[K].labelAngle||0===b[K].labelAngle?n-M:k);if(c&&0<c.length)for(K=0;K<c.length;K++)c[K]&&c[K].labelAutoFit&&(n=c[K].lineCoordinates.x2,k=n-M);f[e].lineCoordinates={x1:n+V,y1:l,x2:n+V,y2:h,height:Math.abs(h-l)};f[e].bounds={x1:k,y1:l,x2:n+B[e]+V,y2:h,width:n-k,height:h-l};f[e].name&&(f[e]._nameTextBlock.maxWidth=0<f[e].nameMaxWidth&&f[e].nameMaxWidth<f[e].lineCoordinates.height?
f[e].nameMaxWidth:f[e].lineCoordinates.height);f[e].calculateValueToPixelConversionParameters();f[e].calculateBreaksSizeInValues();V+=B[e]+f[e].margin}for(e=0;e<m.length;e++)"axisY"===m[e].type&&(m[e].calculateValueToPixelConversionParameters(),m[e].calculateBreaksSizeInValues());if(0<q){if(a&&0<a.length)for(e=0;e<a.length;e++)t=N[q-1][e]===N[q][e]?!0:!1;else t=!0;if(f&&0<f.length)for(e=0;e<f.length;e++)J=I[q-1][e]===I[q][e]?!0:!1;else J=!0;if(b&&0<b.length)for(e=0;e<b.length;e++)L=u[q-1][e]===u[q][e]?
!0:!1;else L=!0;if(c&&0<c.length)for(e=0;e<c.length;e++)O=P[q-1][e]===P[q][e]?!0:!1;else O=!0}if(t&&J&&L&&O)break;q++}if(b&&0<b.length)for(e=0;e<b.length;e++)b[e].calculateBreaksInPixels(),b[e].renderLabelsTicksAndName();if(c&&0<c.length)for(e=0;e<c.length;e++)c[e].calculateBreaksInPixels(),c[e].renderLabelsTicksAndName();if(a&&0<a.length)for(e=0;e<a.length;e++)a[e].calculateBreaksInPixels(),a[e].renderLabelsTicksAndName();if(f&&0<f.length)for(e=0;e<f.length;e++)f[e].calculateBreaksInPixels(),
f[e].renderLabelsTicksAndName()}r.preparePlotArea();g=r.plotArea;p.save();p.beginPath();p.rect(g.x1,g.y1,Math.abs(g.x2-g.x1),Math.abs(g.y2-g.y1));p.clip();if(a&&0<a.length)for(e=0;e<m.length;e++)m[e].renderStripLinesOfThicknessType("value");if(f&&0<f.length)for(e=0;e<f.length;e++)f[e].renderStripLinesOfThicknessType("value");if(b&&0<b.length)for(e=0;e<b.length;e++)b[e].renderStripLinesOfThicknessType("value");if(c&&0<c.length)for(e=0;e<c.length;e++)c[e].renderStripLinesOfThicknessType("value");if(a&&
...
this.conversionParameters.minimum||(w(this.scaleBreaks.firstBreakIndex)&&(this.scaleBreaks.firstBreakIndex=f),a[f].startValue>=this.conversionParameters.minimum&&(a[f].startPixel=this.convertValueToPixel(a[f].startValue),this.scaleBreaks.lastBreakIndex=f),a[f].endValue<=this.conversionParameters.maximum&&(a[f].endPixel=this.convertValueToPixel(a[f].endValue)))}};B.prototype.renderLabelsTicksAndName=function(){var a=this,f=!1,b=0,c=0,d=1,g=0;0!==this.labelAngle&&360!==this.labelAngle&&(d=1.2);if("undefined"===
...
a.ctx.beginPath();a.ctx.moveTo(b,m.y<<0);a.ctx.lineTo(b,m.y-a.tickLength<<0);a.ctx.stroke();a.ctx.restore()}},this);this.name&&(this._nameTextBlock.measureText(),this._nameTextBlock.x=this.lineCoordinates.x1+this.lineCoordinates.width/2-this._nameTextBlock.width/2,this._nameTextBlock.y=this.bounds.y2-this._nameTextBlock.height-3,this.nameMaxWidth=this._nameTextBlock.maxWidth,this._nameTextBlock.render(!0))}else if("top"===this._position){for(h=0;h<this._labels.length;h++)p=this._labels[h],
p.position<this.viewportMinimum||(p.position>this.viewportMaximum||f&&0!==g++%2&&this.labelAutoFit)||(m=this.getPixelCoordinatesOnAxis(p.position),this.tickThickness&&"inside"!=this.labelPlacement&&(this.ctx.lineWidth=this.tickThickness,this.ctx.strokeStyle=this.tickColor,c=1===this.ctx.lineWidth%2?(m.x<<0)+0.5:m.x<<0,this.ctx.beginPath(),this.ctx.moveTo(c,m.y<<0),this.ctx.lineTo(c,m.y-this.tickLength<<0),this.ctx.stroke()),0===p.textBlock.angle?(m.x-=p.textBlock.width/2,m.y="inside"===this.labelPlacement?
...
a.ctx.strokeStyle=a.tickColor;var b=1===a.ctx.lineWidth%2?(m.y<<0)+0.5:m.y<<0;a.ctx.save();a.ctx.beginPath();a.ctx.moveTo(m.x<<0,b);a.ctx.lineTo(m.x+a.tickLength<<0,b);a.ctx.stroke();a.ctx.restore()}},this);this.name&&(this._nameTextBlock.measureText(),this._nameTextBlock.x=this.bounds.x1+1,this._nameTextBlock.y=this.lineCoordinates.height/2+this._nameTextBlock.width/2+this.lineCoordinates.y1,this.nameMaxWidth=this._nameTextBlock.maxWidth,this._nameTextBlock.render(!0))}else if("right"===
...
null===b.options.toolTipContent||("line"===b.type||"stepLine"===b.type||"spline"===b.type||"area"===b.type||"stepArea"===b.type||"splineArea"===b.type||"column"===b.type||"bar"===b.type||"scatter"===b.type||"stackedColumn"===b.type||"stackedColumn100"===b.type||"stackedBar"===b.type||"stackedBar100"===b.type||"stackedArea"===b.type||"stackedArea100"===b.type||"waterfall"===b.type?(this.chart.axisX&&1<this.chart.axisX.length&&(g+=n!=b.axisXIndex?b.axisX.name?b.axisX.name+"<br/>":"X:{axisXIndex}<br/>":
""),g+=c.toolTipContent?c.toolTipContent:b.toolTipContent?b.toolTipContent:this.content&&"function"!==typeof this.content?this.content:"<span style='\""+(this.options.fontColor?"":"'color:{color};'")+"\"'>{name}:</span>&nbsp;&nbsp;{y}",n=b.axisXIndex):"bubble"===b.type?(this.chart.axisX&&1<this.chart.axisX.length&&(g+=n!=b.axisXIndex?b.axisX.name?b.axisX.name+"<br/>":"X:{axisXIndex}<br/>":""),g+=c.toolTipContent?c.toolTipContent:b.toolTipContent?b.toolTipContent:this.content&&"function"!==typeof this.content?
this.content:"<span style='\""+(this.options.fontColor?"":"'color:{color};'")+"\"'>{name}:</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}"):"rangeColumn"===b.type||"rangeBar"===b.type||"rangeArea"===b.type||"rangeSplineArea"===b.type||"error"===b.type?(this.chart.axisX&&1<this.chart.axisX.length&&(g+=n!=b.axisXIndex?b.axisX.name?b.axisX.name+"<br/>":"X:{axisXIndex}<br/>":""),g+=c.toolTipContent?c.toolTipContent:b.toolTipContent?b.toolTipContent:this.content&&"function"!==typeof this.content?this.content:
"<span style='\""+(this.options.fontColor?"":"'color:{color};'")+"\"'>{name}:</span>&nbsp;&nbsp;{y[0]},&nbsp;{y[1]}"):"candlestick"===b.type||"ohlc"===b.type?(this.chart.axisX&&1<this.chart.axisX.length&&(g+=n!=b.axisXIndex?b.axisX.name?b.axisX.name+"<br/>":"X:{axisXIndex}<br/>":""),g+=c.toolTipContent?c.toolTipContent:b.toolTipContent?b.toolTipContent:this.content&&"function"!==typeof this.content?this.content:"<span style='\""+(this.options.fontColor?"":"'color:{color};'")+"\"'>{name}:</span><br/>Open: &nbsp;&nbsp;{y[0]}<br/>High: &nbsp;&nbsp;&nbsp;{y[1]}<br/>Low:&nbsp;&nbsp;&nbsp;{y[2]}<br/>Close: &nbsp;&nbsp;{y[3]}"):
"boxAndWhisker"===b.type&&(this.chart.axisX&&1<this.chart.axisX.length&&(g+=n!=b.axisXIndex?b.axisX.name?b.axisX.name+"<br/>":"X:{axisXIndex}<br/>":""),g+=c.toolTipContent?c.toolTipContent:b.toolTipContent?b.toolTipContent:this.content&&"function"!==typeof this.content?this.content:"<span style='\""+(this.options.fontColor?"":"'color:{color};'")+"\"'>{name}:</span><br/>Minimum: &nbsp;&nbsp;{y[0]}<br/>Q1: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{y[1]}<br/>Q2: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{y[4]}<br/>Q3: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{y[2]}<br/>Maximum: &nbsp;{y[3]}"),
