...
<div class="mobile-menu">
    ...
    <li class="{{ Request::url() == route('courier-dashboard') ? 'active' : '' }}">
    ...
    <li class="{{ Request::routeIs('courier-purchases') && !Request::query('type') ? 'active' : '' }}">
        <a href="{{ route('courier-purchases') }}">
    ...
    <li class="{{ Request::fullUrlIs(route('courier-purchases') . '?type=complete') ? 'active' : '' }}">
        <a href="{{ route('courier-purchases') }}?type=complete">
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
    ...
    <li class="{{ Request::url() == route('courier-service-area') ? 'active' : '' }}">
        <a href="{{ route('courier-service-area') }}">
    ...
    <li class="{{ Request::url() == route('courier-wwt-index') ? 'active' : '' }}">
        <a href="{{ route('courier-wwt-index') }}">
    ...
    <li class="{{ Request::url() == route('courier-reset') ? 'active' : '' }}">
        <a href="{{ route('courier-reset') }}">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
    ...
    <li class="{{ Request::url() == route('courier-logout') ? 'active' : '' }}">
