    ...
    <div class="single-product-list-view">
        ...
        <div class="content-wrapper">
            ...
            <p>
                ...
                <span class="badge {{ $stockQty ? 'bg-success' : 'bg-warning' }}">{{ $stockQty ?? 0 }}</span>
            </p>

            @if($product->weight)
                <p>
                    <span>@lang('Weight, kg:')</span>
                    <span>{{ $product->weight ?? 0 }}</span>
                </p>
            @endif
        ...
        <div class="content-wrapper align-content-center align-items-center">
            ...
            <div class="add-to-cart align-items-center">
                <div class="ratings-wrapper">
                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                        <path d="M8.5 0.5L10.4084 6.37336L16.584 6.37336L11.5878 10.0033L13.4962 15.8766L8.5 12.2467L3.50383 15.8766L5.41219 10.0033L0.416019 6.37336L6.59163 6.37336L8.5 0.5Z" fill="#EEAE0B"/>
                    </svg>
