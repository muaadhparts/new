<style>
    /* Modern Teal/Cyan Sidebar Theme */
    ...
    .gs-dashboard-user-sidebar-wrapper li::before {
        content: '';
        position: absolute;
        left: 0;
        top: 0;
    ...
    .gs-dashboard-user-sidebar-wrapper li:hover::before,
    .gs-dashboard-user-sidebar-wrapper li.active::before {
        transform: scaleY(1);
    }
    ...
    .gs-dashboard-user-sidebar-wrapper li a svg path,
    .gs-dashboard-user-sidebar-wrapper li a svg rect {
        stroke: #64748b;
        transition: all 0.3s ease;
    }

    .gs-dashboard-user-sidebar-wrapper li:hover a svg path,
    .gs-dashboard-user-sidebar-wrapper li:hover a svg rect {
        stroke: #0d9488;
        fill: none;
    }

    .gs-dashboard-user-sidebar-wrapper li.active a svg path,
    .gs-dashboard-user-sidebar-wrapper li.active a svg rect {
        stroke: #ffffff;
        fill: none;
    }
    ...
    /* Scrollbar styling */
    .gs-dashboard-user-sidebar-wrapper::-webkit-scrollbar {
        width: 6px;
    }

    .gs-dashboard-user-sidebar-wrapper::-webkit-scrollbar-track {
        background: #f0fdfa;
        border-radius: 10px;
    }

    .gs-dashboard-user-sidebar-wrapper::-webkit-scrollbar-thumb {
        background: linear-gradient(180deg, #0d9488 0%, #14b8a6 100%);
        border-radius: 10px;
    }

    .gs-dashboard-user-sidebar-wrapper::-webkit-scrollbar-thumb:hover {
