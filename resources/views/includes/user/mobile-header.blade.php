...
<div class="mobile-menu">
    ...
    @if (auth()->check() && auth()->user()->is_merchant == 2)
    <li>
    ...
    <li class="{{ Request::url() == route('user-purchases') ? 'active' : '' }}">
    ...
    <li
        class="{{ Request::url() == route('user-top-up-index') || request()->path() == 'user/top-up/create' ? 'active' : '' }}">
        <a href="{{ route('user-top-up-index') }}">
            ...
            <span>@lang('Top Up')</span>
        </a>
    </li>
    
    <li class="{{ Request::url() == route('user-wallet-logs-index') ? 'active' : '' }}">
    ...
    <li class="{{ Request::url() == route('user-purchase-track') ? 'active' : '' }}">
        <a href="{{ route('user-purchase-track') }}">
            ...
            <span>@lang('Purchase Tracking')</span>
        </a>
    </li>
