...
<div class="mobile-menu">
    <div class="mobile-menu-top">
        ...
        <svg class="btn-close" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
            fill="none">
        ...
        <ul class="gs-dashboard-user-sidebar-wrapper">
            ...
            <li>
                <a href="{{ route('front.merchant', str_replace(' ', '-', auth()->user()->shop_name)) }}" target="_blank">
            ...
            <li class="{{ request()->is('merchant/delivery') ? 'active' : '' }}">
                <a href="{{ route('merchant.delivery.index') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path
            ...
            <li class="{{ request()->is('merchant/orders') || request()->is('merchant/order/*/show') ? 'active' : '' }}">
                <a href="{{ route('merchant-purchase-index') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path
            ...
            <li
                class="has-sub-menu {{ request()->is('merchant/products/types') || request()->is('merchant/products') || request()->is('merchant/products/catalogs') || request()->is('merchant/products/physical/create') || request()->is('merchant/products/digital/create') || request()->is('merchant/products/license/create') || request()->is('merchant/products/listing/create') || request()->is('merchant/products/edit/*') || request()->is('merchant/products/catalog/*') ? 'active' : '' }}">


                <a href="#merchant-collapse-product"
                    class="{{ request()->is('merchant/products/types') || request()->is('merchant/products') || request()->is('merchant/products/catalogs') || request()->is('merchant/products/physical/create') || request()->is('merchant/products/digital/create') || request()->is('merchant/products/license/create') || request()->is('merchant/products/listing/create') || request()->is('merchant/products/edit/*') || request()->is('merchant/products/catalog/*') ? '' : 'collapsed' }}"
                ...
                <ul class="sidebar-sub-menu collapse {{ request()->is('merchant/products/types') || request()->is('merchant/products') || request()->is('merchant/products/catalogs') || request()->is('merchant/products/physical/create') || request()->is('merchant/products/digital/create') || request()->is('merchant/products/license/create') || request()->is('merchant/products/listing/create') || request()->is('merchant/products/edit/*') || request()->is('merchant/products/catalog/*') ? 'show' : '' }}"
            ...
            <li
                class="has-sub-menu {{ request()->is('merchant/shipping') || request()->is('merchant/shipping/*') || request()->is('merchant/package') || request()->is('merchant/package/*') || request()->is('merchant/pickup-point') || request()->is('merchant/pickup-point/*') || request()->is('merchant/social-link') || request()->is('merchant/social-link/*') ? 'active' : '' }}">
                <a href="#merchant-collapsed-settings"
                    class="{{ request()->is('merchant/shipping') || request()->is('merchant/shipping/*') || request()->is('merchant/package') || request()->is('merchant/package/*') || request()->is('merchant/pickup-point') || request()->is('merchant/pickup-point/*') || request()->is('merchant/social-link') || request()->is('merchant/social-link/*') ? '' : 'collapsed' }}"
                ...
                <ul class="sidebar-sub-menu collapse {{ request()->is('merchant/shipping') || request()->is('merchant/shipping/*') || request()->is('merchant/package') || request()->is('merchant/package/*') || request()->is('merchant/pickup-point') || request()->is('merchant/pickup-point/*') || request()->is('merchant/social-link') || request()->is('merchant/social-link/*') ? 'show' : '' }}"
