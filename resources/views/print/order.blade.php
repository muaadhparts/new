...
.add-catalogItem-box hr {margin-top: 10px; margin-bottom: 10px;}
...
.name-stats.name-blue {background-color: #0073b7;}
.name-stats.name-green {background-color: #00a65a;}
.name-stats.name-skyblue {background-color: #00acd6;}
.name-stats.name-red {background-color: #f56954;}
.name-stats.name-gray {background-color: #8A6D3B;}
.name-stats.name-pink {background-color: #E91E63;}
.name-stats.name-cyan {background-color: #00BCD4;}
.name-stats.name-orange {background-color: #FF9800;}
.name-stats.name-purple {background-color: #9C27B0;}
.name-stats.name-blue {background-color: #2196F3;}
.name-stats.name-indigo {background-color: #3F51B5;}


.name-stats.name-blue:hover {background-color: #00639e;}
.name-stats.name-green:hover {background-color: #008d4c;}
.name-stats.name-skyblue:hover {background-color: #009AC0;}
.name-stats.name-red:hover {background: #f4543c;}
.name-stats.name-gray:hover {background-color: #7C6235;}
.name-stats.name-pink:hover {background-color: #bd0846;}
.name-stats.name-cyan:hover {background-color: #058696;}
.name-stats.name-orange:hover {background-color: #d88305;}
.name-stats.name-purple:hover {background-color: #87089c;}
.name-stats.name-blue:hover {background-color: #037ad8;}
.name-stats.name-indigo:hover {background-color: #2a3ca0;}

.name-stats .number {font-size: 38px; font-weight: 600;}
.name-stats h4 {margin-bottom: 10px; font-weight: 100;}
.name-view-btn {
    background-color: #fff;
    border-radius: 30px;
...
.catalogItem-sold-chart {margin-bottom: 30px;}
...
/* Starting of Dashboard add-catalogItem-1 area */
.add-catalogItem-1 {
    background-color: #fff;
    padding: 0;
    margin: 20px 0;
...
.add-catalogItem-header {
    padding: 10px 15px 0 15px;
    display: flex;
    justify-content: space-between;
}
.add-catalogItem-header h2 {margin: 0; margin-top: 4px; font-size: 25px;}
...
.add-product_btn:hover, .btn.catalogItem-btn:hover,
.pending-withdraw:hover {
    color: #009432;
    background-color: #ffffff;
}
.catalogItem-header-name h2 {
    font-size: 18px;
    margin-bottom: 6px;
}
.product__header {
...
.add-catalogItem-footer {padding-bottom: 20px;}
.add-catalogItem-box .form-horizontal {padding: 20px 0;}
.add-catalogItem-box .form-horizontal .form-group {margin-bottom: 20px;}
.add-catalogItem-box .form-horizontal .form-group:last-child {margin-bottom: 0;}
.add-catalogItem-box .form-horizontal .form-control {
    height: 40px;
    border-radius: 0;
    box-shadow: none;
}
.add-catalogItem-box .form-horizontal textarea.form-control {
    height: auto;
    border-radius: 0;
}
.add-catalogItem-footer {text-align: center;}
.add-product_btn {
    padding: 10px 30px;
    font-weight: 700;
    background-color: #009432;
...
.add-catalogItem-box > .form-horizontal label {font-size: 16px;}
.add-catalogItem-box > .form-horizontal label span {
    display: block;
    font-weight: 400;
    font-size: 10px;
}
...
/* Ending of Dashboard add-catalogItem-1 area */
...
.table.catalogItems > thead > tr > th {
    border-bottom: none;
    font-size: 16px;
    font-weight: 400;
}
.table.catalogItems > tbody > tr > td {
    padding: 7px 5px;
    vertical-align: middle;
}
.table.catalogItems > tbody > tr:last-child td {border-bottom: 1px solid #ddd;}
table.table.catalogItems.dataTable.dtr-inline.collapsed > tbody > tr[role="row"] > td:first-child::before {
    top: 40%;
...
.catalogItem-btn:last-child {margin-bottom: 0;}
...
.add-catalogItem-header.faq {margin-bottom: 20px;}
...
/* Starting of Dashboard Website Purchase view Details area */
.table-responsive.purchase-details-table {padding: 20px;}
.o-pending {
    color: #FFFFFF;
    background-color: #985f0d;
}
.add-product_btn.purchase-details {
    margin: 5px 15px 25px 15px;
}
/* Ending of Dashboard Website Purchase view Details area */
...
.login-form .input-group-module {
    background-color: transparent;
    border-radius: 2px;
    color: #337AB7;
}
.login-form .input-group-module i.fa {
    width: 20px;
    font-size: 20px;
}
...
.profile-comments-name p {font-size: 12px;}
...
.purchase-table-wrap {padding: 20px;}
.purchase-table-wrap .table>tbody>tr>td,
.purchase-table-wrap .table>tbody>tr>th
 {border-top: none;}
.purchase-table-wrap .table>tbody>tr.tr-head {
    position: relative;
}
.purchase-table-wrap .table>tbody>tr.tr-head:after {
    position: absolute;
    content: "";
    left: 20px;
    top: 0;
...
.purchase-table-wrap .table>tbody>tr>th.purchase-th {font-size: 22px;}
.purchase-table-wrap .table td,
.purchase-table-wrap .table th {padding: 0.50rem;}
...
.modal.merchant .modal-body {
    padding: 1.5em;
}
.modal.merchant .modal-footer {
    background: #f1f4fb;
    padding: 1.4rem;
    border-top: 1px solid #e9ecef;
    text-align: left;
}
.modal.merchant .email-btn {
    background: #0363D1;
...
.modal.merchant .email-btn:hover {
    background: #ffffff;
    color: #0363D1;
}
.modal.merchant.in .modal-dialog {
    position:fixed;
    bottom:0px;
    right:0px;
    margin:0px;
...
.modal.merchant .modal-content {
    border: none;
    /*box-shadow: none;*/
}
.modal.merchant .form-control {
    border-top: none;
    border-left: none;
    border-right: none;
    border-radius: 0px;
...
.modal.merchant .form-group {margin-bottom: 24px;}
/*----------Ending of Merchant shop area----------*/
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($catalogItem['size'])
                                               <p>
                                               @lang('Size :') {{str_replace('-',' ',$catalogItem['size'])}}
                                               </p>
                                               @endif
                                               @if($catalogItem['color'])
                                                <p>
                                                @lang('Color :') <span style="margin-left: 40px; width: 20px; height: 0.2px; display: block; border: 10px solid {{$catalogItem['color'] == "" ? "white" : $catalogItem['color']}};"></span>
                                                </p>
                                                @endif
                                                <p>
