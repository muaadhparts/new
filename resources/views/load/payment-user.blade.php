...
@if ($payment == 'authorize.net')
    ...
    <div class="form-group py-2">
        ...
        <input type="text" class=" form-control
            " name="cardCode" placeholder="{{ __('Card Code') }}"
            required="">
...
@if ($gateway->keyword == 'mercadopago')
    ...
    <div class="form-group py-2">
        <select id="docType" class="option form-control border" name="docType" data-checkout="docType"
            type="text"></select>
    </div>
...
@if ($payment == 'other')
    <div class="row mt-3">
        ...
        <div class="col-lg-8">
            {!! clean($gateway->details, ['Attr.EnableID' => true]) !!}
        </div>
    </div>
    ...
    <div class="row mt-3">
        ...
        <div class="col-lg-8">
            <input type="text" class="option" name="txnid" required="" placeholder="{{ __('Transaction ID#') }}"
                required="">
        </div>
    </div>
@endif
