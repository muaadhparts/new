        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="links">
                    ...
                    <li>
                        <a href="{{ route('admin-courier-index') }}">{{ __("Couriers") }}</a>
                    </li>
                    <li>
                        <a href="{{ route('admin-courier-show',$data->id) }}">{{ __("Details") }}</a>
                    </li>
                </ul>
            </div>
        </div>
                                ...
                                <div class="table-responsive">
                                    <table id="example2" class="table table-hover dt-responsive" cellspacing="0"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><a href="{{ route('admin-purchase-invoice',$deliveryCourier->purchase->id) }}">{{sprintf("%'.08d",
                                                ...
                                                <td>
                                                    <a href=" {{ route('admin-purchase-show',$deliveryCourier->purchase->id) }}"
                                                        class="view-details">
