                    ...
                    <div class="theme-tab-content active" id="tab-colors">
                        ...
                        <div class="theme-section">
                            ...
                            <div class="preset-grid">
                                <button type="button" class="preset-btn" data-preset="nissan" style="background: #c3002f; color: #fff;">Nissan Red</button>
                                <button type="button" class="preset-btn" data-preset="blue" style="background: #2563eb; color: #fff;">Blue</button>
                                <button type="button" class="preset-btn" data-preset="green" style="background: #16a34a; color: #fff;">Green</button>
                                <button type="button" class="preset-btn" data-preset="purple" style="background: #9333ea; color: #fff;">Purple</button>
                                <button type="button" class="preset-btn" data-preset="orange" style="background: #ea580c; color: #fff;">Orange</button>
                                <button type="button" class="preset-btn" data-preset="teal" style="background: #0d9488; color: #fff;">Teal</button>
                            </div>
                        </div>
