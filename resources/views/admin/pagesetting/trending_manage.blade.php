            ...
            <div class="col-lg-12">
                <div class="product-description">
                    <div class="body-area">
                        <div class="row mb-4">
                            <div class="col-md-8">
                                <h5 class="mb-3">{{ __('Current Trending Products') }}</h5>
                            </div>
                            <div class="col-md-4">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('Add Product to Trending') }}</h5>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.select-product', function() {
        ...
        $.get('{{ route("admin-ps-trending-merchants") }}', { product_id: selectedProductId }, function(merchants) {
    ...
    $(document).on('click', '.add-item', function() {
        ...
        $.ajax({ url: '{{ route("admin-ps-trending-toggle") }}', type: 'POST', data: { _token: '{{ csrf_token() }}', merchant_product_id: btn.data('id'), flag: 1 },
    ...
    $(document).on('click', '.remove-item', function() {
        ...
        btn.prop('disabled', true).html('<i class="fas fa-spinner fa-spin"></i>');
        $.ajax({ url: '{{ route("admin-ps-trending-toggle") }}', type: 'POST', data: { _token: '{{ csrf_token() }}', merchant_product_id: btn.data('id'), flag: 0 },
