        ...
        <div class="row">
            <div class="col-lg-12">
                <h4 class="heading">{{ __('Home Page Themes') }}
                    <a class="add-btn" href="{{ route('admin-homethemes-create') }}">
                        ...
                        <div class="card h-100 {{ $theme->is_active ? 'border-success' : '' }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap gap-1 mb-3">
                                    @if($theme->show_slider)<span class="badge bg-primary">Slider</span>@endif
                                    ...
                                    @if($theme->show_services)<span class="badge bg-primary">Services</span>@endif
                            ...
                            <div class="card-footer">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <a href="{{ route('admin-homethemes-edit', $theme->id) }}" class="btn btn-sm btn-info">
                                            <i class="fas fa-edit"></i> {{ __('Edit') }}
                                        </a>
                                        <a href="{{ route('admin-homethemes-duplicate', $theme->id) }}" class="btn btn-sm btn-secondary">
                                            <i class="fas fa-copy"></i> {{ __('Duplicate') }}
                                        </a>
                                    </div>
                                    <div>
                                        @if(!$theme->is_active)
                                            <a href="{{ route('admin-homethemes-activate', $theme->id) }}" class="btn btn-sm btn-success">
                                                <i class="fas fa-check"></i> {{ __('Activate') }}
                                            </a>
                                            <button type="button" class="btn btn-sm btn-danger" data-href="{{ route('admin-homethemes-delete', $theme->id) }}" data-bs-toggle="modal" data-bs-target="#deleteModal">
