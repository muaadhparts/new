...
@include('components.admin.modal-delete', ['message' => __('You are about to delete this Child Category. Everything under this category will be deleted.')])
...
(function($) {
    ...
    $(function() {
        $(".btn-area").append('<div class="col-sm-4 table-contents">' +
            '<a class="add-btn" data-href="{{ route('admin-childcat-create') }}" id="add-data" data-bs-toggle="modal" data-bs-target="#modal1">' +
