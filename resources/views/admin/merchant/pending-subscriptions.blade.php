...
@section('content')  
                    ...
                    <div class="content-area">
                        <div class="mr-breadcrumb">
                            <div class="row">
                                <div class="col-lg-12">
                                        <h4 class="heading">{{ __("Pending Merchant Subscriptions") }}</h4>
                                        <ul class="links">
                                            <li>
                                            ...
                                            <li>
                                                <a href="{{ route('admin-merchant-subs','pending') }}">{{ __("Pending Merchant Subscriptions") }}</a>
                                            </li>
                                        </ul>
                                </div>
                            </div>
...
(function($) {
        ...
        var table = $('#muaadhtable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-merchant-subs-datatables','0') }}',
               columns: [
