        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="links">
                    ...
                    <li>
                        <a href="{{ route('admin-help-article-index') }}">{{ __('Help Article') }}</a>
                    </li>
                </ul>
            </div>
        </div>
...
@include('components.admin.modal-delete', ['message' => __('You are about to delete this Help Article.')])
...
(function($) {
    ...
    var table = $('#muaadhtable').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{{ route('admin-help-article-datatables') }}',
        columns: [
    ...
    $(function() {
        $(".btn-area").append('<div class="col-sm-4 table-contents">' +
            '<a class="add-btn" href="{{ route('admin-help-article-create') }}">' +
