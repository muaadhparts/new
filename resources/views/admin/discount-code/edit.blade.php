...
@section('content')
            ...
            <div class="content-area">
              ...
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('Edit Discount Code') }} <a class="add-btn" href="{{route('admin-discount-code-index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="{{ route('admin-discount-code-edit',$data->id) }}">{{ __('Edit Discount Code') }}</a>
                        </li>
                      </ul>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="muaadhform" action="{{route('admin-discount-code-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
