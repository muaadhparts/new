    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.shipments.refresh', $shipment->tracking_number) }}" class="btn btn-sm btn-outline-info">
        ...
        <div class="col-lg-4">
                ...
                <div class="card-body">
                    <table class="table table-sm table-borderless mb-0">
                        ...
                        <tr>
                            ...
                            <td class="text-right">{{ $order->customer_name ?? 'N/A' }}</td>
                        </tr>
                        <tr>
                            <td class="text-muted">{{ __('Phone') }}</td>
                            <td class="text-right">{{ $order->customer_phone ?? 'N/A' }}</td>
                        </tr>
                        <tr>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ route('admin.shipments.refresh', $shipment->tracking_number) }}" class="btn btn-info btn-block mb-2">
