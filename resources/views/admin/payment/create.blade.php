                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="catalogItem-description">
                      ...
                      <form id="muaadhformdata" action="{{route('admin-payment-create')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <button class="btn btn-primary" type="submit">{{ __('Create Payment') }}</button>
                          </div>
                        </div>
                      </form>
                      </div>
