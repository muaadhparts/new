                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>
                                ...
                                <a target="_blank" href="{{ route('front.product.user', ['slug' => $product['item']['slug'], 'user' => $product['item']['user_id']]) }}" >{{mb_strlen($product['item']['name'],'utf-8') > 30 ? mb_substr($product['item']['name'],0,30,'utf-8').'...' : $product['item']['name']}}</a>
                              </td>
