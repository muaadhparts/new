                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="catalogItem-description">
                                            ...
                                            <form id="trackform" action="{{route('admin-purchase-timeline-store')}}" method="POST" enctype="multipart/form-data">
                                                {{csrf_field()}}
							...
							<div class="add-catalogItem-content">
								<div class="row">
                                    ...
                                    <div class="table-responsive show-table ml-3 mr-3">
                                        <table class="table" id="track-load" data-href={{ route('admin-purchase-timeline-load',$purchase->id) }}>
                                            <tr>
                                                <th>{{ __("Title") }}</th>
                                                <th>{{ __("Details") }}</th>
                                                <th>{{ __("Date") }}</th>
                                            ...
                                            <tr data-id="{{ $track->id }}">
                                                ...
                                                <td>
                                                    <div class="action-list">
                                                        <a data-href="{{ route('admin-purchase-timeline-update',$track->id) }}" class="track-edit"> <i class="fas fa-edit"></i>{{__('Edit')}}</a>
                                                        <a href="javascript:;" data-href="{{ route('admin-purchase-timeline-delete',$track->id) }}" class="track-delete"><i class="fas fa-trash-alt"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            @endforeach
