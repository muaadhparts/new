        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" id="t-add" value="{{ route('admin-purchase-timeline-add') }}">
    ...
    <script type="text/javascript">
        (function($) {
            ...
            var table = $('#muaadhtable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ route('admin-purchase-datatables', 'none') }}',
                columns: [{
                        data: 'customer_email',
                        name: 'customer_email'
                    },
            ...
            $(function() {
                $(".btn-area").append('<div class="col-sm-4 table-contents">' +
                    '<a class="add-btn" href="{{ route('admin-purchase-create') }}">' +
