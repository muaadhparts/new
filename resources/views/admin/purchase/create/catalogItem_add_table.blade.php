     ...
     <table id="example2" class="table table-hover dt-responsive" cellspacing="0" width="100%">
        ...
        <tbody>
           ...
           <tr>
              ...
              <td>
                 <a href="javascript:;"  data-href="{{ route('admin.purchase.remove.cart',$catalogItem['item']['id'].$catalogItem['size'].$catalogItem['color'].str_replace(str_split(' ,'),'',$catalogItem['values'])) }}" class="btn btn-primary removeOrder"><i class="fa fa-trash"></i> {{ __('Remove') }}</a>
              </td>
           </tr>
           @endforeach
        </tbody>
