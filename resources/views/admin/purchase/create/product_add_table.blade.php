     ...
     <table id="example2" class="table table-hover dt-responsive" cellspacing="0" width="100%">
        ...
        <tbody>
           ...
           <tr>
                ...
                <br>
                 ...
                 @php
                    ...
                    if (isset($product['item']['slug']) && isset($product['user_id']) && isset($product['merchant_item_id'])) {
                        ...
                        $prodAddTableUrl = route('front.catalog-item.legacy', $product['item']['slug']);
                    }
                 @endphp
              ...
              <td>
                 <a href="javascript:;"  data-href="{{ route('admin.purchase.remove.cart',$product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values'])) }}" class="btn btn-primary removeOrder"><i class="fa fa-trash"></i> {{ __('Remove') }}</a>
              </td>
           </tr>
           @endforeach
        </tbody>
