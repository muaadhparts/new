        ...
        <div class="container">
            <div class="d-flex">
                ...
                <div class="gs-dashboard-user-content-wrapper gs-dashboard-outlet">
                    ...
                    @include('includes.user.purchase-process')
                            ...
                            <div class="address-item">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        {{ $purchase->customer_address }},{{ $purchase->customer_city }}-{{ $purchase->customer_zip }}
                                    </li>
                                    <li>
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                            ...
                            <ul>
                                ...
                                <li><span>@lang('Payment Method:') </span>
                                    ...
                                    @if ($purchase->method != 'Cash On Delivery' && $purchase->method != 'Wallet')
                                        <br>
                                        <span> {{ __('Transaction ID') }} : </span> {{ $purchase->txnid }}
                                    @endif
                                </li>
                            </ul>
                        </div>
