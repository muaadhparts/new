    ...
    <div class=" product-nav-wrapper">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a class="text-primary" href="{{route('tree.level2',['id'=> $brand->name ,'data'=> $vehicle ,'key1' => $category->code ])}}">{{$category->label}}</a></li>
{{--                <a href="{{route('tree.level3',['id'=> $brand->name ,'data'=> $catalog->data ,'key1' => $catalog->key1  , 'key2'=>$catalog->code])}}">--}}
