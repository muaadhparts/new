  ...
  <div class="widget border-0 py-0 widget_categories">
    ...
    <ul>
      ...
      <li class=""><a class="{{ Request::url() == route('rider-profile') ? 'active' : '' }}"
          href="{{ route('rider-profile') }}">{{ __('Edit Profile') }}</a></li>
      <li class=""><a class="{{ Request::url() == route('rider-wwt-index') ? 'active' : '' }}"
          href="{{route('rider-wwt-index')}}">{{ __('Withdraw') }}</a></li>
      <li class=""><a class="{{ Request::url() == route('rider-reset') ? 'active' : '' }}"
          href="{{ route('rider-reset') }}">{{ __('Reset Password') }}</a></li>
