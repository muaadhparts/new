    ...
    <div class="gs-vendor-outlet">
        ...
        <div class="gs-vendor-breadcrumb has-mb">
            <div class="d-flex gap-4 custom-gap-sm-2 flex-wrap align-items-center">
                ...
                <a href="{{ route('vendor-discount-code-create') }}" class="template-btn mb-3 md-btn black-btn data-table-btn"
                    type="button">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-icon-btns-wrapper">
                                            <a href="{{ route('vendor-discount-code-edit', $data->id) }}"
                                            ...
                                            <a href="javascript:;"
                                                data-href="{{ route('vendor-discount-code-delete', $data->id) }}"
