    ...
    <div class="gs-vendor-outlet">
        ...
        <div class="gs-vendor-breadcrumb has-mb">
            <div class="d-flex gap-4 flex-wrap align-items-center">
                <a class="back-btn" href="{{ route('vendor-discount-code-index') }}">
            ...
            <ul class="breadcrumb-menu">
                ...
                <li>
                    <a href="{{ route('vendor-discount-code-index') }}" class="text-capitalize">@lang('Discount Codes')</a>
                </li>
                <li>
        ...
        <div class="vendor-edit-profile-section-wrapper">
            <div class="gs-edit-profile-section">
                <form class="edit-profile-area" id="discountCodeForm" action="{{ route('vendor-discount-code-update', $data->id) }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
