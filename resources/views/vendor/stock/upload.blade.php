    ...
    <div class="gs-vendor-outlet">
        ...
        <div class="gs-vendor-breadcrumb has-mb">
            <div class="d-flex gap-4 flex-wrap align-items-center custom-gap-sm-2">
                ...
                <a href="{{ route('vendor-stock-management') }}" class="template-btn md-btn black-btn">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-info">
                            ...
                            <ul class="mb-0">
                                ...
                                <li>يمكنك <a href="{{ route('vendor-stock-template') }}" class="alert-link">تحميل ملف نموذجي</a> للمساعدة</li>
                            </ul>
                        </div>

                        <!-- Upload Form -->
                        <form action="{{ route('vendor-stock-upload') }}" method="POST" enctype="multipart/form-data" id="uploadForm">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <a href="{{ route('vendor-stock-management') }}" class="btn btn-secondary">إلغاء</a>
