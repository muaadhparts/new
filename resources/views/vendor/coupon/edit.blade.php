    ...
    <div class="gs-vendor-outlet">
        ...
        <div class="vendor-edit-profile-section-wrapper">
            <div class="gs-edit-profile-section">
                <form class="edit-profile-area" id="couponForm" action="{{ route('vendor-coupon-update', $data->id) }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select id="coupon_type" class="form-control" name="coupon_type" required>
                                    ...
                                    <option value="category" {{ $data->coupon_type == 'category' ? 'selected' : '' }}>@lang('Category')</option>
                                    <option value="sub_category" {{ $data->coupon_type == 'sub_category' ? 'selected' : '' }}>@lang('Sub Category')</option>
                                    <option value="child_category" {{ $data->coupon_type == 'child_category' ? 'selected' : '' }}>@lang('Child Category')</option>
                                </select>
                            </div>
                        </div>

                        <div class="col-lg-6 {{ $data->coupon_type == 'category' ? '' : 'd-none' }}" id="categoryDiv">
                            <div class="form-group">
                        ...
                        <div class="col-lg-6 {{ $data->coupon_type == 'sub_category' ? '' : 'd-none' }}" id="subCategoryDiv">
                            <div class="form-group">
                        ...
                        <div class="col-lg-6 {{ $data->coupon_type == 'child_category' ? '' : 'd-none' }}" id="childCategoryDiv">
                            <div class="form-group">
                        ...
                        <div class="col-12">
                            <button class="template-btn btn-forms" type="submit">
                                <i class="fas fa-save"></i> @lang('Update Coupon')
                            </button>
                        </div>
                    </div>
                </form>
