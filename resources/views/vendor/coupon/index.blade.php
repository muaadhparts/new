    ...
    <div class="gs-vendor-outlet">
        ...
        <div class="gs-vendor-breadcrumb has-mb">
            <div class="d-flex gap-4 custom-gap-sm-2 flex-wrap align-items-center">
                ...
                <a href="{{ route('vendor-coupon-create') }}" class="template-btn mb-3 md-btn black-btn data-table-btn"
                    type="button">
                    ...
                    <table class="gs-data-table w-100" id="coupon-table">
                        ...
                        <tbody>
                            @forelse ($datas as $data)
                                <tr>
                                    <td>
                                        <span class="content coupon-code">{{ $data->code }}</span>
                                    </td>
                                    <td>
                                        <span class="content">
                                            @if($data->type == 0)
                                    ...
                                    <td>
                                        <div class="table-icon-btns-wrapper">
                                            ...
                                            <a href="javascript:;"
                                                data-href="{{ route('vendor-coupon-delete', $data->id) }}"
