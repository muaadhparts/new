    ...
    <div class="gs-vendor-outlet">
        ...
        <div class="gs-vendor-breadcrumb has-mb">
            <div class="d-flex gap-4 custom-gap-sm-2 flex-wrap align-items-center">
                ...
                <a href="{{ route('vendor-package-create') }}" class="template-btn md-btn black-btn data-table-btn"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-icon-btns-wrapper">
                                            <a href="{{ route('vendor-package-edit', $data->id) }}"
                                            ...
                                            <a href="javascript:;"
                                                data-href="{{ route('vendor-package-delete', $data->id) }}"
