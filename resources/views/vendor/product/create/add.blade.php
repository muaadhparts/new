...
<div class="gs-vendor-outlet">
    ...
    <div class="gs-vendor-breadcrumb has-mb">
        ...
        <ul class="breadcrumb-menu">
            <li>
                <a href="{{ route('vendor.dashboard') }}">@lang('Dashboard')</a>
            </li>
            <li>
                <a href="{{ route('vendor-prod-index') }}">@lang('Products')</a>
            </li>
            <li>
    ...
    <div id="product_form_section" style="display: none;">
        <form id="addProductForm" action="{{ route('vendor-prod-store-offer') }}" method="POST">
            @csrf
