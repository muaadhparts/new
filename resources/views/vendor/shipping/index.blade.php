...
@section('content')
    ...
    <div class="gs-vendor-outlet">
        ...
        <div class="gs-vendor-breadcrumb has-mb">
            <div class="d-flex gap-4 custom-gap-sm-2 flex-wrap">
                <h4 class="text-capitalize">@lang('Shipping Methods')</h4>

                <a href="{{ route('vendor-shipping-create') }}" class="template-btn mb-3 md-btn black-btn data-table-btn"
                    type="button">+@lang('Add New Shipping')</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-icon-btns-wrapper">
                                            <a href="{{ route('vendor-shipping-edit', $data->id) }}"
                                            ...
                                            <a href="javascript:;"
                                                data-href="{{ route('vendor-shipping-delete', $data->id) }}"
