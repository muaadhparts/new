    ...
    <div class="gs-vendor-outlet">
        ...
        <div class="gs-vendor-breadcrumb has-mb">
            <div class="d-flex gap-4 flex-wrap">
                <a class="back-btn" href="{{route("vendor-shipping-index")}}">
                    <i class="fa-solid fa-arrow-left"></i>
                </a>
                <h4 class="text-capitalize">@lang('Add Shipping')
                </h4>
            </div>
            <ul class="breadcrumb-menu">
                ...
                <li>
                    <a href="javascript:;" class="text-capitalize">@lang('Create Shipping')  </a>
                </li>
            </ul>
        </div>
        <!-- breadcrumb end -->
        ...
        <div class="vendor-edit-profile-section-wrapper">
            <div class="gs-edit-profile-section">
                ...
                <form class="edit-profile-area" action="{{route('vendor-shipping-create')}}" method="POST">
                    @csrf
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="provider" id="provider" class="form-control">
                                <option value="manual" selected>@lang('Manual')</option>
                                <option value="tryoto">@lang('Tryoto')</option>
                            </select>
                            @error('provider')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="any" id="free_above" class="form-control"
                                placeholder="@lang('Free shipping if cart total above this amount')" value="0"
                                name="free_above">
