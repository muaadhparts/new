...
<div class="gs-vendor-outlet">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('vendor.shipments.index') }}" method="GET" class="row g-3 align-items-end">
                <div class="col-md-3">
                ...
                <div class="col-md-2">
                    <a href="{{ route('vendor.shipments.export', request()->all()) }}" class="btn btn-outline-success w-100">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        @forelse($shipments as $shipment)
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('vendor.shipments.show', $shipment->tracking_number) }}"
                                ...
                                <td>
                                    @if($shipment->order)
                                        <a href="{{ route('vendor-order-show', $shipment->order->order_number) }}">
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <a href="{{ route('vendor.shipments.refresh', $shipment->tracking_number) }}"
