...
<div class="gs-vendor-outlet">
    ...
    <div class="gs-vendor-breadcrumb has-mb">
        <div class="gs-deposit-title d-flex align-items-center gap-4">
            <a href="{{ route('vendor.shipments.index') }}" class="btn btn-outline-secondary btn-sm">
        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('vendor.shipments.refresh', $shipment->tracking_number) }}" class="btn btn-sm btn-outline-info">
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <table class="table table-sm table-borderless mb-0">
                        <tr>
                            ...
                            <td class="text-end fw-bold">
                                <a href="{{ route('vendor-order-show', $order->order_number) }}">
                                    {{ $order->order_number }}
                                </a>
                            </td>
                        </tr>
                    ...
                    <hr>
                    <a href="{{ route('vendor-order-show', $order->order_number) }}" class="btn btn-outline-primary btn-sm w-100">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="{{ route('vendor.shipments.refresh', $shipment->tracking_number) }}" class="btn btn-info">
...
<div class="modal fade" id="cancelModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('vendor.shipments.cancel', $shipment->tracking_number) }}" method="POST">
                @csrf
