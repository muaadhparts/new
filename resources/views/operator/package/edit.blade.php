                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="catalogItem-description">
                      ...
                      <form id="muaadhformdata" action="{{route('operator-package-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="form-control" name="subtitle" placeholder="{{ __('Subtitle') }}" required="" value="{{ $data->subtitle }}">
                          </div>
                        </div>
