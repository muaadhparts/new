            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('operator-package-index') }}">{{ __('Packagings') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        (function($) {
            ...
            $(function() {
                $(".btn-area").append('<div class="col-sm-4 table-contents">' +
                    '<a class="add-btn" data-href="{{ route('operator-package-create') }}" id="add-data" data-bs-toggle="modal" data-bs-target="#modal1">' +
