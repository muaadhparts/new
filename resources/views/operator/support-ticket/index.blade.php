...
(function($) {
    ...
    var table = $('#muaadhtable').DataTable({
         ordering: false,
               processing: true,
               serverSide: true,
               ajax: '{{ route('operator-support-ticket-datatables','Ticket') }}',
               columns: [
                  { data: 'name', name: 'name' },
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          '<a class="add-btn" href="javascript:;" data-bs-toggle="modal" data-bs-target="#merchantform"><i class="fas fa-envelope"></i> {{ __('Add Ticket') }}</a>'+'</div>');
      });                       
