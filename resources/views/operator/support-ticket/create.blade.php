        ...
        <div class="col-lg-12">
            ...
            <h4 class="heading">{{ __('Conversation with') }} {{$conv->user->name}} <a class="add-btn" href="{{ url()->previous() }}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                <ul class="links">
                    ...
                    <li>
                        <a href="{{ route('operator-support-ticket-index') }}">{{ __('Support Tickets') }}</a>
                    </li>
                    <li>
...
<div class="purchase-table-wrap support-ticket-wrapper ">
                        ...
                        @include('alerts.operator.form-both')  
                            <div class="panel-body" id="chat_entries">
                                ...
                                <div class="single-reply-area user">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            @endif
                                                    <a target="_blank" class="d-block profile-btn" href="{{ route('operator-user-show',$message->chatThread->user->id) }}" class="d-block">{{ __('View Profile') }}</a>
                            ...
                            <div class="panel-footer">
                                <form id="messageform" action="{{route('operator-support-ticket-store')}}" data-href="{{ route('operator-support-ticket-load',$conv->id) }}" method="POST">
                                    {{csrf_field()}}
