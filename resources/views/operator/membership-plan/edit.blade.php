      ...
      <div class="col-lg-12">
        <div class="catalogItem-description">
          <div class="body-area">
            ...
            <form id="muaadhformdata" action="{{route('operator-membership-plan-update',$data->id)}}" method="POST" enctype="multipart/form-data">
              {{csrf_field()}}
              <div class="row">
                <div class="col-lg-4">
                ...
                <div class="col-lg-7">
                  <input type="text" class="form-control" name="title" placeholder="{{ __("Enter Plan Title") }}" required="" value="{{ $data->title }}">
                </div>
              </div>
              <div class="row">
                <div class="col-lg-4">
                ...
                <div class="col-lg-7">
                  <input type="text" class="form-control" name="price" placeholder="{{ __("Enter Plan Cost") }}" required="" value="{{ $data->price * $sign->value }}">
                </div>
              </div>
              <div class="row">
                <div class="col-lg-4">
                ...
                <div class="col-lg-7">
                  <input type="text" class="form-control" name="days" placeholder="{{ __("Enter Plan Days") }}" required="" value="{{ $data->days }}">
                </div>
              </div>
              <div class="row">
                <div class="col-lg-4">
