...
@section('content')
            ...
            <div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('Add New Post') }} <a class="add-btn" href="{{route('operator-publication-index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="{{ route('operator-publication-create') }}">{{ __('Add New Post') }}</a>
                        </li>
                      </ul>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="catalogItem-description">
                      ...
                      <form id="muaadhform" action="{{route('operator-publication-create')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
