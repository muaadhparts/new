        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="links">
                    ...
                    <li>
                        <a href="{{ route('operator-brand-index') }}">{{ __('Brands') }}</a>
                    </li>
                </ul>
            </div>
        </div>
...
@include('components.operator.modal-delete', ['message' => __('You are about to delete this Brand.')])
...
(function($) {
    ...
    var table = $('#muaadhtable').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{{ route('operator-brand-datatables') }}',
        columns: [
    ...
    $(function() {
        $(".btn-area").append('<div class="col-sm-4 table-contents">' +
            '<a class="add-btn" data-href="{{ route('operator-brand-create') }}" id="add-data" data-bs-toggle="modal" data-bs-target="#modal1">' +
