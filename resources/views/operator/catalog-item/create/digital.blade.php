...
@section('content')
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading">{{ __("Digital CatalogItem") }} <a class="add-btn" href="{{ route('operator-catalog-item-types') }}"><i class="fas fa-arrow-left"></i> {{ __("Back") }}</a></h4>
											<ul class="links">
												<li>
											...
											<li>
												...
												<li>
													<a href="{{ route('operator-catalog-item-create','digital') }}">{{ __("Digital CatalogItem") }}</a>
												</li>
											</ul>
									</div>
								</div>
