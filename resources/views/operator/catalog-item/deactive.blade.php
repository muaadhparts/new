...
@section('content')  
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __("Deactivated Catalog Items") }}</h4>
										<ul class="links">
											<li>
											...
											<li>
												<a href="{{ route('operator-catalog-item-deactive') }}">{{ __("Deactivated Catalog Items") }}</a>
											</li>
										</ul>
								</div>
							</div>
...
(function($) {
		...
		var table = $('#muaadhtable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('operator-catalog-item-datatables') }}?type=deactive',
               columns: [
