...
<div class="content-area">
    ...
    <div class="card">
        <div class="card-header bg-warning text-dark d-flex justify-content-between align-items-center">
            <strong><i class="fas fa-truck me-2"></i>{{ __('Shipping Companies') }}</strong>
        </div>
