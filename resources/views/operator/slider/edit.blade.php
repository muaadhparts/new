...
@section('content')
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Edit Slider') }} <a class="add-btn" href="{{ route('operator-sl-index') }}"><i
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('operator-sl-index') }}">{{ __('Sliders') }}</a>
                        </li>
                        <li>
                            <a href="{{ route('operator-sl-edit', $data->id) }}">{{ __('Edit') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="catalogItem-description">
                        <div class="body-area">
                            ...
                            <form id="muaadhform" action="{{ route('operator-sl-update', $data->id) }}" method="POST"
