...
@section('content')
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Add Slider') }} <a class="add-btn" href="{{ route('operator-sl-index') }}"><i
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('operator-sl-create') }}">{{ __('Add Slider') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="catalogItem-description">
                        <div class="body-area">
                            ...
                            <form id="muaadhform" action="{{ route('operator-sl-create') }}" method="POST"
