            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('operator-abuse-flag-index') }}">{{ __('Reports') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="heading-area">
                        ...
                        <div class="action-list">
                            <select
                                ...
                                <option data-val="1" value="{{ route('operator-gs-status', ['is_report', 1]) }}"
                                    {{ $gs->is_report == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                <option data-val="0" value="{{ route('operator-gs-status', ['is_report', 0]) }}"
    ...
    <script type="text/javascript">
        (function($) {
            ...
            var table = $('#muaadhtable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ route('operator-abuse-flag-datatables') }}',
                columns: [
