              ...
              <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                      ...
                      <li>
                        <a href="{{ route('operator-gs-load') }}">{{ __('Website Loader') }}</a>
                      </li>
                    </ul>
                </div>
              </div>
                                ...
                                {{ __('Loader') }} :
                                      ...
                                      <div class="action-list">
                                          <select class="process select droplinks {{ $gs->is_loader == 1 ? 'drop-success' : 'drop-danger' }}">
                                            <option data-val="1" value="{{route('operator-gs-status',['is_loader',1])}}" {{ $gs->is_loader == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                            <option data-val="0" value="{{route('operator-gs-status',['is_loader',0])}}" {{ $gs->is_loader == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                          </select>
                                        </div>
                          </div>
                                ...
                                {{ __('Loader') }} :
                                      ...
                                      <div class="action-list">
                                          <select class="process select droplinks {{ $gs->is_admin_loader == 1 ? 'drop-success' : 'drop-danger' }}">
                                            <option data-val="1" value="{{route('operator-gs-status',['is_admin_loader',1])}}" {{ $gs->is_admin_loader == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                            <option data-val="0" value="{{route('operator-gs-status',['is_admin_loader',0])}}" {{ $gs->is_admin_loader == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                          </select>
                                        </div>
                          </div>
