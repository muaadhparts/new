...
(function($) {
		...
		var table = $('#muaadhtable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('operator-sb-datatables','BottomSmall') }}',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="{{route('operator-sb-create-bottom')}}" id="add-data" data-bs-toggle="modal" data-bs-target="#modal1">'+
