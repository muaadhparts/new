        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="links">
                    ...
                    <li>
                        <a href="{{ route('operator-service-index') }}">{{ __('Services') }}</a>
                    </li>
                </ul>
            </div>
        </div>
...
@include('components.operator.modal-delete', ['message' => __('You are about to delete this Service.')])
...
(function($) {
    ...
    var table = $('#muaadhtable').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{{ route('operator-service-datatables') }}',
        columns: [
    ...
    $(function() {
        $(".btn-area").append('<div class="col-sm-4 table-contents">' +
            '<a class="add-btn" data-href="{{ route('operator-service-create') }}" id="add-data" data-bs-toggle="modal" data-bs-target="#modal1">' +
