              ...
              <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                      ...
                      <li>
                        <a href="{{ route('operator-shipping-index') }}">{{ __('Shipping Methods') }}</a>
                      </li>
                    </ul>
                </div>
              </div>
...
(function($) {
    ...
    var table = $('#muaadhtable').DataTable({
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          '<a class="add-btn" data-href="{{route('operator-shipping-create')}}" id="add-data" data-bs-toggle="modal" data-bs-target="#modal1">'+
