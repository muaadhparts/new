                ...
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <ul class="links">
                      ...
                      <li>
                        <a href="{{ route('operator-mail-config') }}">{{ __('Email Configuration') }}</a>
                      </li>
                    </ul>
                  </div>
                </div>
                  ...
                  <div class="col-lg-12">
                    <div class="catalogItem-description">
                      <div class="body-area">
                        ...
                        <form action="{{ route('operator-gs-update-mail') }}" id="muaadhform" method="POST" enctype="multipart/form-data">
                          @csrf
