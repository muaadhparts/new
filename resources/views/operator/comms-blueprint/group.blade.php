              ...
              <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                      ...
                      <li>
                        <a href="{{ route('operator-group-show') }}">{{ __('Group Email') }}</a>
                      </li>
                    </ul>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="catalogItem-description">
                      ...
                      <form id="muaadhform" action="{{route('operator-group-submit')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <select name="type" required="">
                                ...
                                <option value="1">{{ __('Merchants') }}</option>
                              </select>
                          </div>
                        </div>
