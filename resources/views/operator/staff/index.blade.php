							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="{{ route('operator-staff-index') }}">{{ __('Manage Staffs') }}</a>
											</li>
										</ul>
								</div>
							</div>
...
(function($) {
		...
		var table = $('#muaadhtable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('operator-staff-datatables') }}',
               columns: [
                        { data: 'name', name: 'name' },
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="{{route('operator-staff-create')}}" id="add-data" data-bs-toggle="modal" data-bs-target="#modal1">'+
