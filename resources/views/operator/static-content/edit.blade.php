                ...
                <div class="row">
                  <div class="col-lg-12">
                      ...
                      <ul class="links">
                        ...
                        <li>
                          <a href="{{ route('operator-static-content-index') }}">{{ __('Pages') }}</a>
                        </li>
                        <li>
                          <a href="{{ route('operator-static-content-edit',$data->id) }}">{{ __('Edit') }}</a>
                        </li>
                      </ul>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="catalogItem-description">
                      ...
                      <form id="muaadhform" action="{{route('operator-static-content-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="form-control" name="slug" placeholder="{{ __('Slug') }}" value="{{$data->slug}}" required="">
                          </div>
                        </div>
