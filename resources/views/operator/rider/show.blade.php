        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="links">
                    ...
                    <li>
                        <a href="{{ route('operator-rider-show',$data->id) }}">{{ __("Details") }}</a>
                    </li>
                </ul>
            </div>
        </div>
                                ...
                                <div class="table-responsive">
                                    <table id="example2" class="table table-hover dt-responsive" cellspacing="0"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><a href="{{ route('operator-purchase-invoice',$deliveryRider->purchase->id) }}">{{sprintf("%'.08d",
                                                ...
                                                <td>
                                                    <a href=" {{ route('operator-purchase-show',$deliveryRider->purchase->id) }}"
                                                        class="view-details">
