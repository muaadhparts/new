...
@section('styles')
	...
	<link href="{{asset('assets/operator/css/select2.css')}}" rel="stylesheet"/>
@endsection
...
<div class="content-area">
	<div class="mr-breadcrumb">
		<div class="row">
			<div class="col-lg-12">
					<h4 class="heading">{{ __("Affiliate CatalogItem") }} <a class="add-btn" href="{{ route('operator-catalog-item-index') }}"><i class="fas fa-arrow-left"></i> {{ __("Back") }}</a></h4>
					<ul class="links">
						<li>
					...
					<li>
						...
						<li>
							<a href="{{ route('operator-import-create') }}">{{ __("Add Affiliate CatalogItem") }}</a>
						</li>
					</ul>
			</div>
		</div>
	...
	<form id="muaadhform" action="{{route('operator-import-store')}}" method="POST" enctype="multipart/form-data">
	  {{csrf_field()}}
						...
						<div class="catalogItem-description">
							<div class="body-area">
								...
								<div class="row">
									...
									<div class="col-lg-12">
										<input type="text" class="form-control" placeholder="{{ __("Enter CatalogItem Link") }}" name="affiliate_link" required="">
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-lg-12">
										<ul class="list">
											<li>
												<input class="checkclick1" name="item_condition_check" type="checkbox" id="conditionCheck" value="1">
