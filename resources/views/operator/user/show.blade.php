                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                        ...
                                        <ul class="links">
                                            ...
                                            <li>
                                                <a href="{{ route('operator-user-show',$data->id) }}">{{ __("Details") }}</a>
                                            </li>
                                        </ul>
                                </div>
                            </div>
                                                        ...
                                                        <div class="table-responsive">
                                                                <table id="example2" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
            <td><a href="{{ route('operator-purchase-invoice',$purchase->id) }}">{{sprintf("%'.08d", $purchase->id)}}</a></td>
                                                                            ...
                                                                            <td>
                                                                                <a href=" {{ route('operator-purchase-show',$purchase->id) }}" class="view-details">
