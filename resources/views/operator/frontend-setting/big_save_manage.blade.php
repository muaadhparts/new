...
$(document).ready(function() {
    ...
    $('#catalogItemSearch').on('keyup', function() {
        ...
        searchTimeout = setTimeout(function() {
            ...
            $.get('{{ route("admin-fs-big-save-search") }}', { q: query }, function(data) {
    ...
    $(document).on('click', '.select-catalogItem', function() {
        ...
        $.get('{{ route("admin-fs-big-save-merchants") }}', { catalog_item_id: selectedCatalogItemId }, function(merchants) {
    ...
    $(document).on('click', '.add-item', function() {
        ...
        $.ajax({ url: '{{ route("admin-fs-big-save-toggle") }}', type: 'POST', data: { _token: '{{ csrf_token() }}', merchant_item_id: btn.data('id'), flag: 1 },
    ...
    $(document).on('click', '.remove-item', function() {
        ...
        btn.prop('disabled', true).html('<i class="fas fa-spinner fa-spin"></i>');
        $.ajax({ url: '{{ route("admin-fs-big-save-toggle") }}', type: 'POST', data: { _token: '{{ csrf_token() }}', merchant_item_id: btn.data('id'), flag: 0 },
