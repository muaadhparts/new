                ...
                <div class="row">
                  <div class="col-lg-12">
                      ...
                      <ul class="links">
                        ...
                        <li>
                          <a href="{{ route('operator-fs-best-seller') }}">{{ __('Left Side Banner2') }} </a>
                        </li>
                      </ul>
                  </div>
                </div>
                    ...
                    <div class="catalogItem-description">
                      ...
                      <form id="muaadhform" action="{{ route('operator-fs-update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="form-control" name="big_save_banner_link" placeholder="{{ __('Link') }}" required="" value="{{$data->big_save_banner_link}}">
                          </div>
                        </div>
