        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="links">
                    ...
                    <li><a href="{{ route('operator-fs-featured') }}">{{ __('Featured CatalogItems') }}</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-name">{{ __('Add CatalogItem to Featured') }}</h5>
...
$(document).ready(function() {
    ...
    $('#catalogItemSearch').on('keyup', function() {
        ...
        searchTimeout = setTimeout(function() {
            ...
            $.get('{{ route("operator-fs-featured-search") }}', { q: query }, function(data) {
    ...
    $(document).on('click', '.select-catalogItem', function() {
        ...
        $.get('{{ route("operator-fs-featured-merchants") }}', { catalog_item_id: selectedCatalogItemId }, function(merchants) {
    ...
    $(document).on('click', '.add-item', function() {
        ...
        $.ajax({ url: '{{ route("operator-fs-featured-toggle") }}', type: 'POST', data: { _token: '{{ csrf_token() }}', merchant_item_id: btn.data('id'), flag: 1 },
    ...
    $(document).on('click', '.remove-item', function() {
        ...
        btn.prop('disabled', true).html('<i class="fas fa-spinner fa-spin"></i>');
        $.ajax({ url: '{{ route("operator-fs-featured-toggle") }}', type: 'POST', data: { _token: '{{ csrf_token() }}', merchant_item_id: btn.data('id'), flag: 0 },
