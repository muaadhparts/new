							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="{{ route('operator.fonts.index') }}">{{ __('Website Fonts') }}</a>
											</li>
										</ul>
								</div>
							</div>
...
(function($) {
		...
		var table = $('#muaadhtable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('operator.fonts.datatables') }}',
                columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="{{route('operator.fonts.create')}}" id="add-data" data-bs-toggle="modal" data-bs-target="#modal1">'+
