...
@section('content')
						...
						<div class="content-area">
							...
							<div class="mr-breadcrumb">
								<div class="row">
								  <div class="col-lg-12">
									  <h4 class="heading">{{ __('Edit Link') }} <a class="add-btn" href="{{route('operator-network-presence-index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
									  <ul class="links">
										<li>
										...
										<li>
										  <a href="{{ route('operator-network-presence-edit',$data->id) }}">{{ __('Edit') }}</a>
										</li>
									  </ul>
								  </div>
								</div>
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="catalogItem-description">
											...
											<form id="muaadhform" action="{{route('operator-network-presence-update',$data->id)}}" method="POST" enctype="multipart/form-data">
												{{csrf_field()}}
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
