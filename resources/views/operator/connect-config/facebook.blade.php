                ...
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <ul class="links">
                      ...
                      <li>
                        <a href="{{ route('operator-connect-config-facebook') }}">{{ __('Facebook Login') }}</a>
                      </li>
                    </ul>
                  </div>
                </div>
                  ...
                  <div class="col-lg-12">
                    <div class="catalogItem-description">
                      <div class="body-area">
                        ...
                        <form action="{{ route('operator-connect-config-update') }}" id="muaadhform" method="POST" enctype="multipart/form-data">
                          @csrf
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                    <select class="process select droplinks {{ $data->f_check == 1 ? 'drop-success' : 'drop-danger' }}">
                                      <option data-val="1" value="{{route('operator-connect-config-facebookup',1)}}" {{ $data->f_check == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                      <option data-val="0" value="{{route('operator-connect-config-facebookup',0)}}" {{ $data->f_check == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                    </select>
                                  </div>
                            </div>
                          </div>
