...
<div class="content-area">
              ...
              <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                      ...
                      <li>
                        <a href="{{ route('operator-connect-config-index') }}">{{ __('Social Links') }}</a>
                      </li>
                    </ul>
                </div>
              </div>
            ...
            <div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
              <form id="muaadhform" class="form-horizontal" action="{{ route('operator-connect-config-update-all') }}" method="POST">   
              @csrf
