                ...
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <ul class="links">
                      ...
                      <li>
                        <a href="{{ route('operator-connect-config-google') }}">{{ __('Google Login') }}</a>
                      </li>
                    </ul>
                  </div>
                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                    <select class="process select droplinks {{ $data->g_check == 1 ? 'drop-success' : 'drop-danger' }}">
                                      <option data-val="1" value="{{route('operator-connect-config-googleup',1)}}" {{ $data->g_check == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                      <option data-val="0" value="{{route('operator-connect-config-googleup',0)}}" {{ $data->g_check == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                    </select>
                                  </div>
                            </div>
                          </div>
