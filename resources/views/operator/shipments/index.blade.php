...
<div class="content-area">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('operator.shipments.index') }}" method="GET" class="row align-items-end">
                <div class="col-md-2">
                ...
                <div class="col-md-2 d-flex gap-2">
                    ...
                    <a href="{{ route('operator.shipments.export', request()->all()) }}" class="btn btn-outline-success">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($shipment->purchase)
                                                <a href="{{ route('operator-purchase-show', $shipment->purchase->id) }}">
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('operator.shipments.reports') }}" class="btn btn-info">
