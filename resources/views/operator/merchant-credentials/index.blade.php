                                                ...
                                                <td>
                                                    <div class="btn-group btn-group-sm">
                                                        ...
                                                        <button type="button" class="btn btn-secondary btn-test-credential"
                                                                data-url="{{ route('operator.merchant-credentials.test', $credential->id) }}"
...
$(document).ready(function() {
    ...
    $('.btn-test-credential').on('click', function() {
        ...
        resultDiv.html('<div class="alert alert-info py-2 mb-0"><i class="fas fa-spinner fa-spin me-2"></i>{{ __("Testing API...") }}</div>').show();
