        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="links">
                    ...
                    <li>
                        <a href="{{ route('operator-activation-form') }}">{{ __('Activation') }}</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body text-center py-5">
                    @if($activeLicense)
                        ...
                        <div class="mt-4">
                            <a href="{{ route('operator-license-index') }}" class="btn btn-primary">
                    ...
                    @else
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-8">
                                ...
                                <form id="muaadhform" action="{{ route('operator-activate-purchase') }}" method="POST">
                                    @csrf
                        ...
                        <p class="text-muted">
                            ...
                            <a href="{{ route('operator-license-index') }}" class="text-primary">{{ __('Create one here') }}</a>
                        </p>
                    @endif
                </div>
            </div>
