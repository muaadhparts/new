							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="{{ route('operator-article-type-index') }}">{{ __('Categories') }}</a>
											</li>
										</ul>
								</div>
							</div>
...
(function($) {
		...
		var table = $('#muaadhtable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('operator-article-type-datatables') }}',
               columns: [
                        { data: 'name', name: 'name' },
                        { data: 'slug', name: 'slug' },
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="{{route('operator-article-type-create')}}" id="add-data" data-bs-toggle="modal" data-bs-target="#modal1">'+
