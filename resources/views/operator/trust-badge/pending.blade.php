...
@section('content')
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __("Pending Trust Badges") }}</h4>
										<ul class="links">
											<li>
											...
											<li>
												<a href="{{ route('operator-trust-badge-index','pending') }}">{{ __("Pending Trust Badges") }}</a>
											</li>
										</ul>
								</div>
							</div>
    ...
    <script type="text/javascript">
		...
		(function($) {
			...
			var table = $('#muaadhtable').DataTable({
				...
				processing: true,
				serverSide: true,
				ajax: '{{ route('operator-trust-badge-datatables','Pending') }}',
				columns: [
						{ data: 'name', name: 'name' },
