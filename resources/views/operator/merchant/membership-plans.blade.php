...
@section('content')
                    ...
                    <div class="content-area">
                        <div class="mr-breadcrumb">
                            <div class="row">
                                <div class="col-lg-12">
                                        <h4 class="heading">{{ __("Completed Merchant Membership Plans") }}</h4>
                                        <ul class="links">
                                            <li>
                                            ...
                                            <li>
                                                <a href="{{ route('operator-merchant-membership-plans','completed') }}">{{ __("Completed Merchant Membership Plans") }}</a>
                                            </li>
                                        </ul>
                                </div>
                            </div>
...
(function($) {
        ...
        var table = $('#muaadhtable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('operator-merchant-membership-plan-datatables','1') }}',
               columns: [
