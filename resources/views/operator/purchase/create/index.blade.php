   ...
   <div class="row">
      <div class="col-lg-12">
         ...
         <ul class="links">
            ...
            <li>
               <a href="{{ route('operator-purchase-create') }}">{{ __('Create A Purchase') }}</a>
            </li>
         </ul>
      </div>
   </div>
...
<div class="add-catalogItem-content1 add-catalogItem-content2">
    <div class="row">
      <div class="col-lg-12">
        <div class="catalogItem-description">
          <form action="{{route('operator.purchase.create.view')}}" method="POST">
            @csrf
  ...
  @include('operator.purchase.create.adds-catalogItem')
