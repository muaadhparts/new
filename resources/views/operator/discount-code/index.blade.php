...
@include('components.operator.modal-delete', ['message' => __('You are about to delete this Discount Code.')])
...
(function($) {
    ...
    var table = $('#muaadhtable').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{{ route('operator-discount-code-datatables') }}',
        columns: [
            { data: 'code', name: 'code' },
            { data: 'type', name: 'type' },
    ...
    $(function() {
        $(".btn-area").append('<div class="col-sm-4 table-contents">' +
            '<a class="add-btn" href="{{ route('operator-discount-code-create') }}">' +
