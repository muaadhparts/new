                                ...
                                <tr class="">
                                    <td class="cart-product-area">
                                        <div class="cart-product d-flex">
                                            <img src="{{ $photo ? \Illuminate\Support\Facades\Storage::url($photo) : asset('assets/images/noimage.png') }}"
                                                 alt="">
                                            <div class="cart-product-info">
                                                ...
                                                @if (!empty($sku))
                                                    <p class="text-muted small mb-1">
                                                        ...
                                                        <a href="{{ $productUrl }}" class="text-primary text-decoration-none">
                                                            {{ $sku }}
                                                        </a>
                                                    </p>
                                                @endif
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    @if (!empty($product['color']))
                                                        @lang('Color') :
                                                        <p class="cart-color d-inline-block rounded-2"
