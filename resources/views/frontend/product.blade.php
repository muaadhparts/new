                ...
                <div class="col-lg-6 wow-replaced" data-wow-delay=".2s">
                    ...
                    <form>
                        ...
                        <div class="product-info-wrapper {{ $productt->type != 'Physical' ? 'mb-2 mb-md-3' : '' }}">
                            ...
                            {{-- السعر: Vendor-aware --}}
                            @php
                                // vendorId القادم من الكنترولر ProductDetailsController
                                ...
                                // نسبة الخصم من عرض البائع إن وُجد وإلا من المنتج
                                $offPercent = null;
                            ...
                            <div class="price-wrapper">
                                <h5 id="sizeprice">{{ $currentPrice }}</h5>
                                <h5><del>{{ $previousPrice }}</del></h5>
                            ...
                            <div class="rating-wrapper">
                                ...
                                <span class="rating">
                                    {{ number_format($productt->ratings_avg_rating, 1) }}
                                ...
                                <ul>
                                    <li>
                                        @if ($productt->type == 'Physical')
                                            ...
                                            @else
                                                {{ ($gs->show_stock == 0 ? '' : $mpStock) }} {{ __('In Stock') }}
                                            @endif
                                        @endif
                                    </li>
                            ...
                            <div class="action-btns-wrapper">
                                @if ($productt->user_id != 0)
                                    <a class="template-btn dark-outline"
                                       href="{{ route('front.vendor', str_replace(' ', '-', $productt->user->shop_name)) }}">
                                        @lang('visit store')
                                    </a>
                                @endif
