            ...
            <div class="col-lg-2">
                <a href="#">
                    <div class="gs-single-cat">
                        <img class="cate-img square" src="{{ asset('assets/images/categories/' . $fcategory->image) }}"
                            alt="category img">
...
<section class="gs-offer-section">
    <div class="container">
        ...
        <div class="row mb-60 justify-content-center">
            ...
            <div class="col-lg-6">
                <div class="gs-title-box ">
                    <p class="des  mb-0 wow-replaced" data-wow-delay=".1s">@lang('Erat pellentesque curabitur euismod
                        dui etiam pellentesque rhoncus fermentum tristique lobortis lectus magnis. Consequat porta
                        turpis maecenas')</p>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-4 wow-replaced" data-wow-delay=".2s">
                <a href="{{ $arrivals[0]['url'] }}" class="">
                    <img class="w-100 h-100 object-fit-cover"
                        src="{{ asset('assets/images/arrival/' . $arrivals[0]['photo']) }}" alt="offer product">
                </a>
            </div>
            <div class="col-md-6 col-lg-4 wow-replaced" data-wow-delay=".2s">
                <a href="{{ $arrivals[1]['url'] }}" class="">
                    <img class="w-100 h-100 object-fit-cover"
                        src="{{ asset('assets/images/arrival/' . $arrivals[1]['photo']) }}" alt="offer product">
                </a>
            </div>
            <div class="col-md-6 col-lg-4 wow-replaced" data-wow-delay=".2s">
                <a href="{{ $arrivals[2]['url'] }}" class="">
                    <img class="w-100 h-100 object-fit-cover"
                        src="{{ asset('assets/images/arrival/' . $arrivals[2]['photo']) }}" alt="offer product">
                </a>
            </div>
            ...
            <div class="col-lg-6 posts-area wow-replaced" data-wow-delay=".2s">
                <a href="{{ route('front.blogshow', $blog->slug) }}" class="single-post h2-single-post">
                    ...
                    <div class="post-content home-2">
                        <h5 class="post-title">
                            {{ mb_strlen($blog->title, 'UTF-8') > 200 ? mb_substr($blog->title, 0, 200, 'UTF-8') . '...'
                            : $blog->title }}
                        </h5>
