                    ...
                    <form>
                        ...
                        <div class="catalogItem-info-wrapper">
                            ...
                            <div class="price-wrapper">
                                @if($merchant)
                                    <h5 id="sizeprice">{{ method_exists($merchant, 'showPrice') ? $merchant->showPrice() : \App\Models\CatalogItem::convertPrice($merchant->price) }}</h5>
                                    @if($merchant->previous_price > 0)
                                        <h5><del>{{ \App\Models\CatalogItem::convertPrice($merchant->previous_price) }}</del></h5>
                                    @endif
                                    @php
                        ...
                        <div class="store-seller-wrapper">
                            ...
                            <div class="action-btns-wrapper">
                                ...
                                <a class="m-btn m-btn--ghost"
                                    href="{{ route('front.merchant', str_replace(' ', '-', $merchant->user->shop_name)) }}">@lang('visit store')</a>
