                ...
                <div class="col-12 col-lg-8 gs-main-blog-wrapper wow-replaced" data-wow-delay=".1s">
                    <div class="gs-blog-details-wrapper">
                        <div class="gs-blog-card">
                            <img class="fea-img img-fluid" src="{{ asset('assets/images/publications/' . $publication->photo) }}"
                            ...
                            <div class="meta-info-wrapper">
                                ...
                                <div class="single-meta">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25"
                                        viewBox="0 0 24 25" fill="none">
                                        <path d="M3.17188 7.93994L12.0019 13.0499L20.7719 7.96994" stroke="currentColor"
                                            stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M12 22.11V13.04" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path
                            ...
                            <ul class="cat-wrapper">
                                @foreach ($bcats as $cat)
                                    <li><a class="{{ isset($bcat) ? ($bcat->id == $cat->id ? 'active' : '') : '' }}"
                                            href="{{ route('front.publicationcategory', $cat->slug) }}">{{ $cat->name }}
                                    ...
                                    @if (!empty($tag))
                                        <li>
                                            <a class="{{ isset($slug) ? ($slug == $tag ? 'active' : '') : '' }}"
                                                href="{{ route('front.publicationtags', $tag) }}">
                                                {{ $tag }}
                                            </a>
                                        </li>
                                    @endif
