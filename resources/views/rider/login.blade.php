    ...
    <section class="gs-breadcrumb-section">
        <div class="container">
            <div class="row justify-content-center content-wrapper">
                <div class="col-12">
                    <h2 class="breadcrumb-title">@lang('Rider Login')</h2>
                    <ul class="bread-menu">
                        <li><a href="{{ route('front.index') }}">@lang('Home')</a></li>
                        <li><a href="#">@lang('Rider Login')</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="reg-content">
                        ...
                        <form action="{{ route('rider.login.submit') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control" value="rider@gmail.com" id="email"
                                ...
                                <div class="row mb-1 mt-2">
                                    ...
                                    <div class="col d-flex justify-content-end login-forgot">
                                        <!-- Simple link -->
                                        <a href="{{ route('rider.forgot') }}">@lang('Forgot password?')</a>
                                    </div>
                                </div>
                                ...
                                <p class="login-redirect">Don't have an account? <span><a
                                            href="{{ route('rider.register') }}">@lang('Create New Account')</a></span></p>
                            </div>
                    </div>
                    </form>
                </div>
