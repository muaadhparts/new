                ...
                <div class="gs-dashboard-user-content-wrapper gs-dashboard-outlet">
                    <div class="gs-edit-profile-section">
                        <div class="ud-page-title-box gap-4">
                            ...
                            <h3 class="ud-page-title">@lang('Add Service Area')</h3>
                        </div>
                        <form id="userform" action="{{ route('courier-service-area-store') }}" method="POST">
                            @csrf
                                        ...
                                        <div class="multi-form-wrapper gap-4">
                                            <div class="single-form-wrapper">
                                                <div class="form-group">
                                                    ...
                                                    <select class="service_area form-control nice-select form__control form-control-sm"
                                            ...
                                            <div class="single-form-wrapper">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="price" class="form-control"
                                                        placeholder="@lang('price')" value="" required name="price">
                                                </div>
                                            </div>
                                            @error('price')
                                                <span class="text-danger">{{ $message }}</span>
