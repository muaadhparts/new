    ...
    <section class="gs-breadcrumb-section">
        <div class="container">
            <div class="row justify-content-center content-wrapper">
                <div class="col-12">
                    <h2 class="breadcrumb-title">@lang('Courier Login')</h2>
                    <ul class="bread-menu">
                        <li><a href="{{ route('front.index') }}">@lang('Home')</a></li>
                        <li><a href="#">@lang('Courier Login')</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="reg-content">
                        ...
                        <form action="{{ route('courier.login.submit') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control" value="courier@gmail.com" id="email"
                                ...
                                <div class="pass-wrapper">
                                    <input type="password" name="password" class="form-control" value="1234" id="create-password"
                                ...
                                <div class="row mb-1 mt-2">
                                    ...
                                    <div class="col d-flex justify-content-end login-forgot">
                                        <!-- Simple link -->
                                        <a href="{{ route('courier.forgot') }}">@lang('Forgot password?')</a>
                                    </div>
                                </div>
                                ...
                                <p class="text-center login-or">Or</p> <br>




                                <p class="login-redirect">Don't have an account? <span><a
                                            href="{{ route('courier.register') }}">@lang('Create New Account')</a></span></p>
                            </div>
                    </div>
                    </form>
                </div>
