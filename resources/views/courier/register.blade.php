    ...
    <section class="gs-breadcrumb-section">
        <div class="container">
            <div class="row justify-content-center content-wrapper">
                <div class="col-12">
                    <h2 class="breadcrumb-title">@lang('Courier Register')</h2>
                    <ul class="bread-menu">
                        <li><a href="{{ route('front.index') }}">@lang('Home')</a></li>
                        <li><a href="#">@lang('Courier Register')</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6 mx-auto reg-area">
                    <div class="reg-content">
                        ...
                        <form action="{{ route('courier-register-submit') }}" method="POST">
                            @csrf
                            ...
                            @enderror
                                ...
                                <p class="login-redirect">@lang('Already have an account?') <span><a
                                            href="{{ route('courier.login') }}">@lang('Login')</a></span></p>
                            </div>
                        </form>
                    </div>
                </div>
