    ...
    <div class="gs-merchant-outlet">
        ...
        <div class="gs-merchant-breadcrumb has-mb">
            <div class="d-flex align-items-center gap-4">
                <a href="{{route("merchant-network-presence-index")}}" class="back-btn">
                    <i class="fa-solid fa-arrow-left-long"></i>
                </a>
                <h4 class="text-capitalize">@lang('Create Network Presence')</h4>
            </div>
            ...
            <ul class="breadcrumb-menu">
                ...
                <li>
                    <a href="javascript:;" class="text-capitalize"> @lang('Create Network Presence') </a>
                </li>
            </ul>
        </div>
        <!-- breadcrumb end -->
        ...
        <div class="merchant-edit-profile-section-wrapper">
            <div class="gs-edit-profile-section">
                ...
                <form class="edit-profile-area" action="{{ route('merchant-network-presence-create') }}" method="POST">
                    @csrf
                    <div class="row">
                        ...
                        <div class="form-group">
                            <label for="link">@lang('Network Link') <small>@lang('(type fa)')</small></label>
