    ...
    <div class="gs-merchant-outlet">
        ...
        <div class="gs-merchant-breadcrumb has-mb">
            <div class="d-flex gap-4 custom-gap-sm-2 flex-wrap align-items-center">
                <h4 class="text-capitalize">@lang('Network Presence')</h4>
                <a href="{{ route('merchant-network-presence-create') }}"
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $(document).on('change', '#network_presence', function() {
            var link = $(this).val();
