    ...
    <div class="gs-merchant-outlet">
        ...
        <div class="gs-merchant-breadcrumb has-mb">
            <div class="d-flex align-items-center gap-4">
                ...
                <h4 class="text-capitalize">@lang('Edit Network Presence')</h4>
            </div>
            ...
            <ul class="breadcrumb-menu">
                ...
                <li>
                    <a href="javascript:;" class="text-capitalize"> @lang('Edit Network Presence') </a>
                </li>
            </ul>
        </div>
        <!-- breadcrumb end -->
        ...
        <div class="merchant-edit-profile-section-wrapper">
            <div class="gs-edit-profile-section">
                ...
                <form class="edit-profile-area" action="{{ route('merchant-network-presence-update', $data->id) }}" method="POST">
                    @csrf
                    <div class="row">
