...
@section('content')
    <div class="gs-merchant-outlet">
        ...
        <div class="gs-merchant-breadcrumb has-mb">
            <h4 class="text-capitalize">@lang('Merchant Trust Badge')</h4>
            <ul class="breadcrumb-menu">
                ...
                <li>
                    <a href="#" class="text-capitalize"> @lang('Merchant Trust Badge') </a>
                </li>
            </ul>
        </div>
        <!-- breadcrumb end -->

        <!-- Merchant Trust Badge area start  -->
        <div class="merchant-edit-profile-section-wrapper">
            <div class="gs-edit-profile-section">

                @if ($data->hasPendingTrustBadge())
                ...
                @else
                    <form class="edit-profile-area" action="{{ route('merchant-trust-badge-submit') }}" method="POST"
                        ...
                        <div class="row row-cols-1 row-cols-sm-2">
                            ...
                            <input type="hidden" name="warning"
                                value="{{ isset($trustBadge) ? $trustBadge->admin_warning : '0' }}" />
                            <input type="hidden" name="trust_badge_id" value="{{ isset($trustBadge) ? $trustBadge->id : '0' }}" />
