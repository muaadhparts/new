...
@section('content')
    <div class="gs-merchant-outlet">
        ...
        <div class="gs-merchant-breadcrumb has-mb">
            <h4 class="text-capitalize">@lang('Merchant Verification')</h4>
            <ul class="breadcrumb-menu">
                ...
                <li>
                    <a href="#" class="text-capitalize"> @lang('Merchant Verification') </a>
                </li>
            </ul>
        </div>
        <!-- breadcrumb end -->

        <!-- Merchant Verification area start  -->
        <div class="merchant-edit-profile-section-wrapper">
            <div class="gs-edit-profile-section">
                ...
                @else
                    <form class="edit-profile-area" action="{{ route('merchant-verify-submit') }}" method="POST"
        ...
        <!-- Merchant Verification area end  -->
    </div>
@endsection
