        ...
        <form class="row gy-3 gy-lg-4 add-catalogItem-form" id="myForm" action="{{ route('merchant-catalog-item-update', $data->id) }}"
            ...
            <div class="col-12 col-lg-8 physical-catalogItem-inputes-wrapper show">
                <div class="form-group">
                    ...
                    <div class="input-label-wrapper">
                        <label>@lang('CatalogItem Licensel')</label>
                                ...
                                <div class="row row-cols-1 row-cols-md-2 gy-4 position-relative">
                                    <div class="col">
                                        <input type="text" class="form-control" name="license[]"
                                            placeholder="@lang('License Key')" value="{{ $data->license[$key] }}">
                                    </div>
                                    <div class="col position-relative">
                                        <input type="text" class="form-control" name="license_qty[]"
                                            placeholder="@lang('License Quantity') " value="{{ $data->license_qty[$key] }}">
                                            <button class="gallery-extra-remove-btn feature-extra-tags-remove-btn remove_license_sell right-1"><i
                        ...
                        <div class="col-12 col-md-12 d-flex justify-content-end mt-4">
                            <button class="template-btn outline-btn" id="license-btn" type="button">+@lang('Add More
                                Field')</button>
                        </div>
                        ...
                        <div class="row" id="view_gallery">
                            ...
                            <div class="col-6  col-sm-3 col-lg-6 col col-xxl-4  mt-2">
                                <div class="position-relative img-wh-80">
                                            <img class="img-wh-80 rounded-4  object-fit-cover"    src="{{ asset('assets/images/merchant-photos/' . $gallery->photo) }}" alt="">
