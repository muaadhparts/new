...
@section('content')
    <div class="gs-merchant-outlet">
        ...
        <form class="row gy-3 gy-lg-4 add-catalogItem-form" action="{{ route('merchant-catalog-item-store') }}" method="POST"
            ...
            <!-- inputes of physical catalogItem end -->
        ...
        (function($) {
            ...
            $(document).on('click', "#color-btn", function() {
                $("#color-section").append(`<div class="col-12 mt-2 position-relative">
                    <input type="text" class="form-control" name="catalogItem-colors"
                        placeholder="#000000 ">
                    <input class="h-100 position-absolute top-0 end-0 color-input" type="color"
