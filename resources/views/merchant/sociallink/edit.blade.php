    ...
    <div class="gs-merchant-outlet">
        ...
        <div class="gs-merchant-breadcrumb has-mb">
            <div class="d-flex align-items-center gap-4">
                ...
                <h4 class="text-capitalize">@lang('Edit Social Link')</h4>
            </div>
            ...
            <ul class="breadcrumb-menu">
                ...
                <li>
                    <a href="javascript:;" class="text-capitalize"> @lang('Edit Social Link') </a>
                </li>
            </ul>
        </div>
        <!-- breadcrumb end -->
        ...
        <div class="merchant-edit-profile-section-wrapper">
            <div class="gs-edit-profile-section">
                ...
                <form class="edit-profile-area" action="{{ route('merchant-sociallink-update', $data->id) }}" method="POST">
                    @csrf
                    <div class="row">
						...
						<div class="form-group">
                            ...
                            <input type="text" id="icons" class="form-control" placeholder="@lang('icon')" value="{{$data->icon}}"
                                name="icon" required>
                            @error('icon')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
