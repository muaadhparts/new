    ...
    <div class="gs-merchant-outlet">
        ...
        <div class="gs-merchant-breadcrumb has-mb">
            <div class="d-flex gap-4 custom-gap-sm-2 flex-wrap align-items-center">
                <h4 class="text-capitalize">@lang('Social Links')</h4>
                <a href="{{ route('merchant-sociallink-create') }}"
                    class="template-btn md-btn black-btn data-table-btn">+@lang('Add New')</a>
            </div>
                                ...
                                <tr>
                                        ...
                                        <div class="status position-relative">
                                            <div class="dropdown-container">
                                                <select class="form-control nice-select form__control {{ $activeClass }}"
                                                    id="social_link">
                                                    <option
                                                        value="{{ route('merchant-sociallink-status', ['id1' => $data->id, 'id2' => 1]) }}"
                                                        {{ $active }}> {{ __('Activated') }} </option>
                                                    <option
                                                        value="{{ route('merchant-sociallink-status', ['id1' => $data->id, 'id2' => 0]) }}"
                                    ...
                                    <td>
                                        <div class="table-icon-btns-wrapper">
                                            <a href="{{ route('merchant-sociallink-edit', $data->id) }}"
                                            ...
                                            <a data-href="{{ route('merchant-sociallink-delete', $data->id) }}"
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $(document).on('change', '#social_link', function() {
            var link = $(this).val();
