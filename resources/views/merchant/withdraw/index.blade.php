    ...
    <div class="gs-merchant-outlet">
        ...
        <div class="gs-merchant-breadcrumb has-mb">
            ...
            <div class="d-flex gap-4 custom-gap-sm-2 flex-wrap align-items-center">
                <h4 class="text-capitalize">@lang('My Withdraws')</h4>
                <a href="{{ route('merchant-wt-create') }}" class="template-btn md-btn black-btn data-table-btn">
                    +@lang('Withdrow Now')
                </a>
            </div>
        ...
        <div class="merchant-table-wrapper all-orders-table-wrapper">
            <div class="user-table table-responsive position-relative">
                <!-- <div class="data-table-btn-wrapper w-100">
                            <a href="{{ route('merchant-wt-create') }}" class="template-btn md-btn black-btn data-table-btn">
                                +@lang('Withdrow Now')</a>
                        </div> -->
                <table class="gs-data-table w-100">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center">{{ __('No Withdraw Found') }}</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
