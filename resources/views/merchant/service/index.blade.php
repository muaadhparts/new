		...
		<div class="row">
			<div class="col-lg-12">
				...
				<ul class="links">
					...
					<li>
						<a href="{{ route('merchant-service-index') }}">{{ __('Services') }}</a>
					</li>
				</ul>
			</div>
		</div>
...
<script type="text/javascript">
	(function($) {
		...
		var table = $('#muaadhtable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('merchant-service-datatables') }}',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="{{route('merchant-service-create')}}" id="add-data" data-bs-toggle="modal" data-bs-target="#modal1">'+
