		...
		<div class="row">
			<div class="col-lg-12">
				...
				<ul class="links">
					...
					<li>
						<a href="{{ route('merchant-capability-index') }}">{{ __('Capabilities') }}</a>
					</li>
				</ul>
			</div>
		</div>
...
<div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<!-- Modal body -->
			<div class="modal-body">
				<p class="text-center">{{ __('You are about to delete this Capability.') }}</p>
...
<script type="text/javascript">
	(function($) {
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="{{route('merchant-capability-create')}}" id="add-data" data-bs-toggle="modal" data-bs-target="#modal1">'+
