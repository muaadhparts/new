    ...
    <div class="gs-merchant-outlet">
        ...
        <div class="gs-merchant-breadcrumb has-mb">
            <div class="d-flex gap-4 custom-gap-sm-2 flex-wrap align-items-center">
                <h4 class="text-capitalize">@lang('Packagings')</h4>
                <a href="{{ route('merchant-package-create') }}" class="template-btn md-btn black-btn data-table-btn"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-icon-btns-wrapper">
                                            <a href="{{ route('merchant-package-edit', $data->id) }}"
                                            ...
                                            <a href="javascript:;"
                                                data-href="{{ route('merchant-package-delete', $data->id) }}"
