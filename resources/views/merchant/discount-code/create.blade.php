    ...
    <div class="gs-merchant-outlet">
        ...
        <div class="gs-merchant-breadcrumb has-mb">
            <div class="d-flex gap-4 flex-wrap align-items-center">
                ...
                <h4 class="text-capitalize">@lang('Add New Discount Code')</h4>
            </div>
        ...
        <div class="merchant-edit-profile-section-wrapper">
            <div class="gs-edit-profile-section">
                <form class="edit-profile-area" id="discountCodeForm" action="{{ route('merchant-discount-code-store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-12">
                            <button class="template-btn btn-forms" type="submit">
                                <i class="fas fa-save"></i> @lang('Create Discount Code')
                            </button>
                        </div>
                    </div>
                </form>
...
<script type="text/javascript">
    ...
    // Discount Type Change - Load categories dynamically
