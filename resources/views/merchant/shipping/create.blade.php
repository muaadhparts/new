    ...
    <div class="gs-merchant-outlet">
        ...
        <div class="gs-merchant-breadcrumb has-mb">
            <div class="d-flex gap-4 flex-wrap">
                <a class="back-btn" href="{{route("merchant-shipping-index")}}">
        ...
        <div class="merchant-edit-profile-section-wrapper">
            <div class="gs-edit-profile-section">
                ...
                <form class="edit-profile-area" action="{{route('merchant-shipping-create')}}" method="POST">
                    @csrf
                    <div class="row">

                        <div class="form-group">
                            <label for="name">@lang('Name')</label>
                            <input type="text" id="name" class="form-control" placeholder="@lang('Name')" value=""
                                name="name">
                            @error('name')
