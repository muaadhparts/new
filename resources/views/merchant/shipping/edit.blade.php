    ...
    <div class="gs-merchant-outlet">
        ...
        <div class="gs-merchant-breadcrumb has-mb">
                ...
                <div class=" d-flex align-items-center gap-4 ms-0">
                    <a href="{{route("merchant-shipping-index")}}" class="back-btn">
                        <i class="fa-solid fa-arrow-left-long"></i>
                    </a>
                    <h4>@lang('Edit Shipping')</h4>
                </div>
            ...
            <ul class="breadcrumb-menu">
                ...
                <li>
                    <a href="javascript:;" class="text-capitalize"> @lang('Edit Shipping') </a>
                </li>
            </ul>
        </div>
        <!-- breadcrumb end -->
        ...
        <div class="merchant-edit-profile-section-wrapper">
            <div class="gs-edit-profile-section">
                ...
                <form class="edit-profile-area" action="{{ route('merchant-shipping-update', $data->id) }}" method="POST">
                    @csrf
                    <div class="row">
