                ...
                <form class="edit-profile-area" action="{{ route('merchant-location-create') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6 mb-3">
                            ...
                            <input type="text" id="warehouse_name" class="form-control" placeholder="@lang('e.g. Main Warehouse')" value="{{ old('warehouse_name') }}"
                        ...
                        <div class="form-group col-md-6 mb-3">
                            ...
                            <input type="text" id="tryoto_warehouse_code" class="form-control" placeholder="@lang('e.g. 1 or WH001')" value="{{ old('tryoto_warehouse_code') }}"
