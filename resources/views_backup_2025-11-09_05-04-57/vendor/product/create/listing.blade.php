    ...
    <div class="gs-vendor-outlet">
        ...
        <div class="gs-vendor-breadcrumb has-mb">
            <div class="gs-deposit-title ms-0 d-flex align-items-center gap-4">
                ...
                <h4>@lang('Add Listing Product')</h4>
            </div>
            ...
            <ul class="breadcrumb-menu">
                ...
                <li>
                    <a href="#" class="text-capitalize"> @lang('Add Listing Product') </a>
                </li>
            </ul>
        </div>
        <!-- breadcrumb end -->
        ...
        <form class="row gy-3 gy-lg-4 add-product-form" id="myForm" action="{{ route('vendor-prod-store') }}"
            ...
            <!-- inputes of listing product start  -->
            <div class="col-12 col-lg-8 listing-product-inputes-wrapper show">
                <div class="form-group">
                    ...
                    <div class="input-label-wrapper">
                        ...
                        <small class="text-muted">@lang('Enter the part number of the listing product you want to sell')</small>
                    </div>
